...
import com.rusefi.compatibility.ini.SpecialCaseUnit;
    ...
    public int run(ReaderState state, ConfigStructure structure, int structureStartingTsPosition, String temporaryLineComment, String variableNamePrefix) {
        FieldsStrategy strategy = new FieldsStrategy() {
			...
			public int writeOneField(FieldIterator it, String prefix, int tsPosition) {
                ...
                String directiveOutput = ConfigDirective.getDirectiveOutput(configField);
                if (directiveOutput != null) {
                    tsHeader.append(directiveOutput);
                    tsHeader.append(EOL);
                    return tsPosition;
                }
                ...
                String resolvedTsInfo = SpecialCaseUnit.resolveSpecialCase(originalUnits, originalTsInfo);
                if (resolvedTsInfo != null) {
                    configField.setTsInfo(resolvedTsInfo);
