...
public class SdCardFieldsGeneratorTest {
    ...
    public void bitAndAlignment() {
        String expectedOutput = "\t{test->reference.RPMValue, \"feee\", \"RPM\", 2},\n" +
            "// structureStartingTsPosition 0 test->reference/\"sd_logging_internal\", skipping bit  at 4@0\n" +
            "\t{test->reference.Value, \"feee\", \"RPM\", 2},\n" +
            "// structureStartingTsPosition 0 test->reference/\"sd_logging2\", skipping bit  at 12@0\n" +
            "// structureStartingTsPosition 0 test->reference/\"sd_logging3\", skipping bit  at 12@1\n";
