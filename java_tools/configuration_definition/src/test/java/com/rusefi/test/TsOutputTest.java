...
class TsOutputTest {
    ...
    void testFormatTemperatureTsInfo() {
        ...
        assertEquals("", SpecialCaseUnit.formatTemperatureTsInfo(null, false));
        assertEquals("", SpecialCaseUnit.formatTemperatureTsInfo("", false));
        assertEquals("", SpecialCaseUnit.formatTemperatureTsInfo("  ", false));
        ...
        assertEquals(expectedCelsius, SpecialCaseUnit.formatTemperatureTsInfo(temperatureInput, false));

        // Test Fahrenheit format
        String expectedFahrenheit = "\"F\",1.8,17.77777,-40.0,392.0, 0";
        assertEquals(expectedFahrenheit, SpecialCaseUnit.formatTemperatureTsInfo(temperatureInput, true));
    }
    ...
    void testFormatPressureTsInfo() {
        // Test null or empty input
        assertEquals("", SpecialCaseUnit.formatPressureTsInfo(null, false));
        assertEquals("", SpecialCaseUnit.formatPressureTsInfo("", false));
        assertEquals("", SpecialCaseUnit.formatPressureTsInfo("  ", false));
        ...
        assertEquals(expectedKPa, SpecialCaseUnit.formatPressureTsInfo(pressureInput, false));

        // Test psi format
        String expectedPsi = "\"psi\",0.145038,0.0,2.17557,36.2595, 0";
        assertEquals(expectedPsi, SpecialCaseUnit.formatPressureTsInfo(pressureInput, true));
    }
    ...
    void testFormatSpeedTsInfo() {
        // Test null or empty input
        assertEquals("", SpecialCaseUnit.formatSpeedTsInfo(null, false));
        assertEquals("", SpecialCaseUnit.formatSpeedTsInfo("", false));
        assertEquals("", SpecialCaseUnit.formatSpeedTsInfo("  ", false));
        ...
        assertEquals(expectedKmh, SpecialCaseUnit.formatSpeedTsInfo(speedInput, false));

        // Test mph format
        String expectedMph = "\"mph\",0.62137119,0.0,155.3427975,0.0";
        assertEquals(expectedMph, SpecialCaseUnit.formatSpeedTsInfo(speedInput, true));
    }
