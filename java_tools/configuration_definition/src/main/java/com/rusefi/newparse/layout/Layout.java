...
public abstract class Layout {
    ...
    public void writeOutputChannelLayout(PrintStream ps, PrintStream psDatalog, int offsetAdd) {
        writeOutputChannelLayout(ps, psDatalog, new StructNamePrefixer(), offsetAdd);
    }
