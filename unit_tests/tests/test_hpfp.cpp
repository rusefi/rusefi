...
TEST(HPFP, PI) {
	...
	math.calcPI(1000, 0);
	EXPECT_FLOAT_EQ(math.m_pressureTarget_kPa, 2025);

	// Proportional gain
	math.m_I_sum_percent = 0; // Reset for ease of testing
	...
	EXPECT_FLOAT_EQ(math.calcPI(1000, 0), 21.21);
	EXPECT_FLOAT_EQ(math.m_I_sum_percent, 1.01);
}
