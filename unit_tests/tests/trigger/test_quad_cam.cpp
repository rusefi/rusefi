...
TEST(trigger, testQuadCam) {
	...
	ASSERT_EQ(0, engine->triggerCentral.getVVTPosition(0, 0));
	ASSERT_EQ(0, engine->triggerCentral.getVVTPosition(0, 1));
	ASSERT_EQ(0, engine->triggerCentral.getVVTPosition(1, 0));
	ASSERT_EQ(0, engine->triggerCentral.getVVTPosition(1, 1));
	...
	EXPECT_NEAR(basePos, engine->triggerCentral.getVVTPosition(0, 0), EPS3D);
	EXPECT_NEAR(basePos, engine->triggerCentral.getVVTPosition(0, 1), EPS3D);
	EXPECT_NEAR(basePos, engine->triggerCentral.getVVTPosition(1, 0), EPS3D);
	EXPECT_NEAR(basePos, engine->triggerCentral.getVVTPosition(1, 1), EPS3D);
	...
	EXPECT_NEAR(basePos - oneMsDegrees * 1, engine->triggerCentral.getVVTPosition(0, 0), EPS3D);
	EXPECT_NEAR(basePos - oneMsDegrees * 2, engine->triggerCentral.getVVTPosition(0, 1), EPS3D);
	EXPECT_NEAR(basePos - oneMsDegrees * 3, engine->triggerCentral.getVVTPosition(1, 0), EPS3D);
	EXPECT_NEAR(basePos - oneMsDegrees * 4, engine->triggerCentral.getVVTPosition(1, 1), EPS3D);
}
