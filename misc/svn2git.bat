rem mkdir -p c:\stuff\rusefi.svn2git\rusefi.svn
rem mkdir -p c:\stuff\rusefi.svn2git\rusefi.github
rem cd c:\stuff\rusefi.svn2git\rusefi.svn
rem svn co https://svn.code.sf.net/p/rusefi/code/trunk/ .
rem cd c:\stuff\rusefi.svn2git\rusefi.github
rem git clone https://github.com/rusefi/rusefi.git
