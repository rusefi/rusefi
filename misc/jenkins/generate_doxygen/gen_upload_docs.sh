...
bash misc/pinout-gen/gen.sh firmware/config/boards/proteus/white35.yaml > pinouts/white35.html
cp firmware/config/boards/proteus/black35.jpg pinouts/white35.jpg
