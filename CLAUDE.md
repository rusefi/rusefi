...
- SDIO HAL host regressions live in the ChibiOS submodule under
  ...
  its tests separately. See `docs/sdio-reliability.md` for the upstream HAL
  dependencies. Keep the official ChibiOS URL in `.gitmodules`; a commit being
  fetchable through that URL does not establish that it has merged upstream.
