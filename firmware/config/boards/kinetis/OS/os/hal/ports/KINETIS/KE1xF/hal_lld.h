...
/**
 * @file    KE1xF/hal_lld.h
 * @brief   Kinetis KE1xF HAL subsystem low level driver header.
 ...
 * FTM clock frequency
 */
#if !defined(KINETIS_FTM_FREQUENCY) || defined(__DOXYGEN__)
#define KINETIS_FTM_FREQUENCY KINETIS_SYSCLK_FREQUENCY
#endif
...
// This is needed by FlexNVM driver?
