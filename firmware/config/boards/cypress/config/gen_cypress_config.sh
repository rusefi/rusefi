...
java \
 ...
 $COMMON_GEN_CONFIG \
 -c_defines ${BOARD_DIR}/config/controllers/generated/rusefi_generated_cypress.h \
 -c_destination ${BOARD_DIR}/config/controllers/generated/engine_configuration_generated_structures_cypress.h \
