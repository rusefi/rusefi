...
#define VAL_GPIO_MODER_ALL_DEFAULT (PIN_MODE_INPUT(0) |  \
									PIN_MODE_INPUT(1) |  \
									PIN_MODE_INPUT(2) |  \
									PIN_MODE_INPUT(3) |  \
									PIN_MODE_INPUT(4) |  \
...
#define VAL_GPIO_OSPEEDR_ALL_DEFAULT (PIN_OSPEED_HIGH(0) |  \
									  PIN_OSPEED_HIGH(1) |  \
									  PIN_OSPEED_HIGH(2) |  \
									  PIN_OSPEED_HIGH(3) |  \
									  PIN_OSPEED_HIGH(4) |  \
...
#define VAL_GPIO_ODR_ALL_DEFAULT 	(PIN_ODR_LOW(0) |  \
									  PIN_ODR_LOW(1) |  \
									  PIN_ODR_LOW(2) |  \
									  PIN_ODR_LOW(3) |  \
									  PIN_ODR_LOW(4) |  \
...
#define VAL_GPIO_PUPDR_ALL_DEFAULT (PIN_PUPDR_PULLDOWN(0) |  \
...
#define VAL_GPIOA_MODER VAL_GPIO_MODER_ALL_DEFAULT
