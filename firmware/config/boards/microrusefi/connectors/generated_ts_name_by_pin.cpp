...
const char* getBoardSpecificPinName(brain_pin_e brainPin) {
	switch (brainPin) {
		...
		case Gpio::A15:
			return "AUX J2 PA15";
		case Gpio::A2:
			return "24 - AN temp 3 or Hall Input or Flex";
		case Gpio::A3:
			return "22 - AN temp 4 or Hall Input or Flex";
		case Gpio::A4:
			return "28 - AN volt 10, Aux Reuse";
		case Gpio::A5:
			return "25 - Hall Cam";
		case Gpio::A6:
			return "26 - AN volt 2";
		case Gpio::A7:
			return "31 - AN volt 3";
		case Gpio::B0:
			return "36 - AN volt 8, Aux Reuse";
		case Gpio::B1:
			return "40 - AN volt 9, Aux Reuse";
		case Gpio::B10:
			return "AUX J13";
		case Gpio::B11:
			return "AUX J12";
		...
		case Gpio::C3:
			return "20 - AN volt 5";
		case Gpio::C4:
			return "32 - AN volt 6, Aux Reuse";
		case Gpio::C5:
			return "30 - AN volt 7";
		case Gpio::C6:
			return "45 - VR/Hall Crank";
		case Gpio::D1:
			return "12 - Ignition 4";
		case Gpio::D2:
			return "11 - Ignition 3";
		case Gpio::D3:
			return "10 - Ignition 2";
		case Gpio::D4:
			return "9 - Ignition 1";
		case Gpio::D6:
			return "13 - GP Out 6";
		...
		case Gpio::TLE8888_PIN_3:
			return "41 - Injector 3";
		case Gpio::TLE8888_PIN_4:
			return "42 - Injector 4";
