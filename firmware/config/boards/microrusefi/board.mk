...
M25QDEFS = -DJESD216_BUS_MODE=JESD216_BUS_MODE_SPI
BOARDINC += $(M25QINC)
BOARDSRC += $(M25QSRC)
...
#Enable SPI flash
DDEFS += -DEFI_FLASH_SPI=TRUE

# Add them all together
DDEFS += $(MCU_DEFS) $(M25QDEFS) -DEFI_USE_OSC=TRUE -DFIRMWARE_ID=\"microRusEFI\" $(DEFAULT_ENGINE_TYPE) $(LED_CRITICAL_ERROR_BRAIN_PIN) $(EFI_CONSOLE_TTL_PINS) -DEFI_SOFTWARE_KNOCK=TRUE -DSTM32_ADC_USE_ADC3=TRUE
