...
const char* getBoardSpecificPinName(brain_pin_e brainPin) {
	switch (brainPin) {
		...
		case Gpio::A1:
			return "C3 AUX2";
		case Gpio::A6:
			return "D10 A/C Request / BUTTON2";
		case Gpio::A7:
			return "C15 Fuel Pressure / AUX3";
		case Gpio::A8:
			return "B1 injector output 6";
		case Gpio::A9:
			return "B5 injector output 2";
		case Gpio::B1:
			return "D2 BUTTON1";
		case Gpio::B8:
			return "B10 Coil 6";
		case Gpio::B9:
			return "B9 Main Relay Weak Low Side output 1 (no flyback here)";
		case Gpio::C13:
			return "B15 Coil 1";
		case Gpio::C6:
			return "B16 Low Side output 4 / Fuel Pump Relay (has flyback D5)";
		case Gpio::D10:
			return "B3 injector output 4";
		case Gpio::D11:
			return "B4 injector output 3";
		case Gpio::D12:
			return "B18 VVT2 or Idle or Low Side output 2 or injector 8 (has flyback D3)";
		case Gpio::D13:
			return "B17 Low Side output 3 or injector 7 (has flyback D4)";
		case Gpio::D15:
			return "B7 VVT1 or Low Side output 1 (has flyback D2)";
		case Gpio::D2:
			return "B2 injector output 5";
		case Gpio::D3:
			return "B6 injector output 1";
		case Gpio::E0:
			return "C18 VR1+ Discrete for low count wheel";
		case Gpio::E1:
			return "C17 VR2-/HALL max9924 best for normal 12+ tooth wheels";
		case Gpio::E11:
			return "D5 FLEX";
		case Gpio::E12:
			return "C5 CAM 1 / HALL1";
		case Gpio::E13:
			return "C6 CAM 2 / HALL2";
		case Gpio::E14:
			return "C7 HALL3";
		case Gpio::E15:
			return "C9 BUTTON3";
