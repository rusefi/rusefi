...
const char* getBoardSpecificPinName(brain_pin_e brainPin) {
	switch (brainPin) {
		case Gpio::A1:
			return "28B input";
		case Gpio::A6:
			return "12A VR Negative";
		case Gpio::B1:
			return "10A VR Negative";
		case Gpio::C13:
			return "14B Ignition 1";
		case Gpio::D10:
			return "3B GDI Injector 4";
		case Gpio::D11:
			return "5B GDI Injector 3";
		case Gpio::E3:
			return "11B Ignition 4";
		case Gpio::E4:
			return "12B Ignition 3";
		case Gpio::E5:
		...
		case Gpio::F12:
			return "HPFP pump Positive";
		case Gpio::F3:
			return "21A Digital Input 1";
		case Gpio::F4:
			return "27A Digital Input 3";
		case Gpio::F5:
			return "28A Digital Input 4";
		case Gpio::F6:
			return "18A Flex Input 1";
		case Gpio::G7:
		...
		case Gpio::TLE9104_0_OUT_1:
			return "3A Port injector 2";
		case Gpio::TLE9104_0_OUT_2:
			return "2A Port injector 3";
		case Gpio::TLE9104_0_OUT_3:
			return "1A Port injector 4";
		case Gpio::TLE9104_1_OUT_0:
			return "5A Main Relay Control";
		...
		case Gpio::TLE9104_3_OUT_0:
			return "33A Wastegate Solenoid";
		case Gpio::TLE9104_3_OUT_1:
			return "34A AC Control";
		default:
			return nullptr;
	}
	return nullptr;
