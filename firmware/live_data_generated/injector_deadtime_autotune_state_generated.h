// this section was generated automatically by rusEFI tool config_definition_base-all.jar based on (unknown script) controllers/modules/injector_deadtime_autotune/injector_deadtime_autotune_state.txt
// by class com.rusefi.output.CHeaderConsumer
// begin
#pragma once
#include "rusefi_types.h"
// start of injector_deadtime_autotune_state_s
struct injector_deadtime_autotune_state_s {
	/**
	offset 0 bit 0 */
	bool dtAutotuneActive : 1 {};
	/**
	offset 0 bit 1 */
...
static_assert(sizeof(injector_deadtime_autotune_state_s) == 4);
