...
//                       gm_2_2.cpp -lCN F:\stuff\rusefi_sourceforge\firmware /
...
// F:\stuff\rusefi_sourceforge\firmware\config\engines\gm_2_2.cpp
//    1 /*
//    2  * @file gm_2_2.cpp
//    3  *
//    4  * set_engine_type 30
//    5  *
//    6  * @date Apr 9, 2015
...
//   15 
        ...
        SECTION `.text`:CODE:NOROOT(2)
          ...
          CFI Function _Z8setGm2_2v
        THUMB
//   16 void setGm2_2(DECLARE_ENGINE_PARAMETER_F) {
_Z8setGm2_2v:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
//   17 	setOperationMode(engineConfiguration, FOUR_STROKE_CAM_SENSOR);
        MOVS     R1,#+2
        LDR.N    R0,??setGm2_2_0
        LDR      R0,[R0, #+0]
...
//   18 	engineConfiguration->trigger.type = TT_ONE_PLUS_TOOTHED_WHEEL_60_2;
        LDR.N    R0,??setGm2_2_0
        LDR      R0,[R0, #+0]
        MOVS     R1,#+17
        STR      R1,[R0, #+536]
//   19 
//   20 	boardConfiguration->triggerInputPins[0] = GPIOC_6;
        LDR.N    R0,??setGm2_2_0+0x4
        LDR      R0,[R0, #+0]
        MOVS     R1,#+38
        STR      R1,[R0, #+296]
//   21 	boardConfiguration->triggerInputPins[1] = GPIOA_8;
        LDR.N    R0,??setGm2_2_0+0x4
        LDR      R0,[R0, #+0]
        MOVS     R1,#+8
        STR      R1,[R0, #+300]
