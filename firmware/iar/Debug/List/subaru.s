...
//                       subaru.cpp -lCN F:\stuff\rusefi_sourceforge\firmware /
...
// F:\stuff\rusefi_sourceforge\firmware\config\engines\subaru.cpp
//    1 /**
//    2  * @file	subaru.cpp
//    3  *
//    4  * SUBARU_2003_WRX
//    5  * set_engine_type 22
//    6  *
//    7  * @date Sep 14, 2014
...
//   15 
        ...
        SECTION `.text`:CODE:NOROOT(2)
          ...
          CFI Function _Z16setSubaru2003Wrxv
        THUMB
//   16 void setSubaru2003Wrx(DECLARE_ENGINE_PARAMETER_F) {
_Z16setSubaru2003Wrxv:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
//   17 	setFrankenso_01_LCD(boardConfiguration);
        LDR.N    R0,??setSubaru2003Wrx_0
        LDR      R0,[R0, #+0]
          CFI FunCall _Z19setFrankenso_01_LCDP21board_configuration_s
        BL       _Z19setFrankenso_01_LCDP21board_configuration_s
//   18 	setFrankenso0_1_joystick(engineConfiguration);
        LDR.N    R0,??setSubaru2003Wrx_0+0x4
        LDR      R0,[R0, #+0]
...
//   19 
//   20 	engineConfiguration->trigger.type = TT_TOOTHED_WHEEL;
        LDR.N    R0,??setSubaru2003Wrx_0+0x4
        LDR      R0,[R0, #+0]
        MOVS     R1,#+0
        STR      R1,[R0, #+536]
//   21 	engineConfiguration->trigger.customTotalToothCount = 5;
        LDR.N    R0,??setSubaru2003Wrx_0+0x4
        LDR      R0,[R0, #+0]
        MOVS     R1,#+5
        STR      R1,[R0, #+544]
//   22 	engineConfiguration->trigger.customSkippedToothCount = 1;
        LDR.N    R0,??setSubaru2003Wrx_0+0x4
        LDR      R0,[R0, #+0]
        MOVS     R1,#+1
        STR      R1,[R0, #+548]
//   23 
//   24 	engineConfiguration->sensorChartFrequency = 2;
        LDR.N    R0,??setSubaru2003Wrx_0+0x4
        LDR      R0,[R0, #+0]
        MOVS     R1,#+2
        STR      R1,[R0, #+532]
