...
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN chThdSleep
        EXTERN sdStart
        EXTERN sduObjectInit
        EXTERN sduStart
        EXTERN serusbcfg
        EXTERN usbStart
        EXTERN usbcfg

        PUBLIC is_usb_serial_ready
        PUBLIC usb_serial_start
...
//   25 	sduObjectInit(&SDU1);
        LDR.N    R0,??DataTable1
          CFI FunCall sduObjectInit
        BL       sduObjectInit
//   26 	sduStart(&SDU1, &serusbcfg);
        LDR.N    R1,??DataTable1_1
        LDR.N    R0,??DataTable1
          CFI FunCall sduStart
        BL       sduStart
//   27 
//   28 	/*
...
//   43 
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function is_usb_serial_ready
          CFI NoCalls
        THUMB
...
is_usb_serial_ready:
        ...
        LDRB     R0,[R0, #+0]
        CMP      R0,#+4
        BNE.N    ??is_usb_serial_ready_0
        MOVS     R0,#+1
        B.N      ??is_usb_serial_ready_1
