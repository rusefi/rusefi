...
static void updateIgnition(int rpm) {
	...
	engine->outputChannels.knockCount = engine->module<KnockControllerImpl>()->getKnockCount();
	engine->outputChannels.knockRetard = engine->module<KnockControllerImpl>()->getKnockRetard();
}
