static constexpr LogField fields[] = {
	...
	{engine->outputChannels.speedToRpmRatio, "Gearbox Ratio", "value", 0},
	{engine->outputChannels.vehicleSpeedKph, "Vehicle Speed", "kph", 0},
	{engine->outputChannels.internalMcuTemperature, "CPU Temperature", "deg C", 0},
	{engine->outputChannels.coolant, "CLT", "deg C", 0},
	{engine->outputChannels.intake, "IAT", "deg C", 0},
	{engine->outputChannels.auxTemp1, "auxTemp1", "deg C", 0},
	{engine->outputChannels.auxTemp2, "auxTemp2", "deg C", 0},
	{engine->outputChannels.TPSValue, "TPS", "%", 0},
	{engine->outputChannels.throttlePedalPosition, "Throttle pedal position", "%", 0},
	{engine->outputChannels.tpsADC, "tpsADC", "ADC", 0},
	{engine->outputChannels.rawMaf, "rawMaf", "V", 3},
	{engine->outputChannels.mafMeasured, "MAF sensor", "kg/h", 0},
	{engine->outputChannels.MAPValue, "MAP", "kPa", 0},
	{engine->outputChannels.baroPressure, "baroPressure", "kPa", 0},
	{engine->outputChannels.lambdaValue, "Lambda", "", 0},
	{engine->outputChannels.knockRetard, "knock: retard", "deg", 0},
	{engine->outputChannels.idleCurrentPosition, "idleCurrentPosition", "%", 1},
	{engine->outputChannels.VBatt, "VBatt", "V", 0},
	{engine->outputChannels.oilPressure, "Oil Pressure", "kPa", 0},
	{engine->outputChannels.vvtPositionB1I, "VVT: bank 1 intake", "deg", 0},
	{engine->outputChannels.chargeAirMass, "air mass", "g", 0},
	{engine->outputChannels.crankingFuelMs, "crankingFuelMs", "ms", 0},
	{engine->outputChannels.currentTargetAfr, "fuel: target AFR", "ratio", 0},
	{engine->outputChannels.baseFuel, "fuel: base mass", "mg", 0},
	{engine->outputChannels.fuelRunning, "fuel: running", "mg", 0},
	{engine->outputChannels.actualLastInjection, "fuel: Last injection", "ms", 0},
	{engine->outputChannels.injectorDutyCycle, "fuel: injector duty cycle", "%", 0},
	{engine->outputChannels.veValue, "fuel: VE", "ratio", 0},
	{engine->outputChannels.injectionOffset, "injectionOffset", "deg", 0},
	{engine->outputChannels.tCharge, "tCharge", "deg C", 0},
	{engine->outputChannels.injectorLagMs, "fuel: injector lag", "ms", 0},
	{engine->outputChannels.engineMakeCodeNameCrc16, "Engine CRC16", "crc16", 0},
	{engine->outputChannels.wallFuelAmount, "fuel: wall amount", "mg", 0},
	{engine->outputChannels.wallFuelCorrection, "fuel: wall correction", "mg", 0},
	...
	{engine->outputChannels.etbTarget, "ETB Target", "%", 0},
	{engine->outputChannels.etb1DutyCycle, "ETB Duty", "%", 0},
	{engine->outputChannels.etb1Error, "ETB Error", "%", 0},
	{engine->outputChannels.fuelTankLevel, "Fuel level", "%", 0},
	{engine->outputChannels.totalFuelConsumption, "fuel: Total consumed", "grams", 0},
	...
	{engine->outputChannels.debugFloatField1, "debugFloatField1", "val", 0},
	{engine->outputChannels.debugFloatField2, "debugFloatField2", "val", 0},
	{engine->outputChannels.debugFloatField3, "debugFloatField3", "val", 0},
	{engine->outputChannels.debugFloatField4, "debugFloatField4", "val", 0},
	{engine->outputChannels.debugFloatField5, "debugFloatField5", "val", 0},
	{engine->outputChannels.debugFloatField6, "debugFloatField6", "val", 0},
	{engine->outputChannels.debugFloatField7, "debugFloatField7", "val", 0},
	...
	{engine->outputChannels.accelerationX, "Acceleration: X", "G", 0},
	{engine->outputChannels.accelerationY, "Acceleration: Y", "G", 0},
	...
	{engine->outputChannels.TPS2Value, "TPS2", "%", 0},
	...
	{engine->outputChannels.wastegatePositionSensor, "Wastegate position sensor", "%", 0},
	{engine->outputChannels.idlePositionSensor, "Idle position sensor", "%", 0},
	...
	{engine->outputChannels.targetLambda, "fuel: target lambda", "", 0},
	{engine->outputChannels.AFRValue, "Air/Fuel Ratio", "AFR", 0},
	{engine->outputChannels.VssAcceleration, "Vss Accel", "m/s2", 0},
	{engine->outputChannels.lambdaValue2, "Lambda 2", "", 0},
	{engine->outputChannels.AFRValue2, "Air/Fuel Ratio 2", "AFR", 0},
	{engine->outputChannels.vvtPositionB1E, "VVT: bank 1 exhaust", "deg", 0},
	{engine->outputChannels.vvtPositionB2I, "VVT: bank 2 intake", "deg", 0},
	{engine->outputChannels.vvtPositionB2E, "VVT: bank 2 exhaust", "deg", 0},
	...
	{engine->outputChannels.tps1Split, "tps1Split", "%", 0},
	{engine->outputChannels.tps2Split, "tps2Split", "%", 0},
	{engine->outputChannels.tps12Split, "tps12Split", "%", 0},
	{engine->outputChannels.accPedalSplit, "accPedalSplit", "%", 0},
