...
ignitionAdvance("ignitionAdvance", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 76, 0.02, 0.0, 0.0, "deg"),
...
baseIgnitionAdvance("Timing: base ignition", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 846, 0.02, 0.0, 0.0, "deg"),
correctedIgnitionAdvance("Timing: ignition", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 848, 0.02, 0.0, 0.0, "deg"),
alignmentFill_at_22("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 850, 1.0, -20.0, 100.0, "units"),
dwellVoltageCorrection("Ignition: dwell corr", SensorCategory.SENSOR_INPUTS, FieldType.INT, 852, 1.0, -1.0, -1.0, ""),
luaTimingAdd("Ignition: Lua add", SensorCategory.SENSOR_INPUTS, FieldType.INT, 856, 1.0, -20.0, 20.0, "deg"),
luaTimingMult("Ignition: Lua mult", SensorCategory.SENSOR_INPUTS, FieldType.INT, 860, 1.0, -20.0, 20.0, "deg"),
perCylinderTiming1("perCylinderTiming 1", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 864, 1.0, 0.0, 0.0, "Timing Cyl"),
perCylinderTiming2("perCylinderTiming 2", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 865, 1.0, 0.0, 0.0, "Timing Cyl"),
perCylinderTiming3("perCylinderTiming 3", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 866, 1.0, 0.0, 0.0, "Timing Cyl"),
perCylinderTiming4("perCylinderTiming 4", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 867, 1.0, 0.0, 0.0, "Timing Cyl"),
perCylinderTiming5("perCylinderTiming 5", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 868, 1.0, 0.0, 0.0, "Timing Cyl"),
perCylinderTiming6("perCylinderTiming 6", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 869, 1.0, 0.0, 0.0, "Timing Cyl"),
perCylinderTiming7("perCylinderTiming 7", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 870, 1.0, 0.0, 0.0, "Timing Cyl"),
perCylinderTiming8("perCylinderTiming 8", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 871, 1.0, 0.0, 0.0, "Timing Cyl"),
perCylinderTiming9("perCylinderTiming 9", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 872, 1.0, 0.0, 0.0, "Timing Cyl"),
perCylinderTiming10("perCylinderTiming 10", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 873, 1.0, 0.0, 0.0, "Timing Cyl"),
perCylinderTiming11("perCylinderTiming 11", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 874, 1.0, 0.0, 0.0, "Timing Cyl"),
perCylinderTiming12("perCylinderTiming 12", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 875, 1.0, 0.0, 0.0, "Timing Cyl"),
m_knockRetard("Knock Degrees retarded\nlarger number = more retard", SensorCategory.SENSOR_INPUTS, FieldType.INT, 876, 1.0, -1.0, -1.0, ""),
m_knockThreshold("Knock Retard Threshold", SensorCategory.SENSOR_INPUTS, FieldType.INT, 880, 1.0, -1.0, -1.0, ""),
m_knockCount("Knock Count", SensorCategory.SENSOR_INPUTS, FieldType.INT, 884, 1.0, -1.0, -1.0, ""),
m_maximumRetard("m_maximumRetard", SensorCategory.SENSOR_INPUTS, FieldType.INT, 888, 1.0, -1.0, -1.0, ""),
m_requested_pump("GDI: HPFP duration\nComputed requested pump duration in degrees (not including deadtime)", SensorCategory.SENSOR_INPUTS, FieldType.INT, 892, 1.0, -1.0, -1.0, ""),
fuel_requested_percent("GDI: requested_percent", SensorCategory.SENSOR_INPUTS, FieldType.INT, 896, 1.0, -1.0, -1.0, ""),
fuel_requested_percent_pi("GDI: percent_pi", SensorCategory.SENSOR_INPUTS, FieldType.INT, 900, 1.0, -1.0, -1.0, ""),
m_pressureTarget_kPa("GDI: target pressure", SensorCategory.SENSOR_INPUTS, FieldType.INT, 908, 1.0, -1.0, -1.0, ""),
nextLobe("GDI: nextLobe", SensorCategory.SENSOR_INPUTS, FieldType.INT, 912, 1.0, -1.0, -1.0, ""),
di_nextStart("GDI: next start", SensorCategory.SENSOR_INPUTS, FieldType.INT, 916, 1.0, 0.0, 100.0, "v"),
m_deadtime("injectorLag(VBatt)\nthis value depends on a slow-changing VBatt value, so\nwe update it once in a while", SensorCategory.SENSOR_INPUTS, FieldType.INT, 920, 1.0, -1.0, -1.0, ""),
pressureDelta("fuel: injector pressureDelta", SensorCategory.SENSOR_INPUTS, FieldType.INT, 924, 1.0, -10000.0, 10000.0, "kPa"),
pressureRatio("fuel: injector pressureRatio", SensorCategory.SENSOR_INPUTS, FieldType.INT, 928, 1.0, -10000.0, 10000.0, ""),
retardThresholdRpm("retardThresholdRpm", SensorCategory.SENSOR_INPUTS, FieldType.INT, 932, 1.0, -1.0, -1.0, ""),
fuelALSCorrection("fuelALSCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT, 944, 1.0, -1.0, -1.0, ""),
timingALSCorrection("timingALSCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 948, 0.01, -20.0, 20.0, "deg"),
timingALSSkip("timingALSSkip", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 950, 0.01, 0.0, 50.0, "deg"),
luaTargetAdd("Boost: Lua Target Add", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 956, 0.5, -100.0, 100.0, "v"),
boostOutput("Boost: Output", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 958, 0.01, -100.0, 100.0, "percent"),
luaTargetMult("Boost: Lua Target Mult", SensorCategory.SENSOR_INPUTS, FieldType.INT, 960, 1.0, -100.0, 100.0, "v"),
openLoopPart("Boost: Open Loop", SensorCategory.SENSOR_INPUTS, FieldType.INT, 964, 1.0, -100.0, 100.0, "v"),
luaOpenLoopAdd("Boost: Lua Open Loop Add", SensorCategory.SENSOR_INPUTS, FieldType.INT, 968, 1.0, -100.0, 100.0, "v"),
boostControllerClosedLoopPart("Boost Closed Loop", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 972, 0.5, -50.0, 50.0, "%"),
alignmentFill_at_21("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 973, 1.0, -20.0, 100.0, "units"),
boostControlTarget("Boost Target", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 974, 0.03333333333333333, 0.0, 300.0, "kPa"),
latest_usage_ac_control("AC latest activity", SensorCategory.SENSOR_INPUTS, FieldType.INT, 980, 1.0, -1.0, -1.0, ""),
acSwitchLastChangeTimeMs("acSwitchLastChangeTimeMs", SensorCategory.SENSOR_INPUTS, FieldType.INT, 984, 1.0, -1.0, -1.0, ""),
lua("lua", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1000, 1.0, -1.0, -1.0, ""),
sd("sd", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1012, 1.0, -1.0, -1.0, ""),
engineCycleDurationMs("engineCycleDurationMs", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1024, 1.0, -1.0, -1.0, ""),
minRpmKcurrentTPS("minRpmKcurrentTPS", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1028, 1.0, -1.0, -1.0, ""),
currentTpsAdc("currentTpsAdc", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1032, 1.0, -1.0, -1.0, ""),
tpsVoltageMCU("tpsVoltageMCU", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1036, 1.0, -1.0, -1.0, ""),
tpsVoltageBoard("tpsVoltageBoard", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1040, 1.0, -1.0, -1.0, ""),
currentBaroCorrectedVE("currentBaroCorrectedVE", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1044, 1.0, -1.0, -1.0, ""),
injectorFlowCorrection("injectorFlowCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1048, 1.0, -1.0, -1.0, ""),
baroCorrection("fuel: Barometric pressure mult", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1052, 1.0, -1.0, -1.0, ""),
...
alignmentFill_at_78("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1078, 1.0, -20.0, 100.0, "units"),
...
alignmentFill_at_98("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1098, 1.0, -20.0, 100.0, "units"),
fuelInjectionCounter("fuelInjectionCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1100, 1.0, -1.0, -1.0, ""),
sparkCounter("sparkCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1104, 1.0, -1.0, -1.0, ""),
fuelingLoad("fuel: load", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1108, 1.0, -1.0, -1.0, ""),
ignitionLoad("Ignition: load", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1112, 1.0, -1.0, -1.0, ""),
veTableYAxis("veTableYAxis", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1116, 0.01, 0.0, 0.0, "%"),
alignmentFill_at_118("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1118, 1.0, -20.0, 100.0, "units"),
tpsFrom("tpsFrom", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1120, 1.0, -1.0, -1.0, ""),
tpsTo("tpsTo", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1124, 1.0, -1.0, -1.0, ""),
deltaTps("deltaTps", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1128, 1.0, -1.0, -1.0, ""),
...
triggerSyncGapRatio("Sync: Trigger Latest Ratio", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1236, 1.0, -10000.0, 10000.0, ""),
...
faultCode("faultCode", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1348, 1.0, -1.0, -1.0, ""),
heaterDuty("heaterDuty", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1349, 1.0, 0.0, 100.0, "%"),
pumpDuty("pumpDuty", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1350, 1.0, 0.0, 100.0, "%"),
alignmentFill_at_3("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1351, 1.0, -20.0, 100.0, "units"),
tempC("tempC", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1352, 1.0, 500.0, 1000.0, "C"),
nernstVoltage("nernstVoltage", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1354, 0.001, 0.0, 1.0, "V"),
esr("esr", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1356, 1.0, -1.0, -1.0, ""),
