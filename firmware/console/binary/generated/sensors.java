...
brokenInjector("brokenInjector", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 848, 1.0, -1.0, -1.0, ""),
alignmentFill_at_45("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 849, 1.0, -20.0, 100.0, "units"),
baseDwell("Ignition: base dwell", SensorCategory.SENSOR_INPUTS, FieldType.INT, 856, 1.0, 0.0, 30.0, "ms"),
sparkDwell("Ignition: coil charge time", SensorCategory.SENSOR_INPUTS, FieldType.INT, 860, 1.0, 0.0, 30.0, "ms"),
dwellAngle("Ignition: dwell duration\nas crankshaft angle\nNAN if engine is stopped\nSee also sparkDwell", SensorCategory.SENSOR_INPUTS, FieldType.INT, 864, 1.0, 0.0, 120.0, "deg"),
cltTimingCorrection("Ign: CLT correction", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 868, 0.01, -20.0, 20.0, "deg"),
timingIatCorrection("Ign: IAT correction", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 870, 0.01, -20.0, 20.0, "deg"),
timingPidCorrection("Idle: Timing adjustment", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 872, 0.01, -20.0, 20.0, "deg"),
baseIgnitionAdvance("Ignition: Timing", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 874, 0.02, 0.0, 0.0, "deg"),
correctedIgnitionAdvance("Timing: ignition", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 876, 0.02, 0.0, 0.0, "deg"),
alignmentFill_at_22("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 878, 1.0, -20.0, 100.0, "units"),
dwellVoltageCorrection("Ign: Dwell voltage correction", SensorCategory.SENSOR_INPUTS, FieldType.INT, 880, 1.0, -1.0, -1.0, ""),
luaTimingAdd("Ign: Lua timing add", SensorCategory.SENSOR_INPUTS, FieldType.INT, 884, 1.0, -20.0, 20.0, "deg"),
luaTimingMult("Ign: Lua timing mult", SensorCategory.SENSOR_INPUTS, FieldType.INT, 888, 1.0, -20.0, 20.0, "deg"),
m_knockLevel("Knock: Current level", SensorCategory.SENSOR_INPUTS, FieldType.INT, 896, 1.0, 0.0, 0.0, "Volts"),
m_knockCyl1("Knock: Cyl 1", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 900, 1.0, 0.0, 0.0, "dBv"),
m_knockCyl2("Knock: Cyl 2", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 901, 1.0, 0.0, 0.0, "dBv"),
m_knockCyl3("Knock: Cyl 3", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 902, 1.0, 0.0, 0.0, "dBv"),
m_knockCyl4("Knock: Cyl 4", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 903, 1.0, 0.0, 0.0, "dBv"),
m_knockCyl5("Knock: Cyl 5", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 904, 1.0, 0.0, 0.0, "dBv"),
m_knockCyl6("Knock: Cyl 6", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 905, 1.0, 0.0, 0.0, "dBv"),
m_knockCyl7("Knock: Cyl 7", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 906, 1.0, 0.0, 0.0, "dBv"),
m_knockCyl8("Knock: Cyl 8", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 907, 1.0, 0.0, 0.0, "dBv"),
m_knockCyl9("Knock: Cyl 9", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 908, 1.0, 0.0, 0.0, "dBv"),
m_knockCyl10("Knock: Cyl 10", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 909, 1.0, 0.0, 0.0, "dBv"),
m_knockCyl11("Knock: Cyl 11", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 910, 1.0, 0.0, 0.0, "dBv"),
m_knockCyl12("Knock: Cyl 12", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 911, 1.0, 0.0, 0.0, "dBv"),
m_knockRetard("Knock: Retard", SensorCategory.SENSOR_INPUTS, FieldType.INT, 912, 1.0, 0.0, 0.0, "deg"),
m_knockThreshold("Knock: Threshold", SensorCategory.SENSOR_INPUTS, FieldType.INT, 916, 1.0, -1.0, -1.0, ""),
m_knockCount("Knock: Count", SensorCategory.SENSOR_INPUTS, FieldType.INT, 920, 1.0, 0.0, 0.0, ""),
m_maximumRetard("Knock: Max retard", SensorCategory.SENSOR_INPUTS, FieldType.INT, 924, 1.0, -1.0, -1.0, ""),
