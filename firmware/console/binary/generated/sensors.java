...
maxLockedDuration("maxLockedDuration", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 388, 1.0, 0.0, 65535.0, "us"),
maxTriggerReentrant("maxTriggerReentrant", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 390, 1.0, 0.0, 100.0, ""),
alignmentFill_at_391("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 391, 1.0, -20.0, 100.0, "units"),
...
unusedAtTheEnd151("unusedAtTheEnd 151", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 742, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd152("unusedAtTheEnd 152", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 743, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd153("unusedAtTheEnd 153", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 744, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd154("unusedAtTheEnd 154", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 745, 1.0, 0.0, 0.0, ""),
...
baroCorrection("fuel: Barometric pressure correction", SensorCategory.SENSOR_INPUTS, FieldType.INT, 932, 1.0, -1.0, -1.0, ""),
...
fuelingLoad("fuel: load", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1020, 1.0, -1.0, -1.0, ""),
ignitionLoad("ign: load", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1024, 1.0, -1.0, -1.0, ""),
...
crankSynchronizationCounter("Crank sync counter\nUsually matches crank revolutions", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1120, 1.0, -1.0, -1.0, ""),
vvtSyncGapRatio("vvtSyncGapRatio", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1124, 1.0, -10000.0, 10000.0, ""),
vvtCurrentPosition("vvtCurrentPosition", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1128, 1.0, -10000.0, 10000.0, ""),
triggerSyncGapRatio("Trigger Sync Latest Ratio", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1132, 1.0, -10000.0, 10000.0, ""),
triggerActualSyncGapRatio("trigger: unused field?", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1136, 1.0, -1.0, -1.0, ""),
triggerStateIndex("triggerStateIndex", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1140, 1.0, -1.0, -1.0, ""),
vvtCounter("vvtCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1141, 1.0, -1.0, -1.0, ""),
camResyncCounter("camResyncCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1142, 1.0, -1.0, -1.0, ""),
vvtStateIndex("vvtStateIndex", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1143, 1.0, -1.0, -1.0, ""),
wallFuelCorrection("fuel injection time correction to account for wall wetting effect for current cycle", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1148, 1.0, -1.0, -1.0, ""),
wallFuel("Amount of fuel on the wall, in ms of injector open time for each injector.", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1152, 1.0, -1.0, -1.0, ""),
idleState("idleState", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1156, 1.0, -1.0, -1.0, ""),
currentIdlePosition("idle: current position\nthat's current position with CLT and IAT corrections", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1160, 1.0, -1.0, -1.0, ""),
baseIdlePosition("idle: base value\ncurrent position without adjustments (iacByTpsTaper, afterCrankingIACtaperDuration)", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1164, 1.0, -1.0, -1.0, ""),
iacByTpsTaper("idle: iacByTpsTaper portion of idle", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1168, 1.0, -1.0, -1.0, ""),
throttlePedalUpState("true in IDLE throttle pedal state, false if driver is touching the pedal\ntodo: better name for this field?", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1172, 1.0, -1.0, -1.0, ""),
targetRpmByClt("idle: target by CLT", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1180, 1.0, -1.0, -1.0, ""),
targetRpmAcBump("idle: A/C bump", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1184, 1.0, -1.0, -1.0, ""),
iacByRpmTaper("idle: iacByRpmTaper portion of idle", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1188, 1.0, -1.0, -1.0, ""),
luaAdd("idle: Lua Adder", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1192, 1.0, -1.0, -1.0, ""),
baseDwell("baseDwell", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1196, 1.0, -1.0, -1.0, ""),
dwellVoltageCorrection("dwellVoltageCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1200, 1.0, -1.0, -1.0, ""),
luaTimingAdd("luaTimingAdd", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1204, 1.0, -1.0, -1.0, ""),
luaTimingMult("luaTimingMult", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1208, 1.0, -1.0, -1.0, ""),
idlePosition("idlePosition", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1212, 1.0, -1.0, -1.0, ""),
trim("trim", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1216, 1.0, -1.0, -1.0, ""),
luaAdjustment("luaAdjustment", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1220, 1.0, -1.0, -1.0, ""),
etbFeedForward("etbFeedForward", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1224, 1.0, -1.0, -1.0, ""),
etbIntegralError("etbIntegralError", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1228, 1.0, -10000.0, 10000.0, ""),
etbCurrentTarget("etbCurrentTarget", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1232, 1.0, -10000.0, 10000.0, "%"),
faultCode("faultCode", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1240, 1.0, -1.0, -1.0, ""),
heaterDuty("heaterDuty", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1241, 1.0, 0.0, 100.0, "%"),
pumpDuty("pumpDuty", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1242, 1.0, 0.0, 100.0, "%"),
alignmentFill_at_3("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1243, 1.0, -20.0, 100.0, "units"),
tempC("tempC", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1244, 1.0, 500.0, 1000.0, "C"),
nernstVoltage("nernstVoltage", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1246, 0.001, 0.0, 1.0, "V"),
esr("esr", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1248, 1.0, -1.0, -1.0, ""),
alignmentFill_at_10("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1250, 1.0, -20.0, 100.0, "units"),
