...
etbDutyAverage("ETB average duty", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1636, 1.0, -20.0, 50.0, "%"),
...
tcEtbDrop("ETB traction control", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1645, 1.0, 0.0, 100.0, "%"),
jamTimer("ETB jam timer", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1646, 0.01, 0.0, 100.0, "sec"),
adjustedEtbTarget("ETB with adjustments", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1648, 1.0, 0.0, 100.0, "%"),
alignmentFill_at_53("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1649, 1.0, -20.0, 100.0, "units"),
targetWithIdlePosition("ETB: target with idle", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1596, 1.0, 0.0, 10.0, "per"),
trim("ETB: trim", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1600, 1.0, -1.0, -1.0, ""),
luaAdjustment("ETB: luaAdjustment", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1604, 1.0, 0.0, 3.0, "per"),
m_wastegatePosition("DC: wastegatePosition", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1608, 1.0, 0.0, 3.0, "per"),
...
adjustedEtbTarget("ETB with adjustments", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1648, 1.0, 0.0, 100.0, "%"),
alignmentFill_at_53("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1649, 1.0, -20.0, 100.0, "units"),
faultCode("WBO: Fault code", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1708, 1.0, -1.0, -1.0, ""),
heaterDuty("WBO: Heater duty", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1709, 1.0, 0.0, 100.0, "%"),
pumpDuty("WBO: Pump duty", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1710, 1.0, 0.0, 100.0, "%"),
alignmentFill_at_3("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1711, 1.0, -20.0, 100.0, "units"),
tempC("WBO: Temperature", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1712, 1.0, 500.0, 1000.0, "C"),
nernstVoltage("WBO: Nernst Voltage", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1714, 0.001, 0.0, 1.0, "V"),
esr("WBO: ESR", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1716, 1.0, 0.0, 10000.0, "ohm"),
alignmentFill_at_10("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1718, 1.0, -20.0, 100.0, "units"),
faultCode("WBO: Fault code", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1708, 1.0, -1.0, -1.0, ""),
heaterDuty("WBO: Heater duty", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1709, 1.0, 0.0, 100.0, "%"),
pumpDuty("WBO: Pump duty", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1710, 1.0, 0.0, 100.0, "%"),
alignmentFill_at_3("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1711, 1.0, -20.0, 100.0, "units"),
...
esr("WBO: ESR", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1716, 1.0, 0.0, 10000.0, "ohm"),
alignmentFill_at_10("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1718, 1.0, -20.0, 100.0, "units"),
dcOutput0("DC: output0", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1732, 1.0, 0.0, 10.0, "per"),
isEnabled0_int("DC: en0", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1736, 1.0, 0.0, 10.0, "per"),
alignmentFill_at_5("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1737, 1.0, -20.0, 100.0, "units"),
value0("ETB: SENT value0", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1744, 1.0, 0.0, 3.0, "value"),
value1("ETB: SENT value1", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1746, 1.0, 0.0, 3.0, "value"),
errorRate("ETB: SENT error rate", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1748, 1.0, 0.0, 3.0, "ratio"),
vvtTarget("vvtTarget", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1752, 0.1, -90.0, 90.0, "deg"),
vvtOutput("vvtOutput", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1754, 0.5, 100.0, 1.0, "%"),
alignmentFill_at_3("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1755, 1.0, -20.0, 100.0, "units"),
lambdaTimeSinceGood("lambdaTimeSinceGood", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1760, 0.01, 0.0, 1.0, "sec"),
alignmentFill_at_6("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1762, 1.0, -20.0, 100.0, "units"),
