...
injectorLagMs("Fuel: injector lag", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 58, 0.0033333333333333335, 0.0, 0.0, "ms"),
engineMakeCodeNameCrc16("Engine CRC16", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 60, 1.0, 0.0, 0.0, "crc16"),
wallFuelAmount("Fuel: wall amount", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 62, 0.01, 0.0, 0.0, "mg"),
wallFuelCorrectionValue("Fuel: wall correction", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 64, 0.01, 0.0, 0.0, "mg"),
revolutionCounterSinceStart("revolutionCounterSinceStart", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 66, 1.0, 0.0, 0.0, ""),
deltaTpsValue("Fuel: TPS AE change", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 68, 0.01, 0.0, 0.0, "ratio"),
canReadCounter("canReadCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 70, 1.0, 0.0, 0.0, ""),
tpsAccelFuel("Fuel: TPS AE add fuel ms", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 72, 0.0033333333333333335, 0.0, 0.0, "ms"),
currentIgnitionMode("Ign: Mode", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 74, 1.0, -1.0, -1.0, ""),
currentInjectionMode("Fuel: Injection mode", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 75, 1.0, -1.0, -1.0, ""),
coilDutyCycle("Ign: Coil duty cycle", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 76, 0.01, 0.0, 0.0, "%"),
idleAirValvePosition("Idle: Position", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 78, 0.01, 0.0, 0.0, "%"),
...
detectedGear("Detected Gear", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 120, 1.0, 0.0, 8.0, ""),
...
tpsAccelFrom("Fuel: TPS AE From", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 318, 1.0, 0.0, 100.0, "%"),
tpsAccelTo("Fuel: TPS AE To", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 319, 1.0, 0.0, 100.0, "%"),
...
engineCycleDurationMs("engineCycleDurationMs", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1064, 1.0, -1.0, -1.0, ""),
minRpmKcurrentTPS("minRpmKcurrentTPS", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1068, 1.0, -1.0, -1.0, ""),
currentTpsAdc("currentTpsAdc", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1072, 1.0, -1.0, -1.0, ""),
tpsVoltageMCU("tpsVoltageMCU", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1076, 1.0, -1.0, -1.0, ""),
tpsVoltageBoard("tpsVoltageBoard", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1080, 1.0, -1.0, -1.0, ""),
currentBaroCorrectedVE("currentBaroCorrectedVE", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1084, 1.0, -1.0, -1.0, ""),
injectorFlowCorrection("injectorFlowCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1088, 1.0, -1.0, -1.0, ""),
baroCorrection("Fuel: Barometric pressure mult", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1092, 1.0, -1.0, -1.0, ""),
crankingFuel("crankingFuel", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1096, 1.0, -1.0, -1.0, ""),
hellenBoardId("Detected Board ID", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1116, 1.0, 0.0, 3000.0, "id"),
alignmentFill_at_74("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1118, 1.0, -20.0, 100.0, "units"),
startStopStateToggleCounter("startStopStateToggleCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1124, 1.0, -1.0, -1.0, ""),
egtValue1("egtValue1", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1128, 1.0, -1.0, -1.0, ""),
egtValue2("egtValue2", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1132, 1.0, -1.0, -1.0, ""),
desiredRpmLimit("User-defined RPM hard limit", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1136, 1.0, 0.0, 30000.0, "rpm"),
alignmentFill_at_94("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1138, 1.0, -20.0, 100.0, "units"),
fuelInjectionCounter("fuelInjectionCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1140, 1.0, -1.0, -1.0, ""),
sparkCounter("sparkCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1144, 1.0, -1.0, -1.0, ""),
fuelingLoad("Fuel: load", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1148, 1.0, -1.0, -1.0, ""),
ignitionLoad("Ign: Load", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1152, 1.0, -1.0, -1.0, ""),
veTableYAxis("veTableYAxis", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1156, 0.01, 0.0, 0.0, "%"),
alignmentFill_at_114("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1158, 1.0, -20.0, 100.0, "units"),
tpsFrom("tpsFrom", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1160, 1.0, -1.0, -1.0, ""),
tpsTo("tpsTo", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1164, 1.0, -1.0, -1.0, ""),
deltaTps("deltaTps", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1168, 1.0, -1.0, -1.0, ""),
extraFuel("extraFuel", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1172, 1.0, -1.0, -1.0, ""),
valueFromTable("valueFromTable", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1176, 1.0, -1.0, -1.0, ""),
fractionalInjFuel("fractionalInjFuel", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1184, 1.0, -1.0, -1.0, ""),
accumulatedValue("accumulatedValue", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1188, 1.0, -1.0, -1.0, ""),
maxExtraPerCycle("maxExtraPerCycle", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1192, 1.0, -1.0, -1.0, ""),
maxExtraPerPeriod("maxExtraPerPeriod", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1196, 1.0, -1.0, -1.0, ""),
maxInjectedPerPeriod("maxInjectedPerPeriod", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1200, 1.0, -1.0, -1.0, ""),
cycleCnt("cycleCnt", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1204, 1.0, -1.0, -1.0, ""),
hwEventCounters1("Hardware events since boot 1", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1208, 1.0, -1.0, -1.0, ""),
hwEventCounters2("Hardware events since boot 2", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1212, 1.0, -1.0, -1.0, ""),
hwEventCounters3("Hardware events since boot 3", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1216, 1.0, -1.0, -1.0, ""),
hwEventCounters4("Hardware events since boot 4", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1220, 1.0, -1.0, -1.0, ""),
hwEventCounters5("Hardware events since boot 5", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1224, 1.0, -1.0, -1.0, ""),
hwEventCounters6("Hardware events since boot 6", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1228, 1.0, -1.0, -1.0, ""),
vvtCamCounter("Sync: total cams front counter", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1232, 1.0, -1.0, -1.0, ""),
mapVvt_MAP_AT_SPECIAL_POINT("mapVvt_MAP_AT_SPECIAL_POINT", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1236, 1.0, -10000.0, 10000.0, ""),
mapVvt_MAP_AT_DIFF("mapVvt_MAP_AT_DIFF", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1240, 1.0, -10000.0, 10000.0, ""),
mapVvt_MAP_AT_CYCLE_COUNT("mapVvt_MAP_AT_CYCLE_COUNT", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1244, 1.0, -10000.0, 10000.0, ""),
mapVvt_map_peak("mapVvt_map_peak", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1245, 1.0, -10000.0, 10000.0, ""),
alignmentFill_at_38("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1246, 1.0, -20.0, 100.0, "units"),
currentEngineDecodedPhase("Sync: Engine Phase", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1248, 1.0, 0.0, 0.0, "deg"),
triggerToothAngleError("Sync: trigger angle error", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1252, 1.0, -30.0, 30.0, "deg"),
triggerIgnoredToothCount("triggerIgnoredToothCount", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1256, 1.0, -1.0, -1.0, ""),
alignmentFill_at_49("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1257, 1.0, -20.0, 100.0, "units"),
crankSynchronizationCounter("sync: Crank sync counter\nUsually matches crank revolutions", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1260, 1.0, -1.0, -1.0, ""),
vvtSyncGapRatio("vvtSyncGapRatio", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1264, 1.0, -10000.0, 10000.0, ""),
vvtToothDurations0("vvtToothDurations0", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1268, 1.0, 0.0, 100000.0, "us"),
vvtCurrentPosition("vvtCurrentPosition", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1272, 1.0, -10000.0, 10000.0, ""),
...
vvtCounter("vvtCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1281, 1.0, -1.0, -1.0, ""),
camResyncCounter("camResyncCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1282, 1.0, -1.0, -1.0, ""),
vvtStateIndex("vvtStateIndex", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1283, 1.0, -1.0, -1.0, ""),
...
currentIdlePosition("idle: current position\nthat's current position with CLT and IAT corrections", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1300, 1.0, -1.0, -1.0, ""),
...
iacByTpsTaper("idle: iacByTpsTaper portion", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1308, 1.0, -1.0, -1.0, ""),
throttlePedalUpState("idle: throttlePedalUpState\ntrue in IDLE throttle pedal state, false if driver is touching the pedal\ntodo: better name for this field?", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1312, 1.0, -1.0, -1.0, ""),
targetRpmByClt("idle: target by CLT", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1320, 1.0, -1.0, -1.0, ""),
targetRpmAcBump("idle: A/C bump", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1324, 1.0, -1.0, -1.0, ""),
iacByRpmTaper("idle: iacByRpmTaper portion", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1328, 1.0, -1.0, -1.0, ""),
luaAdd("idle: Lua Adder", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1332, 1.0, -1.0, -1.0, ""),
idlePosition("ETB: idlePosition", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1336, 1.0, 0.0, 10.0, "per"),
trim("ETB: trim", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1340, 1.0, -1.0, -1.0, ""),
luaAdjustment("ETB: luaAdjustment", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1344, 1.0, 0.0, 3.0, "per"),
m_wastegatePosition("DC: wastegatePosition", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1348, 1.0, 0.0, 3.0, "per"),
etbFeedForward("etbFeedForward", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1352, 1.0, -1.0, -1.0, ""),
etbIntegralError("etbIntegralError", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1356, 1.0, -10000.0, 10000.0, ""),
etbCurrentTarget("etbCurrentTarget", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1360, 1.0, -10000.0, 10000.0, "%"),
etbCurrentAdjustedTarget("etbCurrentAdjustedTarget", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1364, 1.0, -10000.0, 10000.0, "%"),
etbDutyRateOfChange("ETB duty rate of change", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1372, 1.0, 0.0, 25.0, "per"),
etbDutyAverage("ETB average duty", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1376, 1.0, -20.0, 50.0, "per"),
etbTpsErrorCounter("ETB TPS error counter", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1380, 1.0, 0.0, 3.0, "count"),
etbPpsErrorCounter("ETB pedal error counter", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1382, 1.0, 0.0, 3.0, "count"),
etbErrorCode("etbErrorCode", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1384, 1.0, -1.0, -1.0, ""),
alignmentFill_at_49("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1385, 1.0, -20.0, 100.0, "units"),
jamTimer("ETB jam timer", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1386, 0.01, 0.0, 100.0, "sec"),
faultCode("faultCode", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1388, 1.0, -1.0, -1.0, ""),
heaterDuty("heaterDuty", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1389, 1.0, 0.0, 100.0, "%"),
pumpDuty("pumpDuty", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1390, 1.0, 0.0, 100.0, "%"),
alignmentFill_at_3("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1391, 1.0, -20.0, 100.0, "units"),
tempC("tempC", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1392, 1.0, 500.0, 1000.0, "C"),
nernstVoltage("nernstVoltage", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1394, 0.001, 0.0, 1.0, "V"),
esr("esr", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1396, 1.0, -1.0, -1.0, ""),
alignmentFill_at_10("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1398, 1.0, -20.0, 100.0, "units"),
dcOutput0("DC: output0", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1400, 1.0, 0.0, 10.0, "per"),
isEnabled0_int("DC: en0", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1404, 1.0, 0.0, 10.0, "per"),
alignmentFill_at_5("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1405, 1.0, -20.0, 100.0, "units"),
value0("ETB: SENT value0", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1412, 1.0, 0.0, 3.0, "value"),
value1("ETB: SENT value1", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1414, 1.0, 0.0, 3.0, "value"),
errorRate("ETB: SENT error rate", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1416, 1.0, 0.0, 3.0, "ratio"),
