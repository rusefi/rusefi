...
sparkDwell("dwell: coil charge time", SensorCategory.SENSOR_INPUTS, FieldType.INT, 796, 1.0, -1.0, -1.0, ""),
dwellAngle("ignition dwell duration\nas crankshaft angle\nNAN if engine is stopped\nSee also sparkDwell", SensorCategory.SENSOR_INPUTS, FieldType.INT, 800, 1.0, -1.0, -1.0, ""),
cltTimingCorrection("cltTimingCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 804, 0.01, -20.0, 20.0, "deg"),
timingIatCorrection("timingIatCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 806, 0.01, -20.0, 20.0, "deg"),
timingPidCorrection("timingPidCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 808, 0.01, -20.0, 20.0, "deg"),
alignmentFill_at_14("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 810, 1.0, -20.0, 100.0, "units"),
