...
baseDwell("Ignition: base dwell", SensorCategory.SENSOR_INPUTS, FieldType.INT, 828, 1.0, 0.0, 30.0, "ms"),
sparkDwell("Ignition: coil charge time", SensorCategory.SENSOR_INPUTS, FieldType.INT, 832, 1.0, 0.0, 30.0, "ms"),
...
cltTimingCorrection("Ignition: CLT correction", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 840, 0.01, -20.0, 20.0, "deg"),
timingIatCorrection("Ignition: IAT correction", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 842, 0.01, -20.0, 20.0, "deg"),
timingPidCorrection("Ignition: PID correction", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 844, 0.01, -20.0, 20.0, "deg"),
...
fuel_requested_percent("GDI: requested_percent", SensorCategory.SENSOR_INPUTS, FieldType.INT, 880, 1.0, -1.0, -1.0, ""),
fuel_requested_percent_pi("GDI: percent_pi", SensorCategory.SENSOR_INPUTS, FieldType.INT, 884, 1.0, -1.0, -1.0, ""),
m_pressureTarget_kPa("GDI: target pressure", SensorCategory.SENSOR_INPUTS, FieldType.INT, 892, 1.0, -1.0, -1.0, ""),
nextLobe("GDI: nextLobe", SensorCategory.SENSOR_INPUTS, FieldType.INT, 896, 1.0, -1.0, -1.0, ""),
di_nextStart("GDI: next start", SensorCategory.SENSOR_INPUTS, FieldType.INT, 900, 1.0, 0.0, 100.0, "v"),
m_deadtime("injectorLag(VBatt)\nthis value depends on a slow-changing VBatt value, so\nwe update it once in a while", SensorCategory.SENSOR_INPUTS, FieldType.INT, 904, 1.0, -1.0, -1.0, ""),
pressureDelta("fuel: injector pressureDelta", SensorCategory.SENSOR_INPUTS, FieldType.INT, 908, 1.0, -10000.0, 10000.0, "kPa"),
pressureRatio("fuel: injector pressureRatio", SensorCategory.SENSOR_INPUTS, FieldType.INT, 912, 1.0, -10000.0, 10000.0, ""),
retardThresholdRpm("retardThresholdRpm", SensorCategory.SENSOR_INPUTS, FieldType.INT, 916, 1.0, -1.0, -1.0, ""),
fuelALSCorrection("fuelALSCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT, 928, 1.0, -1.0, -1.0, ""),
timingALSCorrection("timingALSCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 932, 0.01, -20.0, 20.0, "deg"),
timingALSSkip("timingALSSkip", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 934, 0.01, 0.0, 50.0, "deg"),
luaTargetAdd("Boost: Lua Target Add", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 940, 0.5, -100.0, 100.0, "v"),
boostOutput("Boost: Output", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 942, 0.01, -100.0, 100.0, "percent"),
luaTargetMult("Boost: Lua Target Mult", SensorCategory.SENSOR_INPUTS, FieldType.INT, 944, 1.0, -100.0, 100.0, "v"),
openLoopPart("Boost: Open Loop", SensorCategory.SENSOR_INPUTS, FieldType.INT, 948, 1.0, -100.0, 100.0, "v"),
luaOpenLoopAdd("Boost: Lua Open Loop Add", SensorCategory.SENSOR_INPUTS, FieldType.INT, 952, 1.0, -100.0, 100.0, "v"),
boostControllerClosedLoopPart("Boost Closed Loop", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 956, 0.5, -50.0, 50.0, "%"),
alignmentFill_at_21("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 957, 1.0, -20.0, 100.0, "units"),
boostControlTarget("Boost Target", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 958, 0.03333333333333333, 0.0, 300.0, "kPa"),
latest_usage_ac_control("AC latest activity", SensorCategory.SENSOR_INPUTS, FieldType.INT, 964, 1.0, -1.0, -1.0, ""),
acSwitchLastChangeTimeMs("acSwitchLastChangeTimeMs", SensorCategory.SENSOR_INPUTS, FieldType.INT, 968, 1.0, -1.0, -1.0, ""),
lua("lua", SensorCategory.SENSOR_INPUTS, FieldType.INT, 984, 1.0, -1.0, -1.0, ""),
sd("sd", SensorCategory.SENSOR_INPUTS, FieldType.INT, 996, 1.0, -1.0, -1.0, ""),
engineCycleDurationMs("engineCycleDurationMs", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1008, 1.0, -1.0, -1.0, ""),
minRpmKcurrentTPS("minRpmKcurrentTPS", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1012, 1.0, -1.0, -1.0, ""),
currentTpsAdc("currentTpsAdc", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1016, 1.0, -1.0, -1.0, ""),
tpsVoltageMCU("tpsVoltageMCU", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1020, 1.0, -1.0, -1.0, ""),
tpsVoltageBoard("tpsVoltageBoard", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1024, 1.0, -1.0, -1.0, ""),
currentBaroCorrectedVE("currentBaroCorrectedVE", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1028, 1.0, -1.0, -1.0, ""),
injectorFlowCorrection("injectorFlowCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1032, 1.0, -1.0, -1.0, ""),
baroCorrection("fuel: Barometric pressure mult", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1036, 1.0, -1.0, -1.0, ""),
crankingFuel("crankingFuel", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1040, 1.0, -1.0, -1.0, ""),
hellenBoardId("Detected Board ID", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1060, 1.0, 0.0, 3000.0, "id"),
alignmentFill_at_78("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1062, 1.0, -20.0, 100.0, "units"),
startStopStateToggleCounter("startStopStateToggleCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1068, 1.0, -1.0, -1.0, ""),
egtValue1("egtValue1", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1072, 1.0, -1.0, -1.0, ""),
egtValue2("egtValue2", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1076, 1.0, -1.0, -1.0, ""),
desiredRpmLimit("User-defined RPM hard limit", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1080, 1.0, 0.0, 30000.0, "rpm"),
alignmentFill_at_98("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1082, 1.0, -20.0, 100.0, "units"),
fuelInjectionCounter("fuelInjectionCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1084, 1.0, -1.0, -1.0, ""),
sparkCounter("sparkCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1088, 1.0, -1.0, -1.0, ""),
fuelingLoad("fuel: load", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1092, 1.0, -1.0, -1.0, ""),
ignitionLoad("Ignition: load", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1096, 1.0, -1.0, -1.0, ""),
veTableYAxis("veTableYAxis", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1100, 0.01, 0.0, 0.0, "%"),
alignmentFill_at_118("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1102, 1.0, -20.0, 100.0, "units"),
tpsFrom("tpsFrom", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1104, 1.0, -1.0, -1.0, ""),
tpsTo("tpsTo", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1108, 1.0, -1.0, -1.0, ""),
deltaTps("deltaTps", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1112, 1.0, -1.0, -1.0, ""),
extraFuel("extraFuel", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1116, 1.0, -1.0, -1.0, ""),
valueFromTable("valueFromTable", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1120, 1.0, -1.0, -1.0, ""),
fractionalInjFuel("fractionalInjFuel", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1128, 1.0, -1.0, -1.0, ""),
accumulatedValue("accumulatedValue", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1132, 1.0, -1.0, -1.0, ""),
maxExtraPerCycle("maxExtraPerCycle", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1136, 1.0, -1.0, -1.0, ""),
maxExtraPerPeriod("maxExtraPerPeriod", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1140, 1.0, -1.0, -1.0, ""),
maxInjectedPerPeriod("maxInjectedPerPeriod", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1144, 1.0, -1.0, -1.0, ""),
cycleCnt("cycleCnt", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1148, 1.0, -1.0, -1.0, ""),
hwEventCounters1("Hardware events since boot 1", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1152, 1.0, -1.0, -1.0, ""),
hwEventCounters2("Hardware events since boot 2", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1156, 1.0, -1.0, -1.0, ""),
hwEventCounters3("Hardware events since boot 3", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1160, 1.0, -1.0, -1.0, ""),
hwEventCounters4("Hardware events since boot 4", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1164, 1.0, -1.0, -1.0, ""),
hwEventCounters5("Hardware events since boot 5", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1168, 1.0, -1.0, -1.0, ""),
hwEventCounters6("Hardware events since boot 6", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1172, 1.0, -1.0, -1.0, ""),
vvtCamCounter("Sync: total cams front counter", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1176, 1.0, -1.0, -1.0, ""),
mapVvt_MAP_AT_SPECIAL_POINT("mapVvt_MAP_AT_SPECIAL_POINT", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1180, 1.0, -10000.0, 10000.0, ""),
mapVvt_MAP_AT_DIFF("mapVvt_MAP_AT_DIFF", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1184, 1.0, -10000.0, 10000.0, ""),
mapVvt_MAP_AT_CYCLE_COUNT("mapVvt_MAP_AT_CYCLE_COUNT", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1188, 1.0, -10000.0, 10000.0, ""),
mapVvt_map_peak("mapVvt_map_peak", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1189, 1.0, -10000.0, 10000.0, ""),
alignmentFill_at_38("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1190, 1.0, -20.0, 100.0, "units"),
currentEngineDecodedPhase("Sync: Engine Phase", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1192, 1.0, 0.0, 0.0, "deg"),
...
vvtCounter("vvtCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1225, 1.0, -1.0, -1.0, ""),
camResyncCounter("camResyncCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1226, 1.0, -1.0, -1.0, ""),
vvtStateIndex("vvtStateIndex", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1227, 1.0, -1.0, -1.0, ""),
wallFuelCorrection("fuel wallwetting injection time\n correction to account for wall wetting effect for current cycle", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1232, 1.0, -1.0, -1.0, ""),
wallFuel("Fuel on the wall\nin ms of injector open time for each injector.", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1236, 1.0, -1.0, -1.0, ""),
idleState("idleState", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1240, 1.0, -1.0, -1.0, ""),
currentIdlePosition("idle: current position\nthat's current position with CLT and IAT corrections", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1244, 1.0, -1.0, -1.0, ""),
baseIdlePosition("idle: base value\ncurrent position without adjustments (iacByTpsTaper, afterCrankingIACtaperDuration)", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1248, 1.0, -1.0, -1.0, ""),
iacByTpsTaper("idle: iacByTpsTaper portion", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1252, 1.0, -1.0, -1.0, ""),
throttlePedalUpState("idle: throttlePedalUpState\ntrue in IDLE throttle pedal state, false if driver is touching the pedal\ntodo: better name for this field?", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1256, 1.0, -1.0, -1.0, ""),
targetRpmByClt("idle: target by CLT", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1264, 1.0, -1.0, -1.0, ""),
targetRpmAcBump("idle: A/C bump", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1268, 1.0, -1.0, -1.0, ""),
iacByRpmTaper("idle: iacByRpmTaper portion", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1272, 1.0, -1.0, -1.0, ""),
luaAdd("idle: Lua Adder", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1276, 1.0, -1.0, -1.0, ""),
idlePosition("ETB: idlePosition", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1280, 1.0, 0.0, 10.0, "per"),
trim("ETB: trim", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1284, 1.0, -1.0, -1.0, ""),
luaAdjustment("ETB: luaAdjustment", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1288, 1.0, 0.0, 3.0, "per"),
m_wastegatePosition("DC: wastegatePosition", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1292, 1.0, 0.0, 3.0, "per"),
etbFeedForward("etbFeedForward", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1296, 1.0, -1.0, -1.0, ""),
...
etbErrorCode("etbErrorCode", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1328, 1.0, -1.0, -1.0, ""),
alignmentFill_at_49("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1329, 1.0, -20.0, 100.0, "units"),
jamTimer("ETB jam timer", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1330, 0.01, 0.0, 100.0, "sec"),
faultCode("faultCode", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1332, 1.0, -1.0, -1.0, ""),
heaterDuty("heaterDuty", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1333, 1.0, 0.0, 100.0, "%"),
pumpDuty("pumpDuty", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1334, 1.0, 0.0, 100.0, "%"),
alignmentFill_at_3("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1335, 1.0, -20.0, 100.0, "units"),
tempC("tempC", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1336, 1.0, 500.0, 1000.0, "C"),
nernstVoltage("nernstVoltage", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1338, 0.001, 0.0, 1.0, "V"),
esr("esr", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1340, 1.0, -1.0, -1.0, ""),
alignmentFill_at_10("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1342, 1.0, -20.0, 100.0, "units"),
dcOutput0("DC: output0", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1344, 1.0, 0.0, 10.0, "per"),
isEnabled0_int("DC: en0", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1348, 1.0, 0.0, 10.0, "per"),
alignmentFill_at_5("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1349, 1.0, -20.0, 100.0, "units"),
value0("ETB: SENT value0", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1356, 1.0, 0.0, 3.0, "value"),
value1("ETB: SENT value1", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1358, 1.0, 0.0, 3.0, "value"),
errorRate("ETB: SENT error rate", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1360, 1.0, 0.0, 3.0, "ratio"),
