...
m_requested_pump("DI: Pump Angle", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 328, 0.02, 0.0, 0.0, "deg"),
boostControlTarget("Boost Target", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 330, 0.03333333333333333, 0.0, 0.0, "kPa"),
sparkCutReason("Spark Cut Code", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 332, 1.0, 0.0, 0.0, "code"),
fuelCutReason("Fuel Cut Code", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 333, 1.0, 0.0, 0.0, "code"),
alignmentFill_at_334("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 334, 1.0, -20.0, 100.0, "units"),
fuel_requested_percent("DI: fuel_requested_percent", SensorCategory.SENSOR_INPUTS, FieldType.INT, 336, 1.0, 0.0, 100.0, "v"),
fuel_requested_percent_pi("DI: fuel_requested_percent_pi", SensorCategory.SENSOR_INPUTS, FieldType.INT, 340, 1.0, 0.0, 100.0, "v"),
m_I_sum_percent("DI: m_I_sum_percent", SensorCategory.SENSOR_INPUTS, FieldType.INT, 344, 1.0, 0.0, 100.0, "v"),
m_pressureTarget_kPa("DI: m_pressureTarget_kPa", SensorCategory.SENSOR_INPUTS, FieldType.INT, 348, 1.0, 0.0, 100.0, "v"),
mafEstimate("MAF estimate", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 352, 0.1, 0.0, 0.0, "kg/h"),
instantRpm("instantRpm", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 354, 1.0, 0.0, 0.0, "rpm"),
di_nextStart("DI: next start", SensorCategory.SENSOR_INPUTS, FieldType.INT, 356, 1.0, 0.0, 100.0, "v"),
systemEventReuse("systemEventReuse", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 360, 1.0, 0.0, 0.0, "counter"),
rawMap("rawMap", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 362, 0.001, 0.0, 5.0, "V"),
rawAfr("rawAfr", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 364, 0.001, 0.0, 5.0, "V"),
tpsAccelFrom("tpsAccelFrom", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 366, 1.0, 0.0, 100.0, "%"),
tpsAccelTo("tpsAccelTo", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 367, 1.0, 0.0, 100.0, "%"),
calibrationValue2("calibrationValue2", SensorCategory.SENSOR_INPUTS, FieldType.INT, 368, 1.0, 0.0, 0.0, ""),
...
issEdgeCounter("issEdgeCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT, 396, 1.0, -1.0, -1.0, ""),
auxLinear1("Aux Linear 1", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 400, 0.01, 0.0, 0.0, ""),
auxLinear2("Aux Linear 2", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 402, 0.01, 0.0, 0.0, ""),
boostControllerOutput("Boost Output", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 408, 0.5, 0.0, 100.0, "%"),
boostControllerOpenLoopPart("Boost Open Loop", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 409, 0.5, 0.0, 100.0, "%"),
...
maxLockedDuration("maxLockedDuration", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 426, 1.0, -10000.0, 10000.0, ""),
maxTriggerReentrant("maxTriggerReentrant", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 428, 1.0, -10000.0, 10000.0, ""),
canWriteOk("canWriteOk", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 430, 1.0, -10000.0, 10000.0, ""),
canWriteNotOk("canWriteNotOk", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 432, 1.0, -10000.0, 10000.0, ""),
alignmentFill_at_434("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 434, 1.0, -20.0, 100.0, "units"),
triggerPrimaryFall("triggerPrimaryFall", SensorCategory.SENSOR_INPUTS, FieldType.INT, 436, 1.0, -10000.0, 10000.0, ""),
triggerPrimaryRise("triggerPrimaryRise", SensorCategory.SENSOR_INPUTS, FieldType.INT, 440, 1.0, -10000.0, 10000.0, ""),
triggerSecondaryFall("triggerSecondaryFall", SensorCategory.SENSOR_INPUTS, FieldType.INT, 444, 1.0, -10000.0, 10000.0, ""),
triggerSecondaryRise("triggerSecondaryRise", SensorCategory.SENSOR_INPUTS, FieldType.INT, 448, 1.0, -10000.0, 10000.0, ""),
triggerVvtFall("triggerVvtFall", SensorCategory.SENSOR_INPUTS, FieldType.INT, 452, 1.0, -10000.0, 10000.0, ""),
triggerVvtRise("triggerVvtRise", SensorCategory.SENSOR_INPUTS, FieldType.INT, 456, 1.0, -10000.0, 10000.0, ""),
startStopStateToggleCounter("startStopStateToggleCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 460, 1.0, -10000.0, 10000.0, ""),
starterState("starterState", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 461, 1.0, -10000.0, 10000.0, ""),
starterRelayDisable("starterRelayDisable", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 462, 1.0, -10000.0, 10000.0, ""),
multiSparkCounter("multiSparkCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 463, 1.0, -10000.0, 10000.0, ""),
injectorFlowPressureRatio("injectorFlowPressureRatio", SensorCategory.SENSOR_INPUTS, FieldType.INT, 464, 1.0, -10000.0, 10000.0, ""),
injectorFlowPressureDelta("injectorFlowPressureDelta", SensorCategory.SENSOR_INPUTS, FieldType.INT, 468, 1.0, -10000.0, 10000.0, "kPa"),
etbIntegralError("etbIntegralError", SensorCategory.SENSOR_INPUTS, FieldType.INT, 472, 1.0, -10000.0, 10000.0, ""),
etbCurrentTarget("etbCurrentTarget", SensorCategory.SENSOR_INPUTS, FieldType.INT, 476, 1.0, -10000.0, 10000.0, "%"),
alternatorStatus("alternatorStatus", SensorCategory.SENSOR_INPUTS, FieldType.INT, 480, 1.0, -1.0, -1.0, ""),
idleStatus("idleStatus", SensorCategory.SENSOR_INPUTS, FieldType.INT, 492, 1.0, -1.0, -1.0, ""),
etbStatus("etbStatus", SensorCategory.SENSOR_INPUTS, FieldType.INT, 504, 1.0, -1.0, -1.0, ""),
...
unusedAtTheEnd1("unusedAtTheEnd 1", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 534, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd2("unusedAtTheEnd 2", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 535, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd3("unusedAtTheEnd 3", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 536, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd4("unusedAtTheEnd 4", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 537, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd5("unusedAtTheEnd 5", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 538, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd6("unusedAtTheEnd 6", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 539, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd7("unusedAtTheEnd 7", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 540, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd8("unusedAtTheEnd 8", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 541, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd9("unusedAtTheEnd 9", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 542, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd10("unusedAtTheEnd 10", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 543, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd11("unusedAtTheEnd 11", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 544, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd12("unusedAtTheEnd 12", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 545, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd13("unusedAtTheEnd 13", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 546, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd14("unusedAtTheEnd 14", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 547, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd15("unusedAtTheEnd 15", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 548, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd16("unusedAtTheEnd 16", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 549, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd17("unusedAtTheEnd 17", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 550, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd18("unusedAtTheEnd 18", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 551, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd19("unusedAtTheEnd 19", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 552, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd20("unusedAtTheEnd 20", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 553, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd21("unusedAtTheEnd 21", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 554, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd22("unusedAtTheEnd 22", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 555, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd23("unusedAtTheEnd 23", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 556, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd24("unusedAtTheEnd 24", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 557, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd25("unusedAtTheEnd 25", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 558, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd26("unusedAtTheEnd 26", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 559, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd27("unusedAtTheEnd 27", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 560, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd28("unusedAtTheEnd 28", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 561, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd29("unusedAtTheEnd 29", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 562, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd30("unusedAtTheEnd 30", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 563, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd31("unusedAtTheEnd 31", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 564, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd32("unusedAtTheEnd 32", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 565, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd33("unusedAtTheEnd 33", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 566, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd34("unusedAtTheEnd 34", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 567, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd35("unusedAtTheEnd 35", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 568, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd36("unusedAtTheEnd 36", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 569, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd37("unusedAtTheEnd 37", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 570, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd38("unusedAtTheEnd 38", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 571, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd39("unusedAtTheEnd 39", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 572, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd40("unusedAtTheEnd 40", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 573, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd41("unusedAtTheEnd 41", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 574, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd42("unusedAtTheEnd 42", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 575, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd43("unusedAtTheEnd 43", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 576, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd44("unusedAtTheEnd 44", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 577, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd45("unusedAtTheEnd 45", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 578, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd46("unusedAtTheEnd 46", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 579, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd47("unusedAtTheEnd 47", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 580, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd48("unusedAtTheEnd 48", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 581, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd49("unusedAtTheEnd 49", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 582, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd50("unusedAtTheEnd 50", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 583, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd51("unusedAtTheEnd 51", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 584, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd52("unusedAtTheEnd 52", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 585, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd53("unusedAtTheEnd 53", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 586, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd54("unusedAtTheEnd 54", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 587, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd55("unusedAtTheEnd 55", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 588, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd56("unusedAtTheEnd 56", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 589, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd57("unusedAtTheEnd 57", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 590, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd58("unusedAtTheEnd 58", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 591, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd59("unusedAtTheEnd 59", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 592, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd60("unusedAtTheEnd 60", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 593, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd61("unusedAtTheEnd 61", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 594, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd62("unusedAtTheEnd 62", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 595, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd63("unusedAtTheEnd 63", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 596, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd64("unusedAtTheEnd 64", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 597, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd65("unusedAtTheEnd 65", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 598, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd66("unusedAtTheEnd 66", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 599, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd67("unusedAtTheEnd 67", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 600, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd68("unusedAtTheEnd 68", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 601, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd69("unusedAtTheEnd 69", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 602, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd70("unusedAtTheEnd 70", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 603, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd71("unusedAtTheEnd 71", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 604, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd72("unusedAtTheEnd 72", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 605, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd73("unusedAtTheEnd 73", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 606, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd74("unusedAtTheEnd 74", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 607, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd75("unusedAtTheEnd 75", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 608, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd76("unusedAtTheEnd 76", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 609, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd77("unusedAtTheEnd 77", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 610, 1.0, 0.0, 0.0, ""),
unusedAtTheEnd78("unusedAtTheEnd 78", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 611, 1.0, 0.0, 0.0, ""),
m_knockRetard("Degrees retarded: larger number = more retard", SensorCategory.SENSOR_INPUTS, FieldType.INT, 612, 1.0, -1.0, -1.0, ""),
m_knockThreshold("m_knockThreshold", SensorCategory.SENSOR_INPUTS, FieldType.INT, 616, 1.0, -1.0, -1.0, ""),
m_knockCount("m_knockCount", SensorCategory.SENSOR_INPUTS, FieldType.INT, 620, 1.0, -1.0, -1.0, ""),
m_requested_pump("Computed requested pump duration in degrees (not including deadtime)", SensorCategory.SENSOR_INPUTS, FieldType.INT, 624, 1.0, -1.0, -1.0, ""),
fuel_requested_percent("fuel_requested_percent", SensorCategory.SENSOR_INPUTS, FieldType.INT, 628, 1.0, -1.0, -1.0, ""),
fuel_requested_percent_pi("fuel_requested_percent_pi", SensorCategory.SENSOR_INPUTS, FieldType.INT, 632, 1.0, -1.0, -1.0, ""),
nextLobe("nextLobe", SensorCategory.SENSOR_INPUTS, FieldType.INT, 640, 1.0, -1.0, -1.0, ""),
nextStart("nextStart", SensorCategory.SENSOR_INPUTS, FieldType.INT, 644, 1.0, -1.0, -1.0, ""),
m_deadtime("m_deadtime", SensorCategory.SENSOR_INPUTS, FieldType.INT, 648, 1.0, -1.0, -1.0, ""),
pressureDelta("pressureDelta", SensorCategory.SENSOR_INPUTS, FieldType.INT, 652, 1.0, -1.0, -1.0, ""),
pressureRatio("pressureRatio", SensorCategory.SENSOR_INPUTS, FieldType.INT, 656, 1.0, -1.0, -1.0, ""),
retardThresholdRpm("retardThresholdRpm", SensorCategory.SENSOR_INPUTS, FieldType.INT, 660, 1.0, -1.0, -1.0, ""),
openLoopPart("openLoopPart", SensorCategory.SENSOR_INPUTS, FieldType.INT, 672, 1.0, -1.0, -1.0, ""),
closedLoopPart("closedLoopPart", SensorCategory.SENSOR_INPUTS, FieldType.INT, 676, 1.0, -1.0, -1.0, ""),
latest_usage_ac_control("latest_usage_ac_control", SensorCategory.SENSOR_INPUTS, FieldType.INT, 684, 1.0, -1.0, -1.0, ""),
acSwitchLastChangeTimeMs("acSwitchLastChangeTimeMs", SensorCategory.SENSOR_INPUTS, FieldType.INT, 688, 1.0, -1.0, -1.0, ""),
sd("sd", SensorCategory.SENSOR_INPUTS, FieldType.INT, 704, 1.0, -1.0, -1.0, ""),
targetAFR("targetAFR", SensorCategory.SENSOR_INPUTS, FieldType.INT, 728, 1.0, -1.0, -1.0, ""),
engineCycleDurationMs("engineCycleDurationMs", SensorCategory.SENSOR_INPUTS, FieldType.INT, 732, 1.0, -1.0, -1.0, ""),
minRpmKcurrentTPS("minRpmKcurrentTPS", SensorCategory.SENSOR_INPUTS, FieldType.INT, 736, 1.0, -1.0, -1.0, ""),
currentTpsAdc("currentTpsAdc", SensorCategory.SENSOR_INPUTS, FieldType.INT, 740, 1.0, -1.0, -1.0, ""),
tpsVoltageMCU("tpsVoltageMCU", SensorCategory.SENSOR_INPUTS, FieldType.INT, 744, 1.0, -1.0, -1.0, ""),
tpsVoltageBoard("tpsVoltageBoard", SensorCategory.SENSOR_INPUTS, FieldType.INT, 748, 1.0, -1.0, -1.0, ""),
currentBaroCorrectedVE("currentBaroCorrectedVE", SensorCategory.SENSOR_INPUTS, FieldType.INT, 752, 1.0, -1.0, -1.0, ""),
injectorFlowCorrection("injectorFlowCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT, 756, 1.0, -1.0, -1.0, ""),
baroCorrection("baroCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT, 760, 1.0, -1.0, -1.0, ""),
cranking("cranking", SensorCategory.SENSOR_INPUTS, FieldType.INT, 764, 1.0, -1.0, -1.0, ""),
running("running", SensorCategory.SENSOR_INPUTS, FieldType.INT, 784, 1.0, -1.0, -1.0, ""),
etbFeedForward("etbFeedForward", SensorCategory.SENSOR_INPUTS, FieldType.INT, 812, 1.0, -1.0, -1.0, ""),
targetFromTable("targetFromTable", SensorCategory.SENSOR_INPUTS, FieldType.INT, 816, 1.0, -1.0, -1.0, ""),
...
cltTimingCorrection("cltTimingCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 828, 0.01, -20.0, 20.0, "deg"),
timingIatCorrection("timingIatCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 830, 0.01, -20.0, 20.0, "deg"),
timingPidCorrection("timingPidCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 832, 0.01, -20.0, 20.0, "deg"),
hellenBoardId("How does this board self identifies", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 834, 1.0, 0.0, 3000.0, "id"),
...
vvtSyncGapRatio("vvtSyncGapRatio", SensorCategory.SENSOR_INPUTS, FieldType.INT, 932, 1.0, -10000.0, 10000.0, ""),
vvtCurrentPosition("vvtCurrentPosition", SensorCategory.SENSOR_INPUTS, FieldType.INT, 936, 1.0, -10000.0, 10000.0, ""),
triggerSyncGapRatio("Trigger Sync Latest Ratio", SensorCategory.SENSOR_INPUTS, FieldType.INT, 940, 1.0, -10000.0, 10000.0, ""),
triggerActualSyncGapRatio("triggerActualSyncGapRatio", SensorCategory.SENSOR_INPUTS, FieldType.INT, 944, 1.0, -1.0, -1.0, ""),
triggerStateIndex("triggerStateIndex", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 948, 1.0, -1.0, -1.0, ""),
vvtCounter("vvtCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 949, 1.0, -1.0, -1.0, ""),
vvtSyncCounter("vvtSyncCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 950, 1.0, -1.0, -1.0, ""),
vvtStateIndex("vvtStateIndex", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 951, 1.0, -1.0, -1.0, ""),
wallFuelCorrection("fuel injection time correction to account for wall wetting effect for current cycle", SensorCategory.SENSOR_INPUTS, FieldType.INT, 952, 1.0, -1.0, -1.0, ""),
wallFuel("Amount of fuel on the wall, in ms of injector open time for each injector.", SensorCategory.SENSOR_INPUTS, FieldType.INT, 956, 1.0, -1.0, -1.0, ""),
idleState("idleState", SensorCategory.SENSOR_INPUTS, FieldType.INT, 960, 1.0, -1.0, -1.0, ""),
currentIdlePosition("that's current position with CLT and IAT corrections", SensorCategory.SENSOR_INPUTS, FieldType.INT, 964, 1.0, -1.0, -1.0, ""),
baseIdlePosition("current position without adjustments (iacByTpsTaper, afterCrankingIACtaperDuration)", SensorCategory.SENSOR_INPUTS, FieldType.INT, 968, 1.0, -1.0, -1.0, ""),
iacByTpsTaper("iacByTpsTaper portion of idle", SensorCategory.SENSOR_INPUTS, FieldType.INT, 972, 1.0, -1.0, -1.0, ""),
throttlePedalUpState("true in IDLE throttle pedal state, false if driver is touching the pedal\ntodo: better name for this field?", SensorCategory.SENSOR_INPUTS, FieldType.INT, 976, 1.0, -1.0, -1.0, ""),
targetRpmByClt("targetRpmByClt", SensorCategory.SENSOR_INPUTS, FieldType.INT, 984, 1.0, -1.0, -1.0, ""),
targetRpmAcBump("targetRpmAcBump", SensorCategory.SENSOR_INPUTS, FieldType.INT, 988, 1.0, -1.0, -1.0, ""),
baseDwell("baseDwell", SensorCategory.SENSOR_INPUTS, FieldType.INT, 992, 1.0, -1.0, -1.0, ""),
dwellVoltageCorrection("dwellVoltageCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT, 996, 1.0, -1.0, -1.0, ""),
luaTimingAdd("luaTimingAdd", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1000, 1.0, -1.0, -1.0, ""),
luaTimingMult("luaTimingMult", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1004, 1.0, -1.0, -1.0, ""),
idlePosition("idlePosition", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1008, 1.0, -1.0, -1.0, ""),
trim("trim", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1012, 1.0, -1.0, -1.0, ""),
luaAdjustment("luaAdjustment", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1016, 1.0, -1.0, -1.0, ""),
