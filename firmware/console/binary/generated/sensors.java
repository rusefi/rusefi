...
ignitionLoad("Ignition: load", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1092, 1.0, -1.0, -1.0, ""),
...
vvttoothDurations0("vvttoothDurations0", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1208, 1.0, -10000.0, 10000.0, ""),
vvtCurrentPosition("vvtCurrentPosition", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1212, 1.0, -10000.0, 10000.0, ""),
triggerSyncGapRatio("Trigger Sync Latest Ratio", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1216, 1.0, -10000.0, 10000.0, ""),
triggerStateIndex("triggerStateIndex", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1220, 1.0, -1.0, -1.0, ""),
vvtCounter("vvtCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1221, 1.0, -1.0, -1.0, ""),
camResyncCounter("camResyncCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1222, 1.0, -1.0, -1.0, ""),
vvtStateIndex("vvtStateIndex", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1223, 1.0, -1.0, -1.0, ""),
wallFuelCorrection("fuel wallwetting injection time\n correction to account for wall wetting effect for current cycle", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1228, 1.0, -1.0, -1.0, ""),
wallFuel("Fuel on the wall\nin ms of injector open time for each injector.", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1232, 1.0, -1.0, -1.0, ""),
idleState("idleState", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1236, 1.0, -1.0, -1.0, ""),
currentIdlePosition("idle: current position\nthat's current position with CLT and IAT corrections", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1240, 1.0, -1.0, -1.0, ""),
baseIdlePosition("idle: base value\ncurrent position without adjustments (iacByTpsTaper, afterCrankingIACtaperDuration)", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1244, 1.0, -1.0, -1.0, ""),
iacByTpsTaper("idle: iacByTpsTaper portion", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1248, 1.0, -1.0, -1.0, ""),
throttlePedalUpState("idle: throttlePedalUpState\ntrue in IDLE throttle pedal state, false if driver is touching the pedal\ntodo: better name for this field?", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1252, 1.0, -1.0, -1.0, ""),
targetRpmByClt("idle: target by CLT", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1260, 1.0, -1.0, -1.0, ""),
targetRpmAcBump("idle: A/C bump", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1264, 1.0, -1.0, -1.0, ""),
iacByRpmTaper("idle: iacByRpmTaper portion", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1268, 1.0, -1.0, -1.0, ""),
luaAdd("idle: Lua Adder", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1272, 1.0, -1.0, -1.0, ""),
idlePosition("ETB: idlePosition", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1276, 1.0, 0.0, 10.0, "per"),
trim("ETB: trim", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1280, 1.0, -1.0, -1.0, ""),
luaAdjustment("ETB: luaAdjustment", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1284, 1.0, 0.0, 3.0, "per"),
m_wastegatePosition("DC: wastegatePosition", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1288, 1.0, 0.0, 3.0, "per"),
etbFeedForward("etbFeedForward", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1292, 1.0, -1.0, -1.0, ""),
etbIntegralError("etbIntegralError", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1296, 1.0, -10000.0, 10000.0, ""),
etbCurrentTarget("etbCurrentTarget", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1300, 1.0, -10000.0, 10000.0, "%"),
etbCurrentAdjustedTarget("etbCurrentAdjustedTarget", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1304, 1.0, -10000.0, 10000.0, "%"),
etbDutyRateOfChange("ETB duty rate of change", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1312, 1.0, -0.0, 20.0, "per"),
etbDutyAverage("ETB average duty", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1316, 1.0, -20.0, 50.0, "per"),
etbTpsErrorCounter("ETB TPS error counter", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1320, 1.0, 0.0, 3.0, "count"),
etbPpsErrorCounter("ETB pedal error counter", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1322, 1.0, 0.0, 3.0, "count"),
etbErrorCode("etbErrorCode", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1324, 1.0, -1.0, -1.0, ""),
alignmentFill_at_49("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1325, 1.0, -20.0, 100.0, "units"),
jamTimer("ETB jam timer", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1326, 0.01, 0.0, 100.0, "sec"),
faultCode("faultCode", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1328, 1.0, -1.0, -1.0, ""),
heaterDuty("heaterDuty", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1329, 1.0, 0.0, 100.0, "%"),
pumpDuty("pumpDuty", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1330, 1.0, 0.0, 100.0, "%"),
alignmentFill_at_3("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1331, 1.0, -20.0, 100.0, "units"),
tempC("tempC", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1332, 1.0, 500.0, 1000.0, "C"),
nernstVoltage("nernstVoltage", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1334, 0.001, 0.0, 1.0, "V"),
esr("esr", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1336, 1.0, -1.0, -1.0, ""),
alignmentFill_at_10("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1338, 1.0, -20.0, 100.0, "units"),
dcOutput0("DC: output0", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1340, 1.0, 0.0, 10.0, "per"),
isEnabled0_int("DC: en0", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1344, 1.0, 0.0, 10.0, "per"),
alignmentFill_at_5("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1345, 1.0, -20.0, 100.0, "units"),
value0("ETB: SENT value0", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1352, 1.0, 0.0, 3.0, "value"),
value1("ETB: SENT value1", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1354, 1.0, 0.0, 3.0, "value"),
errorRate("ETB: SENT error rate", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1356, 1.0, 0.0, 3.0, "ratio"),
