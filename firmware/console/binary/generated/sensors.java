...
fuelALSCorrection("fuelALSCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1208, 1.0, -1.0, -1.0, ""),
timingALSCorrection("timingALSCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1212, 0.01, -20.0, 20.0, "deg"),
timingALSSkip("timingALSSkip", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1214, 0.01, 0.0, 50.0, "deg"),
luaTargetAdd("Boost: Lua target add", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1220, 0.5, -100.0, 100.0, "percent"),
alignmentFill_at_6("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1222, 1.0, 0.0, 100.0, "units"),
...
alignmentFill_at_14("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1230, 1.0, 0.0, 100.0, "units"),
...
alignmentFill_at_22("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1238, 1.0, 0.0, 100.0, "units"),
...
alignmentFill_at_29("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1245, 1.0, 0.0, 100.0, "units"),
...
veTableIdleYAxis("veTableIdleYAxis", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1418, 0.1, -1000.0, 1000.0, ""),
overDwellCanceledCounter("Ignition: overcharge canceled", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1420, 1.0, 0.0, 255.0, ""),
overDwellNotScheduledCounter("Ignition: overDwellNotScheduled", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1421, 1.0, 0.0, 255.0, ""),
sparkOutOfOrderCounter("Ignition: sparkOutOfOrder", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1422, 1.0, 0.0, 255.0, ""),
dwellUnderChargeCounter("Ignition: undecharge warnings", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1423, 1.0, 0.0, 255.0, ""),
dwellOverChargeCounter("Ignition: overcharge warnings", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1424, 1.0, 0.0, 255.0, ""),
alignmentFill_at_141("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1425, 1.0, 0.0, 100.0, "units"),
dwellActualRatio("Ignition: Dwell deviation", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1428, 1.0, 80.0, 120.0, "%"),
...
etbCurrentTarget("ETB: target for current pedal", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1824, 1.0, 0.0, 100.0, "%"),
boardEtbAdjustment("ETB: board adjustment", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1828, 1.0, -100.0, 100.0, "%"),
targetWithIdlePosition("ETB: target with idle", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1832, 1.0, 0.0, 100.0, "%"),
luaAdjustment("ETB: luaAdjustment", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1836, 1.0, -100.0, 100.0, "%"),
trim("ETB: trim", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1840, 1.0, -100.0, 100.0, "%"),
adjustedEtbTarget("ETB: target with adjustments", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1844, 0.01, 0.0, 100.0, "%"),
m_adjustedTarget("ETB: final target", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1846, 0.01, 0.0, 100.0, "%"),
m_wastegatePosition("DC: wastegatePosition", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1848, 1.0, 0.0, 3.0, "%"),
m_lastPidDtMs("EBT: last PID dT", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1852, 1.0, 0.0, 4.0, "mS"),
etbFeedForward("etbFeedForward", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1856, 1.0, -1.0, -1.0, ""),
integralError("Integral error", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1860, 1.0, 0.0, 100.0, ""),
...
alignmentFill_at_55("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1879, 1.0, 0.0, 100.0, "units"),
etbCurrentTarget("ETB: target for current pedal", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1824, 1.0, 0.0, 100.0, "%"),
boardEtbAdjustment("ETB: board adjustment", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1828, 1.0, -100.0, 100.0, "%"),
targetWithIdlePosition("ETB: target with idle", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1832, 1.0, 0.0, 100.0, "%"),
luaAdjustment("ETB: luaAdjustment", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1836, 1.0, -100.0, 100.0, "%"),
...
stftCorrectionBinIdx("STFT: used bin", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 2048, 1.0, -1.0, -1.0, ""),
stftLearningBinIdx("STFT: learning bin", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 2049, 1.0, -1.0, -1.0, ""),
