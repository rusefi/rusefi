...
startStopState("startStopState", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1376, 1.0, -1.0, -1.0, ""),
smartChipState("smartChipState", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1377, 1.0, -1.0, -1.0, ""),
smartChipRestartCounter("smartChipRestartCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1378, 1.0, -1.0, -1.0, ""),
smartChipAliveCounter("smartChipAliveCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1379, 1.0, -1.0, -1.0, ""),
startStopStateToggleCounter("startStopStateToggleCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1384, 1.0, -1.0, -1.0, ""),
currentVe("currentVe", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1388, 1.0, -1.0, -1.0, ""),
luaSoftSparkSkip("luaSoftSparkSkip", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1392, 1.0, -1.0, -1.0, ""),
luaHardSparkSkip("luaHardSparkSkip", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1396, 1.0, -1.0, -1.0, ""),
tractionControlSparkSkip("tractionControlSparkSkip", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1400, 1.0, -1.0, -1.0, ""),
fuelInjectionCounter("Fuel: Injection counter", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1404, 1.0, -1.0, -1.0, ""),
globalSparkCounter("Ign: Spark counter", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1408, 1.0, -1.0, -1.0, ""),
fuelingLoad("Fuel: Load", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1412, 1.0, -1.0, -1.0, ""),
ignitionLoad("Ignition: load", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1416, 1.0, -1.0, -1.0, ""),
veTableYAxis("veTableYAxis", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1420, 0.01, 0.0, 0.0, "%"),
veTableIdleYAxis("veTableIdleYAxis", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1422, 0.1, -1000.0, 1000.0, ""),
overDwellCounter("overDwellCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1424, 1.0, -1.0, -1.0, ""),
overDwellNotScheduledCounter("overDwellNotScheduledCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1425, 1.0, -1.0, -1.0, ""),
sparkOutOfOrderCounter("sparkOutOfOrderCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1426, 1.0, -1.0, -1.0, ""),
alignmentFill_at_139("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1427, 1.0, 0.0, 100.0, "units"),
stftCorrection1("STFT: Bank 1", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1428, 1.0, 50.0, 150.0, "%"),
stftCorrection2("STFT: Bank 2", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1432, 1.0, 50.0, 150.0, "%"),
tpsFrom("Fuel: TPS AE from", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1436, 1.0, -1.0, -1.0, ""),
tpsTo("Fuel: TPS AE to", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1440, 1.0, -1.0, -1.0, ""),
deltaTps("Fuel: TPS AE change", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1444, 1.0, -1.0, -1.0, ""),
extraFuel("Fuel: TPS extraFuel", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1448, 1.0, -1.0, -1.0, ""),
valueFromTable("Fuel: TPS valueFromTable", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1452, 1.0, -1.0, -1.0, ""),
fractionalInjFuel("Fuel: TPS AE fractionalInjFuel", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1460, 1.0, -1.0, -1.0, ""),
accumulatedValue("accumulatedValue", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1464, 1.0, -1.0, -1.0, ""),
maxExtraPerCycle("maxExtraPerCycle", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1468, 1.0, -1.0, -1.0, ""),
maxExtraPerPeriod("maxExtraPerPeriod", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1472, 1.0, -1.0, -1.0, ""),
maxInjectedPerPeriod("maxInjectedPerPeriod", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1476, 1.0, -1.0, -1.0, ""),
cycleCnt("cycleCnt", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1480, 1.0, -1.0, -1.0, ""),
hwEventCounters1("Hardware events since boot 1", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1484, 1.0, -1.0, -1.0, ""),
hwEventCounters2("Hardware events since boot 2", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1486, 1.0, -1.0, -1.0, ""),
hwEventCounters3("Hardware events since boot 3", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1488, 1.0, -1.0, -1.0, ""),
hwEventCounters4("Hardware events since boot 4", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1490, 1.0, -1.0, -1.0, ""),
vvtEventRiseCounter1("vvtEventRiseCounter 1", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1492, 1.0, -1.0, -1.0, ""),
vvtEventRiseCounter2("vvtEventRiseCounter 2", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1494, 1.0, -1.0, -1.0, ""),
vvtEventRiseCounter3("vvtEventRiseCounter 3", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1496, 1.0, -1.0, -1.0, ""),
vvtEventRiseCounter4("vvtEventRiseCounter 4", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1498, 1.0, -1.0, -1.0, ""),
vvtEventFallCounter1("vvtEventFallCounter 1", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1500, 1.0, -1.0, -1.0, ""),
vvtEventFallCounter2("vvtEventFallCounter 2", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1502, 1.0, -1.0, -1.0, ""),
vvtEventFallCounter3("vvtEventFallCounter 3", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1504, 1.0, -1.0, -1.0, ""),
vvtEventFallCounter4("vvtEventFallCounter 4", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1506, 1.0, -1.0, -1.0, ""),
vvtCamCounter("Sync: total cams front counter", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1508, 1.0, -1.0, -1.0, ""),
alignmentFill_at_26("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1510, 1.0, 0.0, 100.0, "units"),
mapVvt_MAP_AT_SPECIAL_POINT("InstantMAP at readout angle", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1512, 1.0, -300.0, 300.0, "kPa"),
mapVvt_MAP_AT_DIFF("InstantMAP delta @ readout angles", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1516, 1.0, -300.0, 300.0, "kPa"),
mapVvt_MAP_AT_CYCLE_COUNT("mapVvt_MAP_AT_CYCLE_COUNT", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1520, 1.0, -10.0, 100.0, "distance"),
mapVvt_sync_counter("Instant MAP sync counter", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1521, 1.0, 0.0, 100.0, "counter"),
mapVvt_min_point_counter("mapVvt_min_point_counter", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1522, 1.0, -1.0, -1.0, ""),
alignmentFill_at_39("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1523, 1.0, 0.0, 100.0, "units"),
temp_mapVvt_index("temp_mapVvt_index", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1524, 1.0, -1.0, -1.0, ""),
mapVvt_CycleDelta("mapVvt_CycleDelta", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1528, 1.0, -1.0, -1.0, ""),
currentEngineDecodedPhase("Sync: Engine Phase", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1532, 1.0, 0.0, 0.0, "deg"),
triggerToothAngleError("Sync: trigger angle error", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1536, 1.0, -30.0, 30.0, "deg"),
triggerIgnoredToothCount("triggerIgnoredToothCount", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1540, 1.0, -1.0, -1.0, ""),
alignmentFill_at_57("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1541, 1.0, 0.0, 100.0, "units"),
mapCamPrevToothAngle("Sync: MAP: prev angle", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1544, 1.0, -3000.0, 3000.0, "deg"),
triggerElapsedUs("triggerElapsedUs", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1552, 1.0, -1.0, -1.0, ""),
synchronizationCounter("sync: wheel sync counter", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1556, 1.0, -1.0, -1.0, ""),
vvtToothDurations0("vvtToothDurations0", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1560, 1.0, 0.0, 100000.0, "us"),
vvtCurrentPosition("sync: Primary Position", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1564, 1.0, -10000.0, 10000.0, ""),
vvtToothPosition1("sync: Cam Position 1", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1568, 1.0, -10000.0, 10000.0, ""),
vvtToothPosition2("sync: Cam Position 2", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1572, 1.0, -10000.0, 10000.0, ""),
vvtToothPosition3("sync: Cam Position 3", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1576, 1.0, -10000.0, 10000.0, ""),
vvtToothPosition4("sync: Cam Position 4", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1580, 1.0, -10000.0, 10000.0, ""),
triggerSyncGapRatio("Sync: Trigger Latest Ratio", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1584, 1.0, -10000.0, 10000.0, ""),
triggerStateIndex("triggerStateIndex", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1588, 1.0, -1.0, -1.0, ""),
triggerCountersError("triggerCountersError", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1589, 1.0, -1.0, -1.0, ""),
alignmentFill_at_34("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1590, 1.0, 0.0, 100.0, "units"),
synchronizationCounter("sync: wheel sync counter", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1556, 1.0, -1.0, -1.0, ""),
vvtToothDurations0("vvtToothDurations0", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1560, 1.0, 0.0, 100000.0, "us"),
vvtCurrentPosition("sync: Primary Position", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1564, 1.0, -10000.0, 10000.0, ""),
vvtToothPosition1("sync: Cam Position 1", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1568, 1.0, -10000.0, 10000.0, ""),
...
triggerCountersError("triggerCountersError", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1589, 1.0, -1.0, -1.0, ""),
alignmentFill_at_34("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1590, 1.0, 0.0, 100.0, "units"),
camResyncCounter("sync: Phase Re-Sync Counter", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1736, 1.0, -1.0, -1.0, ""),
alignmentFill_at_1("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1737, 1.0, 0.0, 100.0, "units"),
wallFuelCorrection("fuel wallwetting injection time\n correction to account for wall wetting effect for current cycle", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1744, 1.0, -1.0, -1.0, ""),
wallFuel("Fuel on the wall\nin ms of injector open time for each injector.", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1748, 1.0, -1.0, -1.0, ""),
emaError("emaError", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1756, 1.0, -1.0, -1.0, ""),
liveDataExampleField("liveDataExampleField", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1760, 1.0, -1.0, -1.0, ""),
idleState("idleState", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1764, 1.0, -1.0, -1.0, ""),
baseIdlePosition("idle: base value\ncurrent position without adjustments (iacByTpsTaper, afterCrankingIACtaperDuration)", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1768, 1.0, -1.0, -1.0, ""),
iacByTpsTaper("idle: iacByTpsTaper portion", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1772, 1.0, -1.0, -1.0, ""),
idleTarget("Idle: Target RPM", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1780, 1.0, -1.0, -1.0, ""),
idleEntryRpm("Idle: Entry threshold", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1782, 1.0, -1.0, -1.0, ""),
idleExitRpm("Idle: Exit threshold", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1784, 1.0, -1.0, -1.0, ""),
alignmentFill_at_22("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1786, 1.0, 0.0, 100.0, "units"),
targetRpmByClt("Idle: Target RPM base", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1788, 1.0, -1.0, -1.0, ""),
targetRpmAc("Idle: Target A/C RPM", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1792, 1.0, -1.0, -1.0, ""),
iacByRpmTaper("idle: iacByRpmTaper portion", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1796, 1.0, -1.0, -1.0, ""),
luaAdd("idle: Lua Adder", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1800, 1.0, -1.0, -1.0, ""),
m_lastTargetRpm("m_lastTargetRpm", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1804, 1.0, -1.0, -1.0, ""),
idleClosedLoop("Closed loop", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1808, 1.0, -1.0, -1.0, ""),
currentIdlePosition("Idle: Position", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1812, 1.0, 0.0, 0.0, "%"),
idleTargetAirmass("Target airmass", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1816, 1.0, 0.0, 0.0, "mg"),
idleTargetFlow("Target airflow", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1818, 0.01, 0.0, 0.0, "kg/h"),
targetWithIdlePosition("ETB: target with idle", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1820, 1.0, 0.0, 10.0, "%"),
trim("ETB: trim", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1824, 1.0, -1.0, -1.0, ""),
boardEtbAdjustment("boardEtbAdjustment", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1828, 1.0, -1.0, -1.0, ""),
luaAdjustment("ETB: luaAdjustment", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1832, 1.0, 0.0, 3.0, "%"),
m_wastegatePosition("DC: wastegatePosition", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1836, 1.0, 0.0, 3.0, "%"),
m_lastPidDtMs("EBT: last PID dT", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1840, 1.0, 0.0, 4.0, "mS"),
etbFeedForward("etbFeedForward", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1844, 1.0, -1.0, -1.0, ""),
integralError("Integral error", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1848, 1.0, 0.0, 100.0, ""),
etbCurrentTarget("ETB: target for current pedal", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1852, 1.0, -10000.0, 10000.0, "%"),
m_adjustedTarget("Adjusted target", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1856, 0.01, -100.0, 100.0, "%"),
alignmentFill_at_38("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1858, 1.0, 0.0, 100.0, "units"),
etbTpsErrorCounter("ETB TPS error counter", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1864, 1.0, 0.0, 3.0, "count"),
etbPpsErrorCounter("ETB pedal error counter", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1866, 1.0, 0.0, 3.0, "count"),
etbErrorCode("etbErrorCode", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1868, 1.0, -1.0, -1.0, ""),
etbErrorCodeBlinker("etbErrorCodeBlinker", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1869, 1.0, -1.0, -1.0, ""),
tcEtbDrop("ETB traction control", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1870, 1.0, 0.0, 100.0, "%"),
alignmentFill_at_51("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1871, 1.0, 0.0, 100.0, "units"),
jamTimer("ETB jam timer", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1872, 0.01, 0.0, 100.0, "sec"),
adjustedEtbTarget("ETB with adjustments", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1874, 1.0, 0.0, 100.0, "%"),
state("state", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1875, 1.0, -1.0, -1.0, ""),
targetWithIdlePosition("ETB: target with idle", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1820, 1.0, 0.0, 10.0, "%"),
trim("ETB: trim", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1824, 1.0, -1.0, -1.0, ""),
boardEtbAdjustment("boardEtbAdjustment", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1828, 1.0, -1.0, -1.0, ""),
luaAdjustment("ETB: luaAdjustment", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1832, 1.0, 0.0, 3.0, "%"),
...
adjustedEtbTarget("ETB with adjustments", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1874, 1.0, 0.0, 100.0, "%"),
state("state", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1875, 1.0, -1.0, -1.0, ""),
faultCode("WBO: Fault code", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1932, 1.0, -1.0, -1.0, ""),
heaterDuty("WBO: Heater duty", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1933, 1.0, 0.0, 100.0, "%"),
pumpDuty("WBO: Pump duty", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1934, 1.0, 0.0, 100.0, "%"),
alignmentFill_at_3("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1935, 1.0, 0.0, 100.0, "units"),
tempC("WBO: Temperature", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1940, 1.0, 500.0, 1000.0, "C"),
nernstVoltage("WBO: Nernst Voltage", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1942, 0.001, 0.0, 1.0, "V"),
esr("WBO: ESR", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1944, 1.0, 0.0, 10000.0, "ohm"),
alignmentFill_at_14("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1946, 1.0, 0.0, 100.0, "units"),
faultCode("WBO: Fault code", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1932, 1.0, -1.0, -1.0, ""),
heaterDuty("WBO: Heater duty", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1933, 1.0, 0.0, 100.0, "%"),
pumpDuty("WBO: Pump duty", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1934, 1.0, 0.0, 100.0, "%"),
alignmentFill_at_3("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1935, 1.0, 0.0, 100.0, "units"),
...
esr("WBO: ESR", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1944, 1.0, 0.0, 10000.0, "ohm"),
alignmentFill_at_14("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1946, 1.0, 0.0, 100.0, "units"),
dcOutput0("DC: output0", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1964, 1.0, -1.0, 1.0, "%"),
isEnabled0_int("DC: en0", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1968, 1.0, 0.0, 10.0, "%"),
alignmentFill_at_5("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1969, 1.0, 0.0, 100.0, "units"),
value0("SENT ch0 value0", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1976, 1.0, 0.0, 4095.0, "RAW"),
value1("SENT ch0 value1", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1978, 1.0, 0.0, 4095.0, "RAW"),
errorRate("SENT ch0 error rate", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1980, 1.0, 0.0, 100.0, "% (don't belive me)"),
vvtTarget("vvtTarget", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1984, 0.1, -90.0, 90.0, "deg"),
vvtOutput("vvtOutput", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1986, 0.5, 100.0, 1.0, "%"),
alignmentFill_at_3("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1987, 1.0, 0.0, 100.0, "units"),
lambdaTimeSinceGood("lambdaTimeSinceGood", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 1992, 0.01, 0.0, 1.0, "sec"),
alignmentFill_at_6("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1994, 1.0, 0.0, 100.0, "units"),
sparkDuration1("Spark duration 1", SensorCategory.SENSOR_INPUTS, FieldType.INT, 1996, 1.0, 0.0, 5.0, "ms"),
sparkDuration2("Spark duration 2", SensorCategory.SENSOR_INPUTS, FieldType.INT, 2000, 1.0, 0.0, 5.0, "ms"),
sparkDuration3("Spark duration 3", SensorCategory.SENSOR_INPUTS, FieldType.INT, 2004, 1.0, 0.0, 5.0, "ms"),
sparkDuration4("Spark duration 4", SensorCategory.SENSOR_INPUTS, FieldType.INT, 2008, 1.0, 0.0, 5.0, "ms"),
ltftCntHit("LTFT learning: hits", SensorCategory.SENSOR_INPUTS, FieldType.INT, 2012, 1.0, 0.0, 10000.0, "cnt"),
ltftCntMiss("LTFT learning: miss", SensorCategory.SENSOR_INPUTS, FieldType.INT, 2016, 1.0, 0.0, 10000.0, "cnt"),
ltftCntDeadband("LTFT learning: in deadband", SensorCategory.SENSOR_INPUTS, FieldType.INT, 2020, 1.0, 0.0, 10000.0, "cnt"),
ltftCorrection1("LTFT: Bank 1", SensorCategory.SENSOR_INPUTS, FieldType.INT, 2028, 1.0, 50.0, 150.0, "%"),
ltftCorrection2("LTFT: Bank 2", SensorCategory.SENSOR_INPUTS, FieldType.INT, 2032, 1.0, 50.0, 150.0, "%"),
ltftAccummulatedCorrection1("LTFT: Total Bank 1", SensorCategory.SENSOR_INPUTS, FieldType.INT, 2036, 1.0, 50.0, 150.0, "%"),
ltftAccummulatedCorrection2("LTFT: Total Bank 2", SensorCategory.SENSOR_INPUTS, FieldType.INT, 2040, 1.0, 50.0, 150.0, "%"),
stftCorrectionBinIdx("STFT: used bin", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 2044, 1.0, 0.0, 0.0, "Bin"),
stftLearningBinIdx("STFT: learning bin", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 2045, 1.0, 0.0, 0.0, "Bin"),
stftCorrectionState("stftCorrectionState", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 2046, 1.0, -1.0, -1.0, ""),
stftLearningState1("stftLearningState 1", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 2047, 1.0, -1.0, -1.0, ""),
stftLearningState2("stftLearningState 2", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 2048, 1.0, -1.0, -1.0, ""),
alignmentFill_at_5("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 2049, 1.0, 0.0, 100.0, "units"),
stftInputError1("STFT: input Lambda error 1", SensorCategory.SENSOR_INPUTS, FieldType.INT, 2052, 1.0, 50.0, 150.0, "%"),
stftInputError2("STFT: input Lambda error 2", SensorCategory.SENSOR_INPUTS, FieldType.INT, 2056, 1.0, 50.0, 150.0, "%"),
