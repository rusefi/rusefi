...
tcu_currentRange("TCU: Current Range", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 320, 1.0, 0.0, 0.0, ""),
alignmentFill_at_321("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 321, 1.0, -20.0, 100.0, "units"),
tcRatio("TCU: Torque Converter Ratio", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 322, 0.01, 0.0, 0.0, "value"),
lastShiftTime("lastShiftTime", SensorCategory.SENSOR_INPUTS, FieldType.INT, 324, 1.0, -1.0, -1.0, ""),
vssEdgeCounter("vssEdgeCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT, 328, 1.0, -1.0, -1.0, ""),
issEdgeCounter("issEdgeCounter", SensorCategory.SENSOR_INPUTS, FieldType.INT, 332, 1.0, -1.0, -1.0, ""),
auxLinear1("Aux linear #1", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 336, 0.01, 0.0, 0.0, ""),
auxLinear2("Aux linear #2", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 338, 0.01, 0.0, 0.0, ""),
...
vehicleSpeedKph("Vehicle Speed", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 652, 0.01, 0.0, 0.0, "kph"),
Gego("Gego", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 654, 0.01, 50.0, 150.0, "%"),
testBenchIter("testBenchIter", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 656, 1.0, 0.0, 0.0, "count"),
oilTemp("oilTemp", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 658, 0.01, 0.0, 0.0, "deg C"),
fuelTemp("fuelTemp", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 660, 0.01, 0.0, 0.0, "deg C"),
ambientTemp("ambientTemp", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 662, 0.01, 0.0, 0.0, "deg C"),
compressorDischargeTemp("compressorDischargeTemp", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 664, 0.01, 0.0, 0.0, "deg C"),
compressorDischargePressure("compressorDischargePressure", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 666, 0.03333333333333333, 0.0, 0.0, "kPa"),
throttleInletPressure("throttleInletPressure", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 668, 0.03333333333333333, 0.0, 0.0, "kPa"),
ignitionOnTime("ignitionOnTime", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 670, 1.0, 0.0, 0.0, "sec"),
engineRunTime("engineRunTime", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 672, 1.0, 0.0, 0.0, "sec"),
distanceTraveled("distanceTraveled", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 674, 0.1, 0.0, 0.0, "km"),
afrGasolineScale("Air/Fuel Ratio (Gas Scale)", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 676, 0.001, 0.0, 0.0, "AFR"),
afr2GasolineScale("Air/Fuel Ratio 2 (Gas Scale)", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 678, 0.001, 0.0, 0.0, "AFR"),
...
normalizedCylinderFilling("Air: Normalized cyl filling", SensorCategory.SENSOR_INPUTS, FieldType.INT, 840, 1.0, 0.0, 100.0, "%"),
brokenInjector("brokenInjector", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 844, 1.0, -1.0, -1.0, ""),
alignmentFill_at_45("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 845, 1.0, -20.0, 100.0, "units"),
