...
fuelALSCorrection("fuelALSCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT, 832, 1.0, -1.0, -1.0, ""),
timingALSCorrection("timingALSCorrection", SensorCategory.SENSOR_INPUTS, FieldType.INT16, 836, 0.01, -20.0, 20.0, "deg"),
alignmentFill_at_10("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 838, 1.0, -20.0, 100.0, "units"),
luaTargetAdd("luaTargetAdd", SensorCategory.SENSOR_INPUTS, FieldType.INT, 844, 1.0, -1.0, -1.0, ""),
luaTargetMult("luaTargetMult", SensorCategory.SENSOR_INPUTS, FieldType.INT, 848, 1.0, -1.0, -1.0, ""),
openLoopPart("openLoopPart", SensorCategory.SENSOR_INPUTS, FieldType.INT, 852, 1.0, -1.0, -1.0, ""),
luaOpenLoopAdd("luaOpenLoopAdd", SensorCategory.SENSOR_INPUTS, FieldType.INT, 856, 1.0, -1.0, -1.0, ""),
boostControllerClosedLoopPart("Boost Closed Loop", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 860, 0.5, -50.0, 50.0, "%"),
alignmentFill_at_21("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 861, 1.0, -20.0, 100.0, "units"),
...
baroCorrection("fuel: Barometric pressure mult", SensorCategory.SENSOR_INPUTS, FieldType.INT, 940, 1.0, -1.0, -1.0, ""),
crankingFuel("crankingFuel", SensorCategory.SENSOR_INPUTS, FieldType.INT, 944, 1.0, -1.0, -1.0, ""),
...
alignmentFill_at_154("need 4 byte alignment", SensorCategory.SENSOR_INPUTS, FieldType.INT8, 1042, 1.0, -20.0, 100.0, "units"),
