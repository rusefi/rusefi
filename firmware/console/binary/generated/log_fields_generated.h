...
static LOG_FIELD_CONSTNESS_SPECIFIER_STORAGE MLG::Entries::Field fields[] = {
	...
	{engine->outputChannels, 700, 0, "coilState1", ""},
	{engine->outputChannels, 700, 1, "coilState2", ""},
	{engine->outputChannels, 700, 2, "coilState3", ""},
	{engine->outputChannels, 700, 3, "coilState4", ""},
	{engine->outputChannels, 700, 4, "coilState5", ""},
	{engine->outputChannels, 700, 5, "coilState6", ""},
	{engine->outputChannels, 700, 6, "coilState7", ""},
	{engine->outputChannels, 700, 7, "coilState8", ""},
	{engine->outputChannels, 700, 8, "coilState9", ""},
	{engine->outputChannels, 700, 9, "coilState10", ""},
	{engine->outputChannels, 700, 10, "coilState11", ""},
	{engine->outputChannels, 700, 11, "coilState12", ""},
	{engine->outputChannels, 700, 12, "injectorState1", ""},
	{engine->outputChannels, 700, 13, "injectorState2", ""},
	{engine->outputChannels, 700, 14, "injectorState3", ""},
	{engine->outputChannels, 700, 15, "injectorState4", ""},
	{engine->outputChannels, 700, 16, "injectorState5", ""},
	{engine->outputChannels, 700, 17, "injectorState6", ""},
	{engine->outputChannels, 700, 18, "injectorState7", ""},
	{engine->outputChannels, 700, 19, "injectorState8", ""},
	{engine->outputChannels, 700, 20, "injectorState9", ""},
	{engine->outputChannels, 700, 21, "injectorState10", ""},
	{engine->outputChannels, 700, 22, "injectorState11", ""},
	{engine->outputChannels, 700, 23, "injectorState12", ""},
	{engine->outputChannels, 700, 24, "triggerChannel1", ""},
	{engine->outputChannels, 700, 25, "triggerChannel2", ""},
	{engine->outputChannels, 700, 26, "bank 1 intake cam input", ""},
	{engine->outputChannels, 700, 27, "bank 1 exhaust cam input", ""},
	{engine->outputChannels, 700, 28, "bank 2 intake cam input", ""},
	{engine->outputChannels, 700, 29, "bank 2 exhaust cam input", ""},
	{engine->outputChannels, 700, 30, "AE: Map Prediction Active", ""},
	...
	{engine->triggerCentral.triggerState.camResyncCounter, "sync: Phase Re-Sync Counter", "cnt", 0, "Sync"},
	{engine->triggerCentral.triggerState.m_phaseAdjustment, "sync: phase adjustment", "deg", 0, "Sync"},
	{engine->triggerCentral.triggerState, 4, 0, "sync: We Know Engine Phase", ""},
