...
static LOG_FIELD_CONSTNESS_SPECIFIER_STORAGE MLG::Entries::Field fields[] = {
	...
	{engine->outputChannels, 696, 0, "coilState1", ""},
	{engine->outputChannels, 696, 1, "coilState2", ""},
	{engine->outputChannels, 696, 2, "coilState3", ""},
	{engine->outputChannels, 696, 3, "coilState4", ""},
	{engine->outputChannels, 696, 4, "coilState5", ""},
	{engine->outputChannels, 696, 5, "coilState6", ""},
	{engine->outputChannels, 696, 6, "coilState7", ""},
	{engine->outputChannels, 696, 7, "coilState8", ""},
	{engine->outputChannels, 696, 8, "coilState9", ""},
	{engine->outputChannels, 696, 9, "coilState10", ""},
	{engine->outputChannels, 696, 10, "coilState11", ""},
	{engine->outputChannels, 696, 11, "coilState12", ""},
	{engine->outputChannels, 696, 12, "injectorState1", ""},
	{engine->outputChannels, 696, 13, "injectorState2", ""},
	{engine->outputChannels, 696, 14, "injectorState3", ""},
	{engine->outputChannels, 696, 15, "injectorState4", ""},
	{engine->outputChannels, 696, 16, "injectorState5", ""},
	{engine->outputChannels, 696, 17, "injectorState6", ""},
	{engine->outputChannels, 696, 18, "injectorState7", ""},
	{engine->outputChannels, 696, 19, "injectorState8", ""},
	{engine->outputChannels, 696, 20, "injectorState9", ""},
	{engine->outputChannels, 696, 21, "injectorState10", ""},
	{engine->outputChannels, 696, 22, "injectorState11", ""},
	{engine->outputChannels, 696, 23, "injectorState12", ""},
	{engine->outputChannels, 696, 24, "triggerChannel1", ""},
	{engine->outputChannels, 696, 25, "triggerChannel2", ""},
	{engine->outputChannels, 696, 26, "bank 1 intake cam input", ""},
	{engine->outputChannels, 696, 27, "bank 1 exhaust cam input", ""},
	{engine->outputChannels, 696, 28, "bank 2 intake cam input", ""},
	{engine->outputChannels, 696, 29, "bank 2 exhaust cam input", ""},
	{engine->outputChannels, 696, 30, "AE: Map Prediction Active", ""},
