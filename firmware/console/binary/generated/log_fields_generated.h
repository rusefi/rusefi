...
static LOG_FIELD_CONSTNESS_SPECIFIER_STORAGE MLG::Entries::Field fields[] = {
	...
	{engine->outputChannels, 672, 0, "coilState1", ""},
	{engine->outputChannels, 672, 1, "coilState2", ""},
	{engine->outputChannels, 672, 2, "coilState3", ""},
	{engine->outputChannels, 672, 3, "coilState4", ""},
	{engine->outputChannels, 672, 4, "coilState5", ""},
	{engine->outputChannels, 672, 5, "coilState6", ""},
	{engine->outputChannels, 672, 6, "coilState7", ""},
	{engine->outputChannels, 672, 7, "coilState8", ""},
	{engine->outputChannels, 672, 8, "coilState9", ""},
	{engine->outputChannels, 672, 9, "coilState10", ""},
	{engine->outputChannels, 672, 10, "coilState11", ""},
	{engine->outputChannels, 672, 11, "coilState12", ""},
	{engine->outputChannels, 672, 12, "injectorState1", ""},
	{engine->outputChannels, 672, 13, "injectorState2", ""},
	{engine->outputChannels, 672, 14, "injectorState3", ""},
	{engine->outputChannels, 672, 15, "injectorState4", ""},
	{engine->outputChannels, 672, 16, "injectorState5", ""},
	{engine->outputChannels, 672, 17, "injectorState6", ""},
	{engine->outputChannels, 672, 18, "injectorState7", ""},
	{engine->outputChannels, 672, 19, "injectorState8", ""},
	{engine->outputChannels, 672, 20, "injectorState9", ""},
	{engine->outputChannels, 672, 21, "injectorState10", ""},
	{engine->outputChannels, 672, 22, "injectorState11", ""},
	{engine->outputChannels, 672, 23, "injectorState12", ""},
	{engine->outputChannels, 672, 24, "triggerChannel1", ""},
	{engine->outputChannels, 672, 25, "triggerChannel2", ""},
	{engine->outputChannels, 672, 26, "bank 1 intake cam input", ""},
	{engine->outputChannels, 672, 27, "bank 1 exhaust cam input", ""},
	{engine->outputChannels, 672, 28, "bank 2 intake cam input", ""},
	{engine->outputChannels, 672, 29, "bank 2 exhaust cam input", ""},
