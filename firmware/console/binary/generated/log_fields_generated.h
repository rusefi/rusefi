...
static LOG_FIELD_CONSTNESS_SPECIFIER_STORAGE MLG::Entries::Field fields[] = {
	...
	{engine->outputChannels, 704, 0, "coilState1", ""},
	{engine->outputChannels, 704, 1, "coilState2", ""},
	{engine->outputChannels, 704, 2, "coilState3", ""},
	{engine->outputChannels, 704, 3, "coilState4", ""},
	{engine->outputChannels, 704, 4, "coilState5", ""},
	{engine->outputChannels, 704, 5, "coilState6", ""},
	{engine->outputChannels, 704, 6, "coilState7", ""},
	{engine->outputChannels, 704, 7, "coilState8", ""},
	{engine->outputChannels, 704, 8, "coilState9", ""},
	{engine->outputChannels, 704, 9, "coilState10", ""},
	{engine->outputChannels, 704, 10, "coilState11", ""},
	{engine->outputChannels, 704, 11, "coilState12", ""},
	{engine->outputChannels, 704, 12, "injectorState1", ""},
	{engine->outputChannels, 704, 13, "injectorState2", ""},
	{engine->outputChannels, 704, 14, "injectorState3", ""},
	{engine->outputChannels, 704, 15, "injectorState4", ""},
	{engine->outputChannels, 704, 16, "injectorState5", ""},
	{engine->outputChannels, 704, 17, "injectorState6", ""},
	{engine->outputChannels, 704, 18, "injectorState7", ""},
	{engine->outputChannels, 704, 19, "injectorState8", ""},
	{engine->outputChannels, 704, 20, "injectorState9", ""},
	{engine->outputChannels, 704, 21, "injectorState10", ""},
	{engine->outputChannels, 704, 22, "injectorState11", ""},
	{engine->outputChannels, 704, 23, "injectorState12", ""},
	{engine->outputChannels, 704, 24, "triggerChannel1", ""},
	{engine->outputChannels, 704, 25, "triggerChannel2", ""},
	{engine->outputChannels, 704, 26, "bank 1 intake cam input", ""},
	{engine->outputChannels, 704, 27, "bank 1 exhaust cam input", ""},
	{engine->outputChannels, 704, 28, "bank 2 intake cam input", ""},
	{engine->outputChannels, 704, 29, "bank 2 exhaust cam input", ""},
	{engine->outputChannels, 704, 30, "AE: Map Prediction Active", ""},
