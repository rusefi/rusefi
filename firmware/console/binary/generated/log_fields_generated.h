...
static LOG_FIELD_CONSTNESS_SPECIFIER_STORAGE MLG::Entries::Field fields[] = {
	...
	{engine->outputChannels.flexAeMultiplier, "Flex: AE multiplier", "factor", 3},
	{engine->outputChannels.flexWwTauMultiplier, "Flex: WW tau multiplier", "factor", 3},
	{engine->outputChannels.flexWwBetaMultiplier, "Flex: WW beta multiplier", "factor", 3},
	...
	{engine->outputChannels.veValue, "Fuel: VE", "factor", 1},
	...
	{engine->outputChannels.totalTriggerErrorCounter, "Trigger Error Counter", "count", 0},
	...
	{engine->ignitionState.luaTimingMult, "Ign: Lua timing mult", "factor", 2, "Timing"},
	...
	{engine->module<KnockController>()->m_knockLevel, "Knock: Current level", "V", 2},
	...
	{engine->module<KnockController>()->m_knockFuelTrimMultiplier, "Knock: Fuel trim when knock", "factor", 0},
	...
	{engine->fuelComputer.totalFuelCorrection, "Fuel: Total correction", "factor", 2, "Fuel: math"},
	...
	{engine->fuelComputer.running.timeSinceCrankingInSecs, "running.timeSinceCrankingInSecs", "s", 0, "Fuel: math"},
	...
	{engine->fuelComputer.targetLambda, "Fuel: target lambda", "lambda", 2, "Fuel: math"},
	...
	{engine->module<BoostController>()->luaTargetAdd, "Boost: Lua target add", "%", 1, "Boost Control"},
	...
	{engine->module<BoostController>()->openLoopPart, "Boost: Open loop", "%", 1, "Boost Control"},
	{engine->module<BoostController>()->openLoopYAxis, "openLoopYAxis", "", 1},
	{engine->module<BoostController>()->luaOpenLoopAdd, "Boost: Lua open loop add", "%", 1, "Boost Control"},
	{engine->module<BoostController>()->boostControllerClosedLoopPart, "Boost: Closed loop", "%", 1, "Boost Control"},
	{engine->module<BoostController>()->boostOutput, "Boost: Output", "%", 2, "Boost Control"},
#endif
#if EFI_ENGINE_CONTROL && EFI_SHAFT_POSITION_INPUT
	{engine->lambdaMonitor, 0, 0, "lambdaCurrentlyGood", ""},
	{engine->lambdaMonitor, 0, 1, "lambdaMonitorCut", ""},
	{engine->lambdaMonitor.lambdaTimeSinceGood, "lambdaTimeSinceGood", "s", 2},
#endif
	...
	{getLiveDataConstexpr<electronic_throttle_s, 0>()->jamTimer, "etb1ETB jam timer", "s", 2},
	...
	{getLiveDataConstexpr<electronic_throttle_s, 1>()->jamTimer, "etb2ETB jam timer", "s", 2},
	...
	{engine->triggerCentral, 72, 0, "binaryCamAtCrankRise", ""},
	{engine->triggerCentral, 72, 1, "binaryCamAtCrankFall", ""},
	{engine->triggerCentral, 72, 2, "m_binaryCamRiseSampleValid", ""},
	{engine->triggerCentral.m_lastBinarySyncCode, "m_lastBinarySyncCode", "", 0},
	{engine->triggerCentral.m_cachedCrankDivider, "m_cachedCrankDivider", "", 0},
	{static_cast<trigger_state_primary_s&>(engine->triggerCentral.triggerState).phaseResyncCounter, "sync: Phase Re-Sync Counter", "count", 0, "Sync"},
