...
#ifndef BLINKY_THREAD_STACK_SIZE
#define BLINKY_THREAD_STACK_SIZE 256
#endif /* BLINKY_THREAD_STACK_SIZE */
...
#define STORAGE_MANAGER_THREAD_STACK_SIZE (3*UTILITY_THREAD_STACK_SIZE)
#else
#define STORAGE_MANAGER_THREAD_STACK_SIZE UTILITY_THREAD_STACK_SIZE
#endif
#endif /* STORAGE_MANAGER_THREAD_STACK_SIZE */

#ifndef TIMER_WATCHDOG_THREAD_STACK_SIZE
#define TIMER_WATCHDOG_THREAD_STACK_SIZE 256
#endif /* TIMER_WATCHDOG_THREAD_STACK_SIZE */
