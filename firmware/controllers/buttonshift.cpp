...
void ButtonShiftController::init (DECLARE_ENGINE_PARAMETER_SIGNATURE) {
    ...
    debounceUp.init(500, CONFIG_POINTERS(tcuUpshiftButtonPin), CONFIG_POINTERS(tcuUpshiftButtonPinMode));
    debounceDown.init(500, CONFIG_POINTERS(tcuDownshiftButtonPin), CONFIG_POINTERS(tcuDownshiftButtonPinMode));
}
