...
struct IIdleController {
	...
	virtual float getRunningOpenLoop(Phase phase, float rpm, float clt, SensorResult tps) = 0;
...
public:
	...
	percent_t getRunningOpenLoop(Phase phase, float rpm, float clt, SensorResult tps) override;
