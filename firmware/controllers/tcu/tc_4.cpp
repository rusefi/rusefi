...
void configureTcu4R70W() {
  ...
  // Range voltages/digital states
	...
	config->tcu_rangeR[3] = 0.0;
	config->tcu_rangeR[4] = 0.0;
	config->tcu_rangeR[5] = 0.0;
	config->tcu_rangeP[0] = 18500.0;
	config->tcu_rangeP[1] = 0.0;
	config->tcu_rangeP[2] = 0.0;
	config->tcu_rangeP[3] = 0.0;
	config->tcu_rangeP[4] = 0.0;
	config->tcu_rangeP[5] = 0.0;
	config->tcu_rangeN[0] = 3028.0;
	config->tcu_rangeN[1] = 0.0;
	config->tcu_rangeN[2] = 0.0;
	config->tcu_rangeN[3] = 0.0;
	config->tcu_rangeN[4] = 0.0;
	config->tcu_rangeN[5] = 0.0;
	config->tcu_rangeD[0] = 1645.0;
	config->tcu_rangeD[1] = 0.0;
	config->tcu_rangeD[2] = 0.0;
	config->tcu_rangeD[3] = 0.0;
	config->tcu_rangeD[4] = 0.0;
	config->tcu_rangeD[5] = 0.0;
	config->tcu_rangeM2[0] = 864.0;
	config->tcu_rangeM2[1] = 0.0;
	config->tcu_rangeM2[2] = 0.0;
	config->tcu_rangeM2[3] = 0.0;
	config->tcu_rangeM2[4] = 0.0;
	config->tcu_rangeM2[5] = 0.0;
	config->tcu_rangeM1[0] = 358.0;
	config->tcu_rangeM1[1] = 0.0;
	config->tcu_rangeM1[2] = 0.0;
	config->tcu_rangeM1[3] = 0.0;
	config->tcu_rangeM1[4] = 0.0;
	config->tcu_rangeM1[5] = 0.0;
	config->tcu_rangePlus[0] = 0.0;
	config->tcu_rangePlus[1] = 1.0;
	config->tcu_rangePlus[2] = 0.0;
	config->tcu_rangePlus[3] = 0.0;
	config->tcu_rangePlus[4] = 0.0;
	config->tcu_rangePlus[5] = 0.0;
	config->tcu_rangeMinus[0] = 0.0;
	config->tcu_rangeMinus[1] = 0.0;
	config->tcu_rangeMinus[2] = 1.0;
	config->tcu_rangeMinus[3] = 0.0;
	config->tcu_rangeMinus[4] = 0.0;
	config->tcu_rangeMinus[5] = 0.0;
