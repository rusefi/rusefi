...
// 16 channels * 16x oversample / 2 simultaneous ADCs = 128 samples per batch
// (41 * 128) / 25MHz -> 209 microseconds to sample all channels
...
static constexpr ADCConversionGroup convGroupSlow = {
	...
	.ccr				= 6 << ADC_CCR_DUAL_Pos, // set "regular simultaneous mode"
	...
	.sqr = {
		...
		// ADC1 samples all the "even" channels
		ADC_SQR1_SQ1_N(16) |	// PA0 (aka PA0_C)
		ADC_SQR1_SQ2_N(14) |	// PA2
		ADC_SQR1_SQ3_N(18) |	// PA4
		ADC_SQR1_SQ4_N(3) |		// PA6
		ADC_SQR2_SQ5_N(9) |		// PB0
		ADC_SQR2_SQ6_N(10) |	// PC0
		ADC_SQR2_SQ7_N(12) |	// PC2 (aka PC2_C)
		ADC_SQR2_SQ8_N(4),		// PC4
		0, 0
	},
	.ssmpr = {
		// Configure all channels to use ADC_SAMPLING_SLOW time
	...
	.ssqr = {
		// The seemingly insane values here exist to put the values
		// in the buffer in the same order as the ADCv2 (F4/F7) ADC
		// ADC2 samples all the "odd" channels
		ADC_SQR1_SQ1_N(17) |	// PA1 (aka PA1_C)
		ADC_SQR1_SQ2_N(15) |	// PA3
		ADC_SQR1_SQ3_N(19) |	// PA5
		ADC_SQR1_SQ4_N(7) |		// PA7
		ADC_SQR2_SQ5_N(5) |		// PB1
		ADC_SQR2_SQ6_N(11) |	// PC1
		ADC_SQR2_SQ7_N(13) |	// PC3 (aka PC3_C)
