...
#define STM32_IRQ_TIM1_BRK_TIM9_PRIORITY    ICU_PRIORITY
#define STM32_IRQ_TIM1_UP_TIM10_PRIORITY    ICU_PRIORITY
#define STM32_IRQ_TIM1_TRGCO_TIM11_PRIORITY ICU_PRIORITY
#define STM32_IRQ_TIM1_CC_PRIORITY          ICU_PRIORITY
#define STM32_IRQ_TIM2_PRIORITY             ICU_PRIORITY
#define STM32_IRQ_TIM3_PRIORITY             ICU_PRIORITY
#define STM32_IRQ_TIM4_PRIORITY             ICU_PRIORITY
#define STM32_IRQ_TIM5_PRIORITY             PRECISE_SCHEDULING_TIMER_PRIORITY
#define STM32_IRQ_TIM6_PRIORITY             ICU_PRIORITY
#define STM32_IRQ_TIM7_PRIORITY             ICU_PRIORITY
#define STM32_IRQ_TIM8_BRK_TIM12_PRIORITY   ICU_PRIORITY
#define STM32_IRQ_TIM8_UP_TIM13_PRIORITY    ICU_PRIORITY
#define STM32_IRQ_TIM8_TRGCO_TIM14_PRIORITY ICU_PRIORITY
#define STM32_IRQ_TIM8_CC_PRIORITY          ICU_PRIORITY
