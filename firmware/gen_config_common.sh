...
COMMON_GEN_CONFIG="
 ...
 -field_lookup_file ${META_OUTPUT_ROOT_FOLDER}controllers/lua/generated/value_lookup_generated.cpp ${META_OUTPUT_ROOT_FOLDER}controllers/lua/generated/value_lookup_generated.md \
