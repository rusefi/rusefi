...
// this file was generated automatically by ConfigDefinition.jar based on rusefi_config.txt Fri Feb 22 22:16:26 EST 2019
public class Fields {
	...
	public static final int alignMaf_offset = 557;
	...
	public static final int warninigLedPin_offset = 2061;
	...
	public static final Field HIP9011SPIDEVICE = Field.create("HIP9011SPIDEVICE", 540, FieldType.INT);
	...
	public static final Field MAFADCCHANNEL = Field.create("MAFADCCHANNEL", 556, FieldType.INT, adc_channel_e);
	public static final Field AFR_HWCHANNEL = Field.create("AFR_HWCHANNEL", 560, FieldType.INT, adc_channel_e);
	...
	public static final Field THROTTLEPEDALPOSITIONADCCHANNEL = Field.create("THROTTLEPEDALPOSITIONADCCHANNEL", 580, FieldType.INT, adc_channel_e);
	...
	public static final Field BAROSENSOR_HWCHANNEL = Field.create("BAROSENSOR_HWCHANNEL", 596, FieldType.INT, adc_channel_e);
	...
	public static final Field IDLE_SOLENOIDPIN = Field.create("IDLE_SOLENOIDPIN", 604, FieldType.INT, brain_pin_e);
	public static final Field IDLE_STEPPERDIRECTIONPIN = Field.create("IDLE_STEPPERDIRECTIONPIN", 605, FieldType.INT, brain_pin_e);
	public static final Field IDLE_STEPPERSTEPPIN = Field.create("IDLE_STEPPERSTEPPIN", 606, FieldType.INT, brain_pin_e);
	public static final String[] pin_output_mode_e = {"default", "default inverted", "open collector", "open collector inverted"};
	public static final Field IDLE_SOLENOIDPINMODE = Field.create("IDLE_SOLENOIDPINMODE", 607, FieldType.INT, pin_output_mode_e);
	...
	public static final Field INJECTIONPINS1 = Field.create("INJECTIONPINS1", 624, FieldType.INT, brain_pin_e);
	public static final Field INJECTIONPINS2 = Field.create("INJECTIONPINS2", 625, FieldType.INT, brain_pin_e);
	public static final Field INJECTIONPINS3 = Field.create("INJECTIONPINS3", 626, FieldType.INT, brain_pin_e);
	public static final Field INJECTIONPINS4 = Field.create("INJECTIONPINS4", 627, FieldType.INT, brain_pin_e);
	public static final Field INJECTIONPINS5 = Field.create("INJECTIONPINS5", 628, FieldType.INT, brain_pin_e);
	public static final Field INJECTIONPINS6 = Field.create("INJECTIONPINS6", 629, FieldType.INT, brain_pin_e);
	public static final Field INJECTIONPINS7 = Field.create("INJECTIONPINS7", 630, FieldType.INT, brain_pin_e);
	public static final Field INJECTIONPINS8 = Field.create("INJECTIONPINS8", 631, FieldType.INT, brain_pin_e);
	public static final Field INJECTIONPINS9 = Field.create("INJECTIONPINS9", 632, FieldType.INT, brain_pin_e);
	public static final Field INJECTIONPINS10 = Field.create("INJECTIONPINS10", 633, FieldType.INT, brain_pin_e);
	public static final Field INJECTIONPINS11 = Field.create("INJECTIONPINS11", 634, FieldType.INT, brain_pin_e);
	public static final Field INJECTIONPINS12 = Field.create("INJECTIONPINS12", 635, FieldType.INT, brain_pin_e);
	public static final Field IGNITIONPINS1 = Field.create("IGNITIONPINS1", 636, FieldType.INT, brain_pin_e);
	public static final Field IGNITIONPINS2 = Field.create("IGNITIONPINS2", 637, FieldType.INT, brain_pin_e);
	public static final Field IGNITIONPINS3 = Field.create("IGNITIONPINS3", 638, FieldType.INT, brain_pin_e);
	public static final Field IGNITIONPINS4 = Field.create("IGNITIONPINS4", 639, FieldType.INT, brain_pin_e);
	public static final Field IGNITIONPINS5 = Field.create("IGNITIONPINS5", 640, FieldType.INT, brain_pin_e);
	public static final Field IGNITIONPINS6 = Field.create("IGNITIONPINS6", 641, FieldType.INT, brain_pin_e);
	public static final Field IGNITIONPINS7 = Field.create("IGNITIONPINS7", 642, FieldType.INT, brain_pin_e);
	public static final Field IGNITIONPINS8 = Field.create("IGNITIONPINS8", 643, FieldType.INT, brain_pin_e);
	public static final Field IGNITIONPINS9 = Field.create("IGNITIONPINS9", 644, FieldType.INT, brain_pin_e);
	public static final Field IGNITIONPINS10 = Field.create("IGNITIONPINS10", 645, FieldType.INT, brain_pin_e);
	public static final Field IGNITIONPINS11 = Field.create("IGNITIONPINS11", 646, FieldType.INT, brain_pin_e);
	public static final Field IGNITIONPINS12 = Field.create("IGNITIONPINS12", 647, FieldType.INT, brain_pin_e);
	public static final Field INJECTIONPINMODE = Field.create("INJECTIONPINMODE", 648, FieldType.INT, pin_output_mode_e);
	public static final Field IGNITIONPINMODE = Field.create("IGNITIONPINMODE", 649, FieldType.INT, pin_output_mode_e);
	public static final Field HD44780_RS = Field.create("HD44780_RS", 650, FieldType.INT, brain_pin_e);
	public static final Field HD44780_E = Field.create("HD44780_E", 651, FieldType.INT, brain_pin_e);
	public static final Field HD44780_DB4 = Field.create("HD44780_DB4", 652, FieldType.INT, brain_pin_e);
	public static final Field HD44780_DB5 = Field.create("HD44780_DB5", 653, FieldType.INT, brain_pin_e);
	public static final Field HD44780_DB6 = Field.create("HD44780_DB6", 654, FieldType.INT, brain_pin_e);
	public static final Field HD44780_DB7 = Field.create("HD44780_DB7", 655, FieldType.INT, brain_pin_e);
	public static final Field GPS_RX_PIN = Field.create("GPS_RX_PIN", 656, FieldType.INT, brain_pin_e);
	public static final Field GPS_TX_PIN = Field.create("GPS_TX_PIN", 657, FieldType.INT, brain_pin_e);
	public static final Field FUELPUMPPIN = Field.create("FUELPUMPPIN", 658, FieldType.INT, brain_pin_e);
	public static final Field FUELPUMPPINMODE = Field.create("FUELPUMPPINMODE", 659, FieldType.INT, pin_output_mode_e);
	public static final Field MALFUNCTIONINDICATORPIN = Field.create("MALFUNCTIONINDICATORPIN", 660, FieldType.INT, brain_pin_e);
	public static final Field MALFUNCTIONINDICATORPINMODE = Field.create("MALFUNCTIONINDICATORPINMODE", 661, FieldType.INT, pin_output_mode_e);
	public static final Field FANPINMODE = Field.create("FANPINMODE", 662, FieldType.INT, pin_output_mode_e);
	public static final Field FANPIN = Field.create("FANPIN", 663, FieldType.INT, brain_pin_e);
	public static final Field CLUTCHDOWNPIN = Field.create("CLUTCHDOWNPIN", 664, FieldType.INT, brain_pin_e);
	public static final Field ALTERNATORCONTROLPIN = Field.create("ALTERNATORCONTROLPIN", 665, FieldType.INT, brain_pin_e);
	public static final Field ALTERNATORCONTROLPINMODE = Field.create("ALTERNATORCONTROLPINMODE", 666, FieldType.INT, pin_output_mode_e);
	public static final Field CLUTCHDOWNPINMODE = Field.create("CLUTCHDOWNPINMODE", 667, FieldType.INT);
	public static final Field DIGITALPOTENTIOMETERCHIPSELECT1 = Field.create("DIGITALPOTENTIOMETERCHIPSELECT1", 668, FieldType.INT, brain_pin_e);
	public static final Field DIGITALPOTENTIOMETERCHIPSELECT2 = Field.create("DIGITALPOTENTIOMETERCHIPSELECT2", 669, FieldType.INT, brain_pin_e);
	public static final Field DIGITALPOTENTIOMETERCHIPSELECT3 = Field.create("DIGITALPOTENTIOMETERCHIPSELECT3", 670, FieldType.INT, brain_pin_e);
	public static final Field DIGITALPOTENTIOMETERCHIPSELECT4 = Field.create("DIGITALPOTENTIOMETERCHIPSELECT4", 671, FieldType.INT, brain_pin_e);
	public static final Field ELECTRONICTHROTTLEPIN1MODE = Field.create("ELECTRONICTHROTTLEPIN1MODE", 672, FieldType.INT, pin_output_mode_e);
	public static final Field WBOHEATERPIN = Field.create("WBOHEATERPIN", 673, FieldType.INT, brain_pin_e);
	...
	public static final Field TRIGGERINPUTPINS1 = Field.create("TRIGGERINPUTPINS1", 700, FieldType.INT, brain_input_pin_e);
	public static final Field TRIGGERINPUTPINS2 = Field.create("TRIGGERINPUTPINS2", 701, FieldType.INT, brain_input_pin_e);
	public static final Field TRIGGERINPUTPINS3 = Field.create("TRIGGERINPUTPINS3", 702, FieldType.INT, brain_input_pin_e);
	public static final Field HIP9011CSPINMODE = Field.create("HIP9011CSPINMODE", 703, FieldType.INT, pin_output_mode_e);
	public static final Field TACHOUTPUTPIN = Field.create("TACHOUTPUTPIN", 704, FieldType.INT, brain_pin_e);
	public static final Field TACHOUTPUTPINMODE = Field.create("TACHOUTPUTPINMODE", 705, FieldType.INT, pin_output_mode_e);
	public static final Field MAINRELAYPIN = Field.create("MAINRELAYPIN", 706, FieldType.INT, brain_pin_e);
	public static final Field SDCARDCSPIN = Field.create("SDCARDCSPIN", 707, FieldType.INT, brain_pin_e);
	public static final Field CANTXPIN = Field.create("CANTXPIN", 708, FieldType.INT, brain_pin_e);
	public static final Field CANRXPIN = Field.create("CANRXPIN", 709, FieldType.INT, brain_pin_e);
	public static final Field BOARDTESTMODEJUMPERPIN = Field.create("BOARDTESTMODEJUMPERPIN", 710, FieldType.INT, brain_pin_e);
	public static final Field UNUSEDMA2 = Field.create("UNUSEDMA2", 711, FieldType.INT);
	...
	public static final Field TRIGGERSIMULATORPINS1 = Field.create("TRIGGERSIMULATORPINS1", 736, FieldType.INT, brain_pin_e);
	public static final Field TRIGGERSIMULATORPINS2 = Field.create("TRIGGERSIMULATORPINS2", 737, FieldType.INT, brain_pin_e);
	public static final Field TRIGGERSIMULATORPINS3 = Field.create("TRIGGERSIMULATORPINS3", 738, FieldType.INT, brain_pin_e);
	public static final Field TRIGGERSIMULATORPINMODES1 = Field.create("TRIGGERSIMULATORPINMODES1", 739, FieldType.INT, pin_output_mode_e);
	public static final Field TRIGGERSIMULATORPINMODES2 = Field.create("TRIGGERSIMULATORPINMODES2", 740, FieldType.INT, pin_output_mode_e);
	public static final Field TRIGGERSIMULATORPINMODES3 = Field.create("TRIGGERSIMULATORPINMODES3", 741, FieldType.INT, pin_output_mode_e);
	public static final Field O2HEATERPIN = Field.create("O2HEATERPIN", 742, FieldType.INT, brain_pin_e);
	public static final Field O2HEATERPINMODETODO = Field.create("O2HEATERPINMODETODO", 743, FieldType.INT, pin_output_mode_e);
	...
	public static final Field LOGICANALYZERPINS1 = Field.create("LOGICANALYZERPINS1", 748, FieldType.INT, brain_input_pin_e);
	public static final Field LOGICANALYZERPINS2 = Field.create("LOGICANALYZERPINS2", 749, FieldType.INT, brain_input_pin_e);
	public static final Field LOGICANALYZERPINS3 = Field.create("LOGICANALYZERPINS3", 750, FieldType.INT, brain_input_pin_e);
	public static final Field LOGICANALYZERPINS4 = Field.create("LOGICANALYZERPINS4", 751, FieldType.INT, brain_input_pin_e);
	public static final Field MAINRELAYPINMODE = Field.create("MAINRELAYPINMODE", 752, FieldType.INT, pin_output_mode_e);
	public static final Field HIP9011CSPIN = Field.create("HIP9011CSPIN", 753, FieldType.INT, brain_pin_e);
	public static final Field HIP9011INTHOLDPIN = Field.create("HIP9011INTHOLDPIN", 754, FieldType.INT, brain_pin_e);
	public static final Field HIP9011INTHOLDPINMODE = Field.create("HIP9011INTHOLDPINMODE", 755, FieldType.INT, pin_output_mode_e);
	public static final Field UNREALISTICRPMTHREASHOLD = Field.create("UNREALISTICRPMTHREASHOLD", 760, FieldType.INT);
	public static final Field GPIOPINMODES1 = Field.create("GPIOPINMODES1", 764, FieldType.INT, pin_output_mode_e);
	public static final Field GPIOPINMODES2 = Field.create("GPIOPINMODES2", 765, FieldType.INT, pin_output_mode_e);
	public static final Field GPIOPINMODES3 = Field.create("GPIOPINMODES3", 766, FieldType.INT, pin_output_mode_e);
	public static final Field GPIOPINMODES4 = Field.create("GPIOPINMODES4", 767, FieldType.INT, pin_output_mode_e);
	public static final Field GPIOPINMODES5 = Field.create("GPIOPINMODES5", 768, FieldType.INT, pin_output_mode_e);
	public static final Field GPIOPINMODES6 = Field.create("GPIOPINMODES6", 769, FieldType.INT, pin_output_mode_e);
	public static final Field GPIOPINMODES7 = Field.create("GPIOPINMODES7", 770, FieldType.INT, pin_output_mode_e);
	public static final Field GPIOPINMODES8 = Field.create("GPIOPINMODES8", 771, FieldType.INT, pin_output_mode_e);
	public static final Field GPIOPINMODES9 = Field.create("GPIOPINMODES9", 772, FieldType.INT, pin_output_mode_e);
	public static final Field GPIOPINMODES10 = Field.create("GPIOPINMODES10", 773, FieldType.INT, pin_output_mode_e);
	public static final Field GPIOPINMODES11 = Field.create("GPIOPINMODES11", 774, FieldType.INT, pin_output_mode_e);
	public static final Field GPIOPINMODES12 = Field.create("GPIOPINMODES12", 775, FieldType.INT, pin_output_mode_e);
	public static final Field GPIOPINMODES13 = Field.create("GPIOPINMODES13", 776, FieldType.INT, pin_output_mode_e);
	public static final Field GPIOPINMODES14 = Field.create("GPIOPINMODES14", 777, FieldType.INT, pin_output_mode_e);
	public static final Field GPIOPINMODES15 = Field.create("GPIOPINMODES15", 778, FieldType.INT, pin_output_mode_e);
	public static final Field GPIOPINMODES16 = Field.create("GPIOPINMODES16", 779, FieldType.INT, pin_output_mode_e);
	public static final Field FSIOOUTPUTPINS1 = Field.create("FSIOOUTPUTPINS1", 780, FieldType.INT, brain_pin_e);
	public static final Field FSIOOUTPUTPINS2 = Field.create("FSIOOUTPUTPINS2", 781, FieldType.INT, brain_pin_e);
	public static final Field FSIOOUTPUTPINS3 = Field.create("FSIOOUTPUTPINS3", 782, FieldType.INT, brain_pin_e);
	public static final Field FSIOOUTPUTPINS4 = Field.create("FSIOOUTPUTPINS4", 783, FieldType.INT, brain_pin_e);
	public static final Field FSIOOUTPUTPINS5 = Field.create("FSIOOUTPUTPINS5", 784, FieldType.INT, brain_pin_e);
	public static final Field FSIOOUTPUTPINS6 = Field.create("FSIOOUTPUTPINS6", 785, FieldType.INT, brain_pin_e);
	public static final Field FSIOOUTPUTPINS7 = Field.create("FSIOOUTPUTPINS7", 786, FieldType.INT, brain_pin_e);
	public static final Field FSIOOUTPUTPINS8 = Field.create("FSIOOUTPUTPINS8", 787, FieldType.INT, brain_pin_e);
	public static final Field FSIOOUTPUTPINS9 = Field.create("FSIOOUTPUTPINS9", 788, FieldType.INT, brain_pin_e);
	public static final Field FSIOOUTPUTPINS10 = Field.create("FSIOOUTPUTPINS10", 789, FieldType.INT, brain_pin_e);
	public static final Field FSIOOUTPUTPINS11 = Field.create("FSIOOUTPUTPINS11", 790, FieldType.INT, brain_pin_e);
	public static final Field FSIOOUTPUTPINS12 = Field.create("FSIOOUTPUTPINS12", 791, FieldType.INT, brain_pin_e);
	public static final Field FSIOOUTPUTPINS13 = Field.create("FSIOOUTPUTPINS13", 792, FieldType.INT, brain_pin_e);
	public static final Field FSIOOUTPUTPINS14 = Field.create("FSIOOUTPUTPINS14", 793, FieldType.INT, brain_pin_e);
	public static final Field FSIOOUTPUTPINS15 = Field.create("FSIOOUTPUTPINS15", 794, FieldType.INT, brain_pin_e);
	public static final Field FSIOOUTPUTPINS16 = Field.create("FSIOOUTPUTPINS16", 795, FieldType.INT, brain_pin_e);
	public static final Field MAX31855_CS1 = Field.create("MAX31855_CS1", 796, FieldType.INT, brain_pin_e);
	public static final Field MAX31855_CS2 = Field.create("MAX31855_CS2", 797, FieldType.INT, brain_pin_e);
	public static final Field MAX31855_CS3 = Field.create("MAX31855_CS3", 798, FieldType.INT, brain_pin_e);
	public static final Field MAX31855_CS4 = Field.create("MAX31855_CS4", 799, FieldType.INT, brain_pin_e);
	public static final Field MAX31855_CS5 = Field.create("MAX31855_CS5", 800, FieldType.INT, brain_pin_e);
	public static final Field MAX31855_CS6 = Field.create("MAX31855_CS6", 801, FieldType.INT, brain_pin_e);
	public static final Field MAX31855_CS7 = Field.create("MAX31855_CS7", 802, FieldType.INT, brain_pin_e);
	public static final Field MAX31855_CS8 = Field.create("MAX31855_CS8", 803, FieldType.INT, brain_pin_e);
	public static final Field MAX31855SPIDEVICE = Field.create("MAX31855SPIDEVICE", 804, FieldType.INT);
	public static final Field CONSOLEUARTDEVICE = Field.create("CONSOLEUARTDEVICE", 808, FieldType.INT);
	public static final Field MAPMINBUFFERLENGTH = Field.create("MAPMINBUFFERLENGTH", 812, FieldType.INT);
	public static final Field IDLEPIDDEACTIVATIONTPSTHRESHOLD = Field.create("IDLEPIDDEACTIVATIONTPSTHRESHOLD", 816, FieldType.INT);
	public static final Field STEPPERPARKINGEXTRASTEPS = Field.create("STEPPERPARKINGEXTRASTEPS", 818, FieldType.INT);
	...
	public static final Field TRIGGERERRORPIN = Field.create("TRIGGERERRORPIN", 828, FieldType.INT, brain_pin_e);
	public static final Field TRIGGERERRORPINMODE = Field.create("TRIGGERERRORPINMODE", 829, FieldType.INT, pin_output_mode_e);
	public static final Field ACRELAYPIN = Field.create("ACRELAYPIN", 830, FieldType.INT, brain_pin_e);
	public static final Field ACRELAYPINMODE = Field.create("ACRELAYPINMODE", 831, FieldType.INT, pin_output_mode_e);
	public static final Field FSIOFREQUENCY1 = Field.create("FSIOFREQUENCY1", 832, FieldType.INT);
	public static final Field FSIOFREQUENCY2 = Field.create("FSIOFREQUENCY2", 834, FieldType.INT);
	public static final Field FSIOFREQUENCY3 = Field.create("FSIOFREQUENCY3", 836, FieldType.INT);
	public static final Field FSIOFREQUENCY4 = Field.create("FSIOFREQUENCY4", 838, FieldType.INT);
	public static final Field FSIOFREQUENCY5 = Field.create("FSIOFREQUENCY5", 840, FieldType.INT);
	public static final Field FSIOFREQUENCY6 = Field.create("FSIOFREQUENCY6", 842, FieldType.INT);
	public static final Field FSIOFREQUENCY7 = Field.create("FSIOFREQUENCY7", 844, FieldType.INT);
	public static final Field FSIOFREQUENCY8 = Field.create("FSIOFREQUENCY8", 846, FieldType.INT);
	public static final Field FSIOFREQUENCY9 = Field.create("FSIOFREQUENCY9", 848, FieldType.INT);
	public static final Field FSIOFREQUENCY10 = Field.create("FSIOFREQUENCY10", 850, FieldType.INT);
	public static final Field FSIOFREQUENCY11 = Field.create("FSIOFREQUENCY11", 852, FieldType.INT);
	public static final Field FSIOFREQUENCY12 = Field.create("FSIOFREQUENCY12", 854, FieldType.INT);
	public static final Field FSIOFREQUENCY13 = Field.create("FSIOFREQUENCY13", 856, FieldType.INT);
	public static final Field FSIOFREQUENCY14 = Field.create("FSIOFREQUENCY14", 858, FieldType.INT);
	public static final Field FSIOFREQUENCY15 = Field.create("FSIOFREQUENCY15", 860, FieldType.INT);
	public static final Field FSIOFREQUENCY16 = Field.create("FSIOFREQUENCY16", 862, FieldType.INT);
	...
	public static final Field SPI1MOSIPIN = Field.create("SPI1MOSIPIN", 928, FieldType.INT, brain_pin_e);
	public static final Field SPI1MISOPIN = Field.create("SPI1MISOPIN", 929, FieldType.INT, brain_pin_e);
	public static final Field SPI1SCKPIN = Field.create("SPI1SCKPIN", 930, FieldType.INT, brain_pin_e);
	public static final Field SPI2MOSIPIN = Field.create("SPI2MOSIPIN", 931, FieldType.INT, brain_pin_e);
	public static final Field SPI2MISOPIN = Field.create("SPI2MISOPIN", 932, FieldType.INT, brain_pin_e);
	public static final Field SPI2SCKPIN = Field.create("SPI2SCKPIN", 933, FieldType.INT, brain_pin_e);
	public static final Field SPI3MOSIPIN = Field.create("SPI3MOSIPIN", 934, FieldType.INT, brain_pin_e);
	public static final Field SPI3MISOPIN = Field.create("SPI3MISOPIN", 935, FieldType.INT, brain_pin_e);
	public static final Field SPI3SCKPIN = Field.create("SPI3SCKPIN", 936, FieldType.INT, brain_pin_e);
	public static final Field CDMINPUTPIN = Field.create("CDMINPUTPIN", 937, FieldType.INT, brain_pin_e);
	public static final Field JOYSTICKCENTERPIN = Field.create("JOYSTICKCENTERPIN", 938, FieldType.INT, brain_pin_e);
	public static final Field JOYSTICKAPIN = Field.create("JOYSTICKAPIN", 939, FieldType.INT, brain_pin_e);
	public static final Field JOYSTICKBPIN = Field.create("JOYSTICKBPIN", 940, FieldType.INT, brain_pin_e);
	public static final Field JOYSTICKCPIN = Field.create("JOYSTICKCPIN", 941, FieldType.INT, brain_pin_e);
	public static final Field JOYSTICKDPIN = Field.create("JOYSTICKDPIN", 942, FieldType.INT, brain_pin_e);
	public static final Field UNUSEDJOY = Field.create("UNUSEDJOY", 943, FieldType.INT);
	...
	public static final Field FSIODIGITALINPUTS1 = Field.create("FSIODIGITALINPUTS1", 952, FieldType.INT, brain_pin_e);
	public static final Field FSIODIGITALINPUTS2 = Field.create("FSIODIGITALINPUTS2", 953, FieldType.INT, brain_pin_e);
	public static final Field FSIODIGITALINPUTS3 = Field.create("FSIODIGITALINPUTS3", 954, FieldType.INT, brain_pin_e);
	public static final Field FSIODIGITALINPUTS4 = Field.create("FSIODIGITALINPUTS4", 955, FieldType.INT, brain_pin_e);
	public static final Field FSIODIGITALINPUTS5 = Field.create("FSIODIGITALINPUTS5", 956, FieldType.INT, brain_pin_e);
	public static final Field FSIODIGITALINPUTS6 = Field.create("FSIODIGITALINPUTS6", 957, FieldType.INT, brain_pin_e);
	public static final Field FSIODIGITALINPUTS7 = Field.create("FSIODIGITALINPUTS7", 958, FieldType.INT, brain_pin_e);
	public static final Field FSIODIGITALINPUTS8 = Field.create("FSIODIGITALINPUTS8", 959, FieldType.INT, brain_pin_e);
	public static final Field FSIODIGITALINPUTS9 = Field.create("FSIODIGITALINPUTS9", 960, FieldType.INT, brain_pin_e);
	public static final Field FSIODIGITALINPUTS10 = Field.create("FSIODIGITALINPUTS10", 961, FieldType.INT, brain_pin_e);
	public static final Field FSIODIGITALINPUTS11 = Field.create("FSIODIGITALINPUTS11", 962, FieldType.INT, brain_pin_e);
	public static final Field FSIODIGITALINPUTS12 = Field.create("FSIODIGITALINPUTS12", 963, FieldType.INT, brain_pin_e);
	public static final Field FSIODIGITALINPUTS13 = Field.create("FSIODIGITALINPUTS13", 964, FieldType.INT, brain_pin_e);
	public static final Field FSIODIGITALINPUTS14 = Field.create("FSIODIGITALINPUTS14", 965, FieldType.INT, brain_pin_e);
	public static final Field FSIODIGITALINPUTS15 = Field.create("FSIODIGITALINPUTS15", 966, FieldType.INT, brain_pin_e);
	public static final Field FSIODIGITALINPUTS16 = Field.create("FSIODIGITALINPUTS16", 967, FieldType.INT, brain_pin_e);
	public static final Field VEHICLESPEEDSENSORINPUTPIN = Field.create("VEHICLESPEEDSENSORINPUTPIN", 968, FieldType.INT, brain_input_pin_e);
	public static final Field CLUTCHUPPIN = Field.create("CLUTCHUPPIN", 969, FieldType.INT, brain_pin_e);
	public static final Field FREQUENCYREPORTINGMAPINPUTPIN = Field.create("FREQUENCYREPORTINGMAPINPUTPIN", 970, FieldType.INT, brain_input_pin_e);
	public static final Field CLUTCHUPPINMODE = Field.create("CLUTCHUPPINMODE", 971, FieldType.INT);
	...
	public static final Field HIPOUTPUTCHANNEL = Field.create("HIPOUTPUTCHANNEL", 1468, FieldType.INT, adc_channel_e);
	...
	public static final Field IDLEPIDRPMUPPERLIMIT = Field.create("IDLEPIDRPMUPPERLIMIT", 1484, FieldType.INT);
	public static final Field PRIMEINJFALLOFFTEMPERATURE = Field.create("PRIMEINJFALLOFFTEMPERATURE", 1486, FieldType.INT);
	public static final Field ACSWITCHADC = Field.create("ACSWITCHADC", 1488, FieldType.INT, adc_channel_e);
	public static final Field IGNMATHCALCULATEATINDEX = Field.create("IGNMATHCALCULATEATINDEX", 1492, FieldType.INT);
	public static final Field ACCUTOFFLOWRPM = Field.create("ACCUTOFFLOWRPM", 1496, FieldType.INT);
	public static final Field ACCUTOFFHIGHRPM = Field.create("ACCUTOFFHIGHRPM", 1498, FieldType.INT);
	public static final Field ACIDLERPMBUMP = Field.create("ACIDLERPMBUMP", 1500, FieldType.INT);
	public static final Field WARNINGPERIOD = Field.create("WARNINGPERIOD", 1502, FieldType.INT);
	public static final Field VREFADCCHANNEL = Field.create("VREFADCCHANNEL", 1504, FieldType.INT, adc_channel_e);
	...
	public static final Field FSIOINPUTMODES1 = Field.create("FSIOINPUTMODES1", 1524, FieldType.INT);
	public static final Field FSIOINPUTMODES2 = Field.create("FSIOINPUTMODES2", 1525, FieldType.INT);
	public static final Field FSIOINPUTMODES3 = Field.create("FSIOINPUTMODES3", 1526, FieldType.INT);
	public static final Field FSIOINPUTMODES4 = Field.create("FSIOINPUTMODES4", 1527, FieldType.INT);
	public static final Field FSIOINPUTMODES5 = Field.create("FSIOINPUTMODES5", 1528, FieldType.INT);
	public static final Field FSIOINPUTMODES6 = Field.create("FSIOINPUTMODES6", 1529, FieldType.INT);
	public static final Field FSIOINPUTMODES7 = Field.create("FSIOINPUTMODES7", 1530, FieldType.INT);
	public static final Field FSIOINPUTMODES8 = Field.create("FSIOINPUTMODES8", 1531, FieldType.INT);
	public static final Field FSIOINPUTMODES9 = Field.create("FSIOINPUTMODES9", 1532, FieldType.INT);
	public static final Field FSIOINPUTMODES10 = Field.create("FSIOINPUTMODES10", 1533, FieldType.INT);
	public static final Field FSIOINPUTMODES11 = Field.create("FSIOINPUTMODES11", 1534, FieldType.INT);
	public static final Field FSIOINPUTMODES12 = Field.create("FSIOINPUTMODES12", 1535, FieldType.INT);
	public static final Field FSIOINPUTMODES13 = Field.create("FSIOINPUTMODES13", 1536, FieldType.INT);
	public static final Field FSIOINPUTMODES14 = Field.create("FSIOINPUTMODES14", 1537, FieldType.INT);
	public static final Field FSIOINPUTMODES15 = Field.create("FSIOINPUTMODES15", 1538, FieldType.INT);
	public static final Field FSIOINPUTMODES16 = Field.create("FSIOINPUTMODES16", 1539, FieldType.INT);
	...
	public static final Field ALTERNATORCONTROL_OFFSET = Field.create("ALTERNATORCONTROL_OFFSET", 1748, FieldType.INT);
	public static final Field ALTERNATORCONTROL_PERIODMS = Field.create("ALTERNATORCONTROL_PERIODMS", 1750, FieldType.INT);
	public static final Field ALTERNATORCONTROL_MINVALUE = Field.create("ALTERNATORCONTROL_MINVALUE", 1752, FieldType.INT);
	public static final Field ALTERNATORCONTROL_MAXVALUE = Field.create("ALTERNATORCONTROL_MAXVALUE", 1754, FieldType.INT);
	...
	public static final Field ETB_OFFSET = Field.create("ETB_OFFSET", 1768, FieldType.INT);
	public static final Field ETB_PERIODMS = Field.create("ETB_PERIODMS", 1770, FieldType.INT);
	public static final Field ETB_MINVALUE = Field.create("ETB_MINVALUE", 1772, FieldType.INT);
	public static final Field ETB_MAXVALUE = Field.create("ETB_MAXVALUE", 1774, FieldType.INT);
	...
	public static final Field WARMUPAFRPID_OFFSET = Field.create("WARMUPAFRPID_OFFSET", 1788, FieldType.INT);
	public static final Field WARMUPAFRPID_PERIODMS = Field.create("WARMUPAFRPID_PERIODMS", 1790, FieldType.INT);
	public static final Field WARMUPAFRPID_MINVALUE = Field.create("WARMUPAFRPID_MINVALUE", 1792, FieldType.INT);
	public static final Field WARMUPAFRPID_MAXVALUE = Field.create("WARMUPAFRPID_MAXVALUE", 1794, FieldType.INT);
	...
	public static final Field IDLERPMPID_OFFSET = Field.create("IDLERPMPID_OFFSET", 1820, FieldType.INT);
	public static final Field IDLERPMPID_PERIODMS = Field.create("IDLERPMPID_PERIODMS", 1822, FieldType.INT);
	public static final Field IDLERPMPID_MINVALUE = Field.create("IDLERPMPID_MINVALUE", 1824, FieldType.INT);
	public static final Field IDLERPMPID_MAXVALUE = Field.create("IDLERPMPID_MAXVALUE", 1826, FieldType.INT);
	public static final Field WWAEBETA = Field.create("WWAEBETA", 1828, FieldType.FLOAT);
	public static final Field COMMUNICATIONLEDPIN = Field.create("COMMUNICATIONLEDPIN", 1832, FieldType.INT, brain_pin_e);
	public static final Field RUNNINGLEDPIN = Field.create("RUNNINGLEDPIN", 1833, FieldType.INT, brain_pin_e);
	public static final Field BINARYSERIALTXPIN = Field.create("BINARYSERIALTXPIN", 1834, FieldType.INT, brain_pin_e);
	public static final Field BINARYSERIALRXPIN = Field.create("BINARYSERIALRXPIN", 1835, FieldType.INT, brain_pin_e);
	public static final Field AUXVALVES1 = Field.create("AUXVALVES1", 1836, FieldType.INT, brain_pin_e);
	public static final Field AUXVALVES2 = Field.create("AUXVALVES2", 1837, FieldType.INT, brain_pin_e);
	public static final Field CONSOLESERIALTXPIN = Field.create("CONSOLESERIALTXPIN", 1838, FieldType.INT, brain_pin_e);
	public static final Field CONSOLESERIALRXPIN = Field.create("CONSOLESERIALRXPIN", 1839, FieldType.INT, brain_pin_e);
	...
	public static final Field STARTUPFUELPUMPDURATION = Field.create("STARTUPFUELPUMPDURATION", 1912, FieldType.INT);
	public static final Field IDLEPIDRPMDEADZONE = Field.create("IDLEPIDRPMDEADZONE", 1914, FieldType.INT);
	...
	public static final Field AFTERCRANKINGIACTAPERDURATION = Field.create("AFTERCRANKINGIACTAPERDURATION", 2056, FieldType.INT);
	public static final Field IACBYTPSTAPER = Field.create("IACBYTPSTAPER", 2058, FieldType.INT);
	public static final Field FATALERRORPIN = Field.create("FATALERRORPIN", 2060, FieldType.INT, brain_pin_e);
	public static final Field WARNINIGLEDPIN = Field.create("WARNINIGLEDPIN", 2061, FieldType.INT, brain_pin_e);
	public static final Field CONFIGRESETPIN = Field.create("CONFIGRESETPIN", 2062, FieldType.INT, brain_pin_e);
	public static final Field LIS302DLCSPIN = Field.create("LIS302DLCSPIN", 2063, FieldType.INT, brain_pin_e);
	...
	public static final Field FSIOADC1 = Field.create("FSIOADC1", 2220, FieldType.INT, adc_channel_e);
	public static final Field FSIOADC2 = Field.create("FSIOADC2", 2221, FieldType.INT, adc_channel_e);
	public static final Field FSIOADC3 = Field.create("FSIOADC3", 2222, FieldType.INT, adc_channel_e);
	public static final Field FSIOADC4 = Field.create("FSIOADC4", 2223, FieldType.INT, adc_channel_e);
	...
	public static final Field AUXPIDPINS1 = Field.create("AUXPIDPINS1", 2240, FieldType.INT, brain_pin_e);
	public static final Field AUXPIDPINS2 = Field.create("AUXPIDPINS2", 2241, FieldType.INT, brain_pin_e);
	public static final Field AUXPIDPINS3 = Field.create("AUXPIDPINS3", 2242, FieldType.INT, brain_pin_e);
	public static final Field AUXPIDPINS4 = Field.create("AUXPIDPINS4", 2243, FieldType.INT, brain_pin_e);
	public static final Field CAMINPUT = Field.create("CAMINPUT", 2244, FieldType.INT, brain_input_pin_e);
	public static final Field CJ125CSPINMODE = Field.create("CJ125CSPINMODE", 2245, FieldType.INT, pin_output_mode_e);
	public static final Field DIZZYSPARKOUTPUTPIN = Field.create("DIZZYSPARKOUTPUTPIN", 2246, FieldType.INT, brain_pin_e);
	public static final Field DIZZYSPARKOUTPUTPINMODE = Field.create("DIZZYSPARKOUTPUTPINMODE", 2247, FieldType.INT, pin_output_mode_e);
	...
	public static final Field AUXPIDFREQUENCY1 = Field.create("AUXPIDFREQUENCY1", 2268, FieldType.INT);
	public static final Field AUXPIDFREQUENCY2 = Field.create("AUXPIDFREQUENCY2", 2270, FieldType.INT);
	public static final Field AUXPIDFREQUENCY3 = Field.create("AUXPIDFREQUENCY3", 2272, FieldType.INT);
	public static final Field AUXPIDFREQUENCY4 = Field.create("AUXPIDFREQUENCY4", 2274, FieldType.INT);
	...
	public static final Field CJ125SPIDEVICE = Field.create("CJ125SPIDEVICE", 2284, FieldType.INT);
	...
	public static final Field AUXTEMPSENSOR1_ADCCHANNEL = Field.create("AUXTEMPSENSOR1_ADCCHANNEL", 2496, FieldType.INT, adc_channel_e);
	...
	public static final Field AUXTEMPSENSOR2_ADCCHANNEL = Field.create("AUXTEMPSENSOR2_ADCCHANNEL", 2528, FieldType.INT, adc_channel_e);
	public static final Field FUELCLOSEDLOOPCLTTHRESHOLD = Field.create("FUELCLOSEDLOOPCLTTHRESHOLD", 2532, FieldType.INT);
	public static final Field FUELCLOSEDLOOPTPSTHRESHOLD = Field.create("FUELCLOSEDLOOPTPSTHRESHOLD", 2534, FieldType.INT);
	public static final Field FUELCLOSEDLOOPRPMTHRESHOLD = Field.create("FUELCLOSEDLOOPRPMTHRESHOLD", 2536, FieldType.INT);
	public static final Field ETBFREQ = Field.create("ETBFREQ", 2538, FieldType.INT);
	...
	public static final Field FUELCLOSEDLOOPPID_OFFSET = Field.create("FUELCLOSEDLOOPPID_OFFSET", 2552, FieldType.INT);
	public static final Field FUELCLOSEDLOOPPID_PERIODMS = Field.create("FUELCLOSEDLOOPPID_PERIODMS", 2554, FieldType.INT);
	public static final Field FUELCLOSEDLOOPPID_MINVALUE = Field.create("FUELCLOSEDLOOPPID_MINVALUE", 2556, FieldType.INT);
	public static final Field FUELCLOSEDLOOPPID_MAXVALUE = Field.create("FUELCLOSEDLOOPPID_MAXVALUE", 2558, FieldType.INT);
	...
	public static final Field SPI2SCKMODE = Field.create("SPI2SCKMODE", 2623, FieldType.INT, pin_mode_e);
	public static final Field SPI2MOSIMODE = Field.create("SPI2MOSIMODE", 2624, FieldType.INT, pin_mode_e);
	public static final Field SPI2MISOMODE = Field.create("SPI2MISOMODE", 2625, FieldType.INT, pin_mode_e);
	...
	public static final Field BRAKEPEDALPINMODE = Field.create("BRAKEPEDALPINMODE", 2635, FieldType.INT);
	...
	public static final Field AUXPID1_OFFSET = Field.create("AUXPID1_OFFSET", 2648, FieldType.INT);
	public static final Field AUXPID1_PERIODMS = Field.create("AUXPID1_PERIODMS", 2650, FieldType.INT);
	public static final Field AUXPID1_MINVALUE = Field.create("AUXPID1_MINVALUE", 2652, FieldType.INT);
	public static final Field AUXPID1_MAXVALUE = Field.create("AUXPID1_MAXVALUE", 2654, FieldType.INT);
	...
	public static final Field AUXPID2_OFFSET = Field.create("AUXPID2_OFFSET", 2668, FieldType.INT);
	public static final Field AUXPID2_PERIODMS = Field.create("AUXPID2_PERIODMS", 2670, FieldType.INT);
	public static final Field AUXPID2_MINVALUE = Field.create("AUXPID2_MINVALUE", 2672, FieldType.INT);
	public static final Field AUXPID2_MAXVALUE = Field.create("AUXPID2_MAXVALUE", 2674, FieldType.INT);
	...
	public static final Field AUXPID3_OFFSET = Field.create("AUXPID3_OFFSET", 2688, FieldType.INT);
	public static final Field AUXPID3_PERIODMS = Field.create("AUXPID3_PERIODMS", 2690, FieldType.INT);
	public static final Field AUXPID3_MINVALUE = Field.create("AUXPID3_MINVALUE", 2692, FieldType.INT);
	public static final Field AUXPID3_MAXVALUE = Field.create("AUXPID3_MAXVALUE", 2694, FieldType.INT);
	...
	public static final Field AUXPID4_OFFSET = Field.create("AUXPID4_OFFSET", 2708, FieldType.INT);
	public static final Field AUXPID4_PERIODMS = Field.create("AUXPID4_PERIODMS", 2710, FieldType.INT);
	public static final Field AUXPID4_MINVALUE = Field.create("AUXPID4_MINVALUE", 2712, FieldType.INT);
	public static final Field AUXPID4_MAXVALUE = Field.create("AUXPID4_MAXVALUE", 2714, FieldType.INT);
	public static final Field OILPRESSURE_HWCHANNEL = Field.create("OILPRESSURE_HWCHANNEL", 2716, FieldType.INT, adc_channel_e);
	...
	public static final Field ACCELEROMETERSPIDEVICE = Field.create("ACCELEROMETERSPIDEVICE", 2736, FieldType.INT);
	public static final Field FLEXFUELSENSOR = Field.create("FLEXFUELSENSOR", 3124, FieldType.INT, brain_input_pin_e);
	public static final Field TEST557PIN = Field.create("TEST557PIN", 3125, FieldType.INT, brain_pin_e);
	...
	public static final Field SERVOOUTPUTPINS4 = Field.create("SERVOOUTPUTPINS4", 3167, FieldType.INT, brain_pin_e);
	public static final Field SERVOOUTPUTPINS5 = Field.create("SERVOOUTPUTPINS5", 3168, FieldType.INT, brain_pin_e);
	public static final Field SERVOOUTPUTPINS6 = Field.create("SERVOOUTPUTPINS6", 3169, FieldType.INT, brain_pin_e);
	public static final Field SERVOOUTPUTPINS7 = Field.create("SERVOOUTPUTPINS7", 3170, FieldType.INT, brain_pin_e);
	public static final Field SERVOOUTPUTPINS8 = Field.create("SERVOOUTPUTPINS8", 3171, FieldType.INT, brain_pin_e);
	public static final Field COASTINGFUELCUTRPMHIGH = Field.create("COASTINGFUELCUTRPMHIGH", 3172, FieldType.INT);
	public static final Field COASTINGFUELCUTRPMLOW = Field.create("COASTINGFUELCUTRPMLOW", 3174, FieldType.INT);
	public static final Field COASTINGFUELCUTTPS = Field.create("COASTINGFUELCUTTPS", 3176, FieldType.INT);
	public static final Field COASTINGFUELCUTCLT = Field.create("COASTINGFUELCUTCLT", 3178, FieldType.INT);
	public static final Field PIDEXTRAFORLOWRPM = Field.create("PIDEXTRAFORLOWRPM", 3180, FieldType.INT);
	public static final Field COASTINGFUELCUTMAP = Field.create("COASTINGFUELCUTMAP", 3182, FieldType.INT);
