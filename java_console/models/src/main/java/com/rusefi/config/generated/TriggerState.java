...
public class TriggerState {
	...
	public static final Field TRIGGERSYNCGAPRATIO = Field.create("TRIGGERSYNCGAPRATIO", 8, FieldType.FLOAT).setBaseOffset(1196);
	public static final Field TRIGGERSTATEINDEX = Field.create("TRIGGERSTATEINDEX", 12, FieldType.INT8).setScale(1.0).setBaseOffset(1196);
	public static final Field VVTCOUNTER = Field.create("VVTCOUNTER", 13, FieldType.INT8).setScale(1.0).setBaseOffset(1196);
	public static final Field CAMRESYNCCOUNTER = Field.create("CAMRESYNCCOUNTER", 14, FieldType.INT8).setScale(1.0).setBaseOffset(1196);
	public static final Field VVTSTATEINDEX = Field.create("VVTSTATEINDEX", 15, FieldType.INT8).setScale(1.0).setBaseOffset(1196);
