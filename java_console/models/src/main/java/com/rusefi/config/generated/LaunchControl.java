...
// this file was generated automatically by rusEFI tool config_definition_base-all.jar based on (unknown script) controllers/algo/launch_control_state.txt Tue May 28 23:10:13 UTC 2024
...
public class LaunchControl {
	...
	public static final Field COMBINEDCONDITIONS = Field.create("COMBINEDCONDITIONS", 4, FieldType.BIT, 0).setBaseOffset(1028);
	public static final Field LAUNCHACTIVATEPINSTATE = Field.create("LAUNCHACTIVATEPINSTATE", 4, FieldType.BIT, 1).setBaseOffset(1028);
	public static final Field ISLAUNCHPRECONDITION = Field.create("ISLAUNCHPRECONDITION", 4, FieldType.BIT, 2).setBaseOffset(1028);
	public static final Field ISLAUNCHCONDITION = Field.create("ISLAUNCHCONDITION", 4, FieldType.BIT, 3).setBaseOffset(1028);
