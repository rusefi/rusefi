...
public class IdleState {
	...
	public static final Field ISIDLECOASTING = Field.create("ISIDLECOASTING", 12, FieldType.BIT, 15).setBaseOffset(1640);
	public static final Field ISIDLECLOSEDLOOP = Field.create("ISIDLECLOSEDLOOP", 12, FieldType.BIT, 16).setBaseOffset(1640);
