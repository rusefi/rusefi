...
public class ElectronicThrottle {
	...
	public static final Field ETBCURRENTADJUSTEDTARGET = Field.create("ETBCURRENTADJUSTEDTARGET", 28, FieldType.FLOAT).setBaseOffset(1676);
	...
	public static final Field TCETBDROP = Field.create("TCETBDROP", 41, FieldType.INT8).setScale(1.0).setBaseOffset(1676);
	public static final Field JAMTIMER = Field.create("JAMTIMER", 42, FieldType.INT16).setScale(0.01).setBaseOffset(1676);
	public static final Field ADJUSTEDETBTARGET = Field.create("ADJUSTEDETBTARGET", 44, FieldType.INT8).setScale(1.0).setBaseOffset(1676);
	public static final Field ALIGNMENTFILL_AT_45 = Field.create("ALIGNMENTFILL_AT_45", 45, FieldType.INT8).setScale(1.0).setBaseOffset(1676);
