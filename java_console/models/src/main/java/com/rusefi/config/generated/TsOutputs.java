...
// this file was generated automatically by rusEFI tool ConfigDefinition.jar based on (unknown script) console/binary/output_channels.txt Thu May 04 23:56:00 UTC 2023
...
public class TsOutputs {
	...
	public static final Field UNUSEDPADDING = Field.create("UNUSEDPADDING", 120, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	...
	public static final Field UNUSEDATTHEEND135 = Field.create("UNUSEDATTHEEND135", 814, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND136 = Field.create("UNUSEDATTHEEND136", 815, FieldType.INT8).setScale(1.0).setBaseOffset(0);
