...
// this file was generated automatically by rusEFI tool ConfigDefinition.jar based on (unknown script) console/binary/output_channels.txt Fri May 05 16:36:44 UTC 2023
...
public class TsOutputs {
	...
	public static final Field CURRENTIGNITIONMODE = Field.create("CURRENTIGNITIONMODE", 74, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field CURRENTINJECTIONMODE = Field.create("CURRENTINJECTIONMODE", 75, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	...
	public static final Field DETECTEDGEAR = Field.create("DETECTEDGEAR", 120, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field MAXTRIGGERREENTRANT = Field.create("MAXTRIGGERREENTRANT", 121, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field LOWFUELPRESSURE = Field.create("LOWFUELPRESSURE", 122, FieldType.INT16).setScale(0.03333333333333333).setBaseOffset(0);
	...
	public static final Field TCUDESIREDGEAR = Field.create("TCUDESIREDGEAR", 254, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field FLEXPERCENT = Field.create("FLEXPERCENT", 255, FieldType.INT8).setScale(0.5).setBaseOffset(0);
	public static final Field WASTEGATEPOSITIONSENSOR = Field.create("WASTEGATEPOSITIONSENSOR", 256, FieldType.INT16).setScale(0.01).setBaseOffset(0);
	public static final Field IDLEPOSITIONSENSOR = Field.create("IDLEPOSITIONSENSOR", 258, FieldType.INT16).setScale(0.01).setBaseOffset(0);
	public static final Field RAWLOWFUELPRESSURE = Field.create("RAWLOWFUELPRESSURE", 260, FieldType.INT16).setScale(0.001).setBaseOffset(0);
	public static final Field RAWHIGHFUELPRESSURE = Field.create("RAWHIGHFUELPRESSURE", 262, FieldType.INT16).setScale(0.001).setBaseOffset(0);
