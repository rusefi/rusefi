...
// this file was generated automatically by rusEFI tool config_definition_base-all.jar based on (unknown script) console/binary/output_channels.txt Wed May 08 14:36:46 UTC 2024
...
public class TsOutputs {
	...
	public static final Field STARTOFDWELLANGLE1 = Field.create("STARTOFDWELLANGLE1", 760, FieldType.FLOAT).setBaseOffset(0);
	public static final Field STARTOFDWELLANGLE2 = Field.create("STARTOFDWELLANGLE2", 764, FieldType.FLOAT).setBaseOffset(0);
	public static final Field STARTOFDWELLANGLE3 = Field.create("STARTOFDWELLANGLE3", 768, FieldType.FLOAT).setBaseOffset(0);
	public static final Field STARTOFDWELLANGLE4 = Field.create("STARTOFDWELLANGLE4", 772, FieldType.FLOAT).setBaseOffset(0);
	public static final Field STARTOFDWELLANGLE5 = Field.create("STARTOFDWELLANGLE5", 776, FieldType.FLOAT).setBaseOffset(0);
	public static final Field STARTOFDWELLANGLE6 = Field.create("STARTOFDWELLANGLE6", 780, FieldType.FLOAT).setBaseOffset(0);
	public static final Field ENDOFDWELLANGLE1 = Field.create("ENDOFDWELLANGLE1", 784, FieldType.FLOAT).setBaseOffset(0);
	public static final Field ENDOFDWELLANGLE2 = Field.create("ENDOFDWELLANGLE2", 788, FieldType.FLOAT).setBaseOffset(0);
	public static final Field ENDOFDWELLANGLE3 = Field.create("ENDOFDWELLANGLE3", 792, FieldType.FLOAT).setBaseOffset(0);
	public static final Field ENDOFDWELLANGLE4 = Field.create("ENDOFDWELLANGLE4", 796, FieldType.FLOAT).setBaseOffset(0);
	public static final Field ENDOFDWELLANGLE5 = Field.create("ENDOFDWELLANGLE5", 800, FieldType.FLOAT).setBaseOffset(0);
	public static final Field ENDOFDWELLANGLE6 = Field.create("ENDOFDWELLANGLE6", 804, FieldType.FLOAT).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND1 = Field.create("UNUSEDATTHEEND1", 808, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND2 = Field.create("UNUSEDATTHEEND2", 809, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND3 = Field.create("UNUSEDATTHEEND3", 810, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND4 = Field.create("UNUSEDATTHEEND4", 811, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND5 = Field.create("UNUSEDATTHEEND5", 812, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND6 = Field.create("UNUSEDATTHEEND6", 813, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND7 = Field.create("UNUSEDATTHEEND7", 814, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND8 = Field.create("UNUSEDATTHEEND8", 815, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND9 = Field.create("UNUSEDATTHEEND9", 816, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND10 = Field.create("UNUSEDATTHEEND10", 817, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND11 = Field.create("UNUSEDATTHEEND11", 818, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND12 = Field.create("UNUSEDATTHEEND12", 819, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND13 = Field.create("UNUSEDATTHEEND13", 820, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND14 = Field.create("UNUSEDATTHEEND14", 821, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND15 = Field.create("UNUSEDATTHEEND15", 822, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND16 = Field.create("UNUSEDATTHEEND16", 823, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND17 = Field.create("UNUSEDATTHEEND17", 824, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND18 = Field.create("UNUSEDATTHEEND18", 825, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND19 = Field.create("UNUSEDATTHEEND19", 826, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND20 = Field.create("UNUSEDATTHEEND20", 827, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND21 = Field.create("UNUSEDATTHEEND21", 828, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND22 = Field.create("UNUSEDATTHEEND22", 829, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND23 = Field.create("UNUSEDATTHEEND23", 830, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field UNUSEDATTHEEND24 = Field.create("UNUSEDATTHEEND24", 831, FieldType.INT8).setScale(1.0).setBaseOffset(0);
