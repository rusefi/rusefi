...
public class VariableRegistryValues {
	...
	public static final int END_OF_CALIBRATION_PADDING = 51;
	public static final int engine_configuration_s_size = 4152;
	...
	public static final String GAUGE_CATEGORY_BOOST_CONTROL = "Controle de pressão turbo";
	public static final String GAUGE_CATEGORY_ETB = "ETB mais";
	public static final String GAUGE_CATEGORY_FUEL_MATH = "Combustível: cálculo";
	public static final String GAUGE_CATEGORY_SENT = "Sensores - SENT";
	public static final String GAUGE_CATEGORY_SYNC = "Sincronia";
	public static final String GAUGE_CATEGORY_TIMING = "Sincronismo";
	public static final String GAUGE_COIL_DWELL_TIME = "Ignição: tempo de carga";
	...
	public static final String GAUGE_NAME_AC_PRESSURE = "Pressão do ar-condicionado";
	public static final String GAUGE_NAME_ACCEL_LAT = "Aceleração: lateral";
	public static final String GAUGE_NAME_ACCEL_LON = "Aceleração: longitudinal";
	public static final String GAUGE_NAME_ACCEL_ROLL = "Acceleration: Roll";
	public static final String GAUGE_NAME_ACCEL_VERT = "Aceleração: vertical";
	public static final String GAUGE_NAME_ACCEL_YAW = "Acceleration: Yaw";
	public static final String GAUGE_NAME_ADJUSTED_TIMING = "Sincronismo: ignição";
	public static final String GAUGE_NAME_AFR = "Relação AF";
	public static final String GAUGE_NAME_AFR2 = "Relação AF 2";
	public static final String GAUGE_NAME_AFR2_GAS_SCALE = "Relação AF 2 (gasolina)";
	public static final String GAUGE_NAME_AFR_GAS_SCALE = "Relação AF (gasolina)";
	public static final String GAUGE_NAME_AIR_FLOW_ESTIMATE = "Ar: estimativa de fluxo";
	...
	public static final String GAUGE_NAME_AIR_MASS = "Ar: massa por cilindro";
	...
	public static final String GAUGE_NAME_AUX_TEMP1 = "Temp auxiliar 1";
	public static final String GAUGE_NAME_AUX_TEMP2 = "Temp auxiliar 2";
	public static final String GAUGE_NAME_BARO_PRESSURE = "Pressão barométrica";
	public static final String GAUGE_NAME_BOOST_CLOSED_LOOP = "Turbo: Malha fechada";
	public static final String GAUGE_NAME_BOOST_OPEN_LOOP = "Turbo: Malha aberta";
	public static final String GAUGE_NAME_BOOST_OUTPUT = "Turbo: Saída";
	public static final String GAUGE_NAME_BOOST_TARGET = "Turbo: Alvo";
	public static final String GAUGE_NAME_CAN_READ_OK = "CAN: Rx";
	public static final String GAUGE_NAME_CAN_WRITE_ERR = "CAN: Tx erro";
	public static final String GAUGE_NAME_CAN_WRITE_OK = "CAN: Tx OK";
	public static final String GAUGE_NAME_CLT = "Temperatura arrefecimento (CLT)";
	public static final String GAUGE_NAME_CPU_TEMP = "Temperatura da CPU";
	public static final String GAUGE_NAME_CURRENT_GEAR = "TCU: Marcha atual";
	...
	public static final String GAUGE_NAME_DESIRED_GEAR = "TCU: Marcha desejada";
	public static final String GAUGE_NAME_DETECTED_GEAR = "Marcha detectada";
	public static final String GAUGE_NAME_DWELL_DUTY = "Ignição: ciclo de trabalho";
	public static final String GAUGE_NAME_ECU_TEMPERATURE = "Temperatura da ECU";
	public static final String GAUGE_NAME_ENGINE_CRC16 = "CRC16 do motor";
	public static final String GAUGE_NAME_ETB_DUTY = "ETB: ciclo de trabalho";
	public static final String GAUGE_NAME_ETB_ERROR = "ETB: erro de posição";
	public static final String GAUGE_NAME_ETB_TARGET = "ETB: posição alvo";
	public static final String GAUGE_NAME_FLEX = "Flex Etanol %";
	public static final String GAUGE_NAME_FUEL_BARO_CORR = "Combustível: correção barométrica";
	public static final String GAUGE_NAME_FUEL_BASE = "Combustível: massa base";
	public static final String GAUGE_NAME_FUEL_CHARGE_TEMP = "Combustível: temperatura estimada";
	public static final String GAUGE_NAME_FUEL_CLT_CORR = "Combustível: correção CLT";
	public static final String GAUGE_NAME_FUEL_CONSUMPTION = "Combustível: total consumido";
	public static final String GAUGE_NAME_FUEL_CORRECTION_REFERENCE_PRESSURE = "Combustível: pressão de referência";
	public static final String GAUGE_NAME_FUEL_CRANKING = "Combustível: partida";
	public static final String GAUGE_NAME_FUEL_FLOW = "Combustível: taxa de fluxo";
	public static final String GAUGE_NAME_FUEL_IAT_CORR = "Combustível: correção IAT";
	public static final String GAUGE_NAME_FUEL_INJ_DUTY = "Combustível: ciclo de trabalho";
	public static final String GAUGE_NAME_FUEL_INJ_DUTY_STAGE_2 = "Combustível: ciclo de trabalho 2";
	public static final String GAUGE_NAME_FUEL_INJECTION_TIMING = "Combustível: fase da injeção";
	public static final String GAUGE_NAME_FUEL_LAST_INJECTION = "Combustível: último pulso";
	public static final String GAUGE_NAME_FUEL_LAST_INJECTION_STAGE_2 = "Combustível: último pulso 2";
	public static final String GAUGE_NAME_FUEL_LEVEL = "Nível de combustível";
	public static final String GAUGE_NAME_FUEL_LOAD = "Combustível: carga";
	public static final String GAUGE_NAME_FUEL_PRESSURE_HIGH = "Pressão de comb. (alta)";
	public static final String GAUGE_NAME_FUEL_PRESSURE_HIGH_UNITS = "bar";
	public static final String GAUGE_NAME_FUEL_PRESSURE_LOW = "Pressão de comb. (baixa)";
	public static final String GAUGE_NAME_FUEL_PRESSURE_LOW_UNITS = "kPa";
	public static final String GAUGE_NAME_FUEL_RUNNING = "Combustível: em funcionamento";
	public static final String GAUGE_NAME_FUEL_TEMPERATURE = "Temperatura do comb.";
	public static final String GAUGE_NAME_FUEL_TPS_EXTRA = "Combustível: acréscimo TPS (ms)";
	public static final String GAUGE_NAME_FUEL_TPS_ROC = "Fuel: TPS change";
	public static final String GAUGE_NAME_FUEL_TRIM = "Combustível: ajuste fino";
	public static final String GAUGE_NAME_FUEL_TRIM_2 = "Combustível: ajuste fino 2";
	public static final String GAUGE_NAME_FUEL_VE = "Combustível: VE";
	public static final String GAUGE_NAME_FUEL_WALL_AMOUNT = "Combustível: quantidade na parede";
	public static final String GAUGE_NAME_FUEL_WALL_CORRECTION = "Combustível: correção de parede";
	public static final String GAUGE_NAME_FW_VERSION = "Versão do software da ECU";
	public static final String GAUGE_NAME_GEAR_RATIO = "Relação de marchas";
	public static final String GAUGE_NAME_GYRO_YAW = "Giro: taxa de guinada";
	public static final String GAUGE_NAME_IAC = "Marcha lenta: posição";
	public static final String GAUGE_NAME_IAT = "Temperatura admissão (IAT)";
	public static final String GAUGE_NAME_IDLE_POSITION = "Marcha lenta: sensor de posição";
	public static final String GAUGE_NAME_IGNITION_LOAD = "Ignição: carga";
	public static final String GAUGE_NAME_IGNITION_MODE = "Ignição: modo";
	public static final String GAUGE_NAME_INJECTION_MODE = "Combustível: modo de injeção";
	public static final String GAUGE_NAME_INJECTOR_LAG = "Combustível: atraso do injetor";
	public static final String GAUGE_NAME_ISS = "TCU: Velocidade do eixo de entrada";
	...
	public static final String GAUGE_NAME_KNOCK_COUNTER = "Detonação: contagem";
	public static final String GAUGE_NAME_KNOCK_FREQ = "Detonação: frequência";
	public static final String GAUGE_NAME_KNOCK_LEVEL = "Detonação: nível atual";
	public static final String GAUGE_NAME_KNOCK_RETARD = "Detonação: retardo";
	public static final String GAUGE_NAME_LAMBDA = "Lambda";
	public static final String GAUGE_NAME_LAMBDA2 = "Lambda 2";
	public static final String GAUGE_NAME_LAST_ERROR = "Aviso: último";
	...
	public static final String GAUGE_NAME_OIL_PRESSURE = "Pressão do óleo";
	public static final String GAUGE_NAME_OIL_PRESSURE_UNITS = "kPa";
	public static final String GAUGE_NAME_RAW_FUEL_PRESSURE_HIGH = "Pressão de comb. bruta (alta)";
	public static final String GAUGE_NAME_RAW_FUEL_PRESSURE_LOW = "Pressão de comb. bruta (baixa)";
	public static final String GAUGE_NAME_RPM = "RPM";
	public static final String GAUGE_NAME_TARGET_AFR = "Combustível: AFR alvo";
	public static final String GAUGE_NAME_TARGET_LAMBDA = "Combustível: lambda alvo";
	public static final String GAUGE_NAME_TC_RATIO = "TCU: Relação do conversor";
	public static final String GAUGE_NAME_TCHARGE = "Ar: tCharge SD";
	public static final String GAUGE_NAME_THROTTLE_PEDAL = "Posição do pedal do acelerador";
	public static final String GAUGE_NAME_TIME = "Tempo";
	public static final String GAUGE_NAME_TIMING_ADVANCE = "Sincronismo: ignição base";
	public static final String GAUGE_NAME_TPS = "TPS";
	public static final String GAUGE_NAME_TPS2 = "TPS2";
	public static final String GAUGE_NAME_TRG_ERR = "Erro sincronismo Trigger";
	public static final String GAUGE_NAME_TRG_GAP = "Trigger: Última razão";
	public static final String GAUGE_NAME_TUNE_CRC16 = "CRC16 da calibração";
	public static final String GAUGE_NAME_TURBO_SPEED = "Velocidade do turbo";
	public static final String GAUGE_NAME_UPTIME = "Tempo ligado";
	public static final String GAUGE_NAME_VBAT = "Bateria (VBatt)";
	public static final String GAUGE_NAME_VERSION = "firmware";
	public static final String GAUGE_NAME_VVS = "Velocidade do veículo";
	public static final String GAUGE_NAME_VVT_B1E = "VVT: 1 escape";
	public static final String GAUGE_NAME_VVT_B1I = "VVT: 1 admissão";
	public static final String GAUGE_NAME_VVT_B2E = "VVT: 2 escape";
	public static final String GAUGE_NAME_VVT_B2I = "VVT: 2 admissão";
	public static final String GAUGE_NAME_VVT_TARGET_B1E = "VVT: alvo 1 escape";
	public static final String GAUGE_NAME_VVT_TARGET_B1I = "VVT: alvo 1 admissão";
	public static final String GAUGE_NAME_VVT_TARGET_B2E = "VVT: alvo 2 escape";
	public static final String GAUGE_NAME_VVT_TARGET_B2I = "VVT: alvo 2 admissão";
	public static final String GAUGE_NAME_WARNING_COUNT = "Warning count";
	public static final String GAUGE_NAME_WARNING_COUNTER = "Aviso: contador";
	public static final String GAUGE_NAME_WARNING_LAST = "Aviso: último";
	public static final String GAUGE_NAME_WG_POSITION = "Sensor de posição da wastegate";
	...
	public static final String INDICATOR_NAME_AC_SWITCH = "Interruptor do ar-condicionado";
	public static final String INDICATOR_NAME_BRAKE_DOWN = "Interruptor do freio";
	public static final String INDICATOR_NAME_CLUTCH_DOWN = "Embreagem: baixo";
	public static final String INDICATOR_NAME_CLUTCH_UP = "Embreagem: cima";
	...
	public static final int persistent_config_s_size = 24920;
	...
	public static final String SD_CARD_LABEL = "evoTech logs";
	...
	public static final int SIGNATURE_HASH = 439681968;
	public static final String SIMULATOR_TUNE_BIN_FILE_NAME = "generated/simulator_tune_image.bin";
	public static final String SIMULATOR_TUNE_BIN_FILE_NAME_PREFIX = "generated/simulator_tune_image";
	public static final String SIMULATOR_TUNE_BIN_FILE_NAME_SUFFIX = ".bin";
	public static final String smLaunchControl_NAME = "Launch Control";
	public static final String SMOOTHED_GAUGE_NAME_AFR = "Relação AF suavizada";
	public static final String SMOOTHED_GAUGE_NAME_AFR2 = "Relação AF 2 suavizada";
	...
	public static final int TOTAL_CONFIG_SIZE = 24920;
	...
	public static final String TS_SIGNATURE = "rusEFI adaptive_wall_wetting.2025.06.17.f407-discovery.439681968";
	...
	public static final int WWAE_CORRECTION_SIZE = 8;
