...
// this file was generated automatically by rusEFI tool ConfigDefinition.jar based on gen_config.sh integration/rusefi_config.txt Wed Dec 01 04:22:06 UTC 2021
...
public class Fields {
	...
	public static final int cltFuelCorr_offset = 10736;
	public static final int cltFuelCorrBins_offset = 10672;
	public static final int cltIdleCorr_offset = 11120;
	public static final int cltIdleCorrBins_offset = 11056;
	...
	public static final int crankingCycleBins_offset = 11024;
	public static final int crankingCycleCoef_offset = 10992;
	public static final int crankingFuelBins_offset = 10960;
	public static final int crankingFuelCoef_offset = 10928;
	...
	public static final int driveWheelRevPerKm_offset = 476;
	...
	public static final int iatFuelCorr_offset = 10864;
	public static final int iatFuelCorrBins_offset = 10800;
	...
	public static final int ignitionIatCorrLoadBins_offset = 14256;
	public static final int ignitionIatCorrRpmBins_offset = 14320;
	public static final int ignitionIatCorrTable_offset = 13232;
	public static final int ignitionLoadBins_offset = 17712;
	...
	public static final int ignitionRpmBins_offset = 17776;
	public static final int ignitionTable_offset = 16688;
	...
	public static final int injectionPhase_offset = 14384;
	...
	public static final int injPhaseLoadBins_offset = 15408;
	public static final int injPhaseRpmBins_offset = 15472;
	...
	public static final int lambdaLoadBins_offset = 19248;
	public static final int lambdaRpmBins_offset = 19312;
	public static final int lambdaTable_offset = 18992;
	...
	public static final int LUA_SCRIPT_SIZE = 4000;
	...
	public static final int mafDecoding_offset = 11184;
	public static final int mafDecodingBins_offset = 12208;
	...
	public static final int mapEstimateRpmBins_offset = 16144;
	public static final int mapEstimateTable_offset = 15600;
	public static final int mapEstimateTpsBins_offset = 16112;
	...
	public static final int persistent_config_s_size = 20400;
	...
	public static final int scriptTable1_offset = 19696;
	public static final int scriptTable1LoadBins_offset = 19952;
	public static final int scriptTable1RpmBins_offset = 19984;
	public static final int scriptTable2_offset = 20016;
	public static final int scriptTable2LoadBins_offset = 20080;
	public static final int scriptTable2RpmBins_offset = 20112;
	public static final int scriptTable3_offset = 20144;
	public static final int scriptTable3LoadBins_offset = 20208;
	public static final int scriptTable3RpmBins_offset = 20240;
	public static final int scriptTable4_offset = 20272;
	public static final int scriptTable4LoadBins_offset = 20336;
	public static final int scriptTable4RpmBins_offset = 20368;
	...
	public static final int scriptTableName4_offset = 3612;
	...
	public static final int tcuSolenoidTable_offset = 15536;
	...
	public static final int TOTAL_CONFIG_SIZE = 20400;
	...
	public static final int tpsTpsAccelFromRpmBins_offset = 19632;
	public static final int tpsTpsAccelTable_offset = 19376;
	public static final int tpsTpsAccelToRpmBins_offset = 19664;
	...
	public static final String TS_SIGNATURE = "rusEFI 2021.12.01.proteus_f4.4173296285";
	...
	public static final int unusedLuaWasHere_offset = 16432;
	...
	public static final int veLoadBins_offset = 18864;
	...
	public static final int veRpmBins_offset = 18928;
	public static final int veTable_offset = 17840;
	...
	public static final int vssFilterReciprocal_offset = 15596;
	...
	public static final int vvtTable1_offset = 16176;
	public static final int vvtTable1LoadBins_offset = 16240;
	public static final int vvtTable1RpmBins_offset = 16272;
	public static final int vvtTable2_offset = 16304;
	public static final int vvtTable2LoadBins_offset = 16368;
	public static final int vvtTable2RpmBins_offset = 16400;
	...
	public static final Field DRIVEWHEELREVPERKM = Field.create("DRIVEWHEELREVPERKM", 476, FieldType.FLOAT);
	...
	public static final Field BAROCORRPRESSUREBINS = Field.create("BAROCORRPRESSUREBINS", 1544, FieldType.FLOAT);
	public static final Field BAROCORRRPMBINS = Field.create("BAROCORRRPMBINS", 1560, FieldType.FLOAT);
	public static final Field BAROCORRTABLE = Field.create("BAROCORRTABLE", 1576, FieldType.FLOAT);
	public static final Field CRANKINGTPSCOEF = Field.create("CRANKINGTPSCOEF", 1640, FieldType.FLOAT);
	public static final Field CRANKINGTPSBINS = Field.create("CRANKINGTPSBINS", 1672, FieldType.FLOAT);
	...
	public static final Field KNOCKNOISE = Field.create("KNOCKNOISE", 1820, FieldType.FLOAT);
	public static final Field KNOCKNOISERPMBINS = Field.create("KNOCKNOISERPMBINS", 1852, FieldType.FLOAT);
	...
	public static final Field CLTIDLERPMBINS = Field.create("CLTIDLERPMBINS", 1896, FieldType.FLOAT);
	public static final Field CLTIDLERPM = Field.create("CLTIDLERPM", 1960, FieldType.FLOAT);
	...
	public static final Field MAPACCELTAPERBINS = Field.create("MAPACCELTAPERBINS", 2136, FieldType.FLOAT);
	public static final Field MAPACCELTAPERMULT = Field.create("MAPACCELTAPERMULT", 2168, FieldType.FLOAT);
	...
	public static final Field ALIGNMENTFILL_AT_2253 = Field.create("ALIGNMENTFILL_AT_2253", 2253, FieldType.INT8);
	...
	public static final String[] vvt_mode_e = {"Inactive", "Single Tooth Second Half", "2GZ", "Miata NB2", "Single Tooth First Half", "Bosch Quick Start", "4/1", "ST 170", "Ford Barra 3+1", "Nissan VQ", "Honda K 4+1", "Nissan MR18", "VTwin 45", "vvt13", "vvt14", "vvt15"};
	...
	public static final Field CLTTIMINGBINS = Field.create("CLTTIMINGBINS", 2352, FieldType.FLOAT);
	public static final Field CLTTIMINGEXTRA = Field.create("CLTTIMINGEXTRA", 2384, FieldType.FLOAT);
	...
	public static final Field AUXTEMPSENSOR1_ALIGNMENTFILL_AT_29 = Field.create("AUXTEMPSENSOR1_ALIGNMENTFILL_AT_29", 2473, FieldType.INT8);
	...
	public static final Field AUXTEMPSENSOR2_ALIGNMENTFILL_AT_29 = Field.create("AUXTEMPSENSOR2_ALIGNMENTFILL_AT_29", 2505, FieldType.INT8);
	...
	public static final Field UNUSEDSPIPADDING4 = Field.create("UNUSEDSPIPADDING4", 2593, FieldType.INT8);
	...
	public static final Field UNUSED1366 = Field.create("UNUSED1366", 2684, FieldType.INT8);
	public static final Field OILPRESSURE_HWCHANNEL = Field.create("OILPRESSURE_HWCHANNEL", 2692, FieldType.INT8, adc_channel_e);
	public static final Field OILPRESSURE_ALIGNMENTFILL = Field.create("OILPRESSURE_ALIGNMENTFILL", 2693, FieldType.INT8);
	...
	public static final Field SCRIPTCURVE1BINS = Field.create("SCRIPTCURVE1BINS", 2716, FieldType.FLOAT);
	public static final Field SCRIPTCURVE1 = Field.create("SCRIPTCURVE1", 2780, FieldType.FLOAT);
	public static final Field SCRIPTCURVE2BINS = Field.create("SCRIPTCURVE2BINS", 2844, FieldType.FLOAT);
	public static final Field SCRIPTCURVE2 = Field.create("SCRIPTCURVE2", 2908, FieldType.FLOAT);
	public static final Field SCRIPTCURVE3BINS = Field.create("SCRIPTCURVE3BINS", 2972, FieldType.FLOAT);
	public static final Field SCRIPTCURVE3 = Field.create("SCRIPTCURVE3", 3004, FieldType.FLOAT);
	public static final Field SCRIPTCURVE4BINS = Field.create("SCRIPTCURVE4BINS", 3036, FieldType.FLOAT);
	public static final Field SCRIPTCURVE4 = Field.create("SCRIPTCURVE4", 3068, FieldType.FLOAT);
	...
	public static final Field CRANKINGADVANCEBINS = Field.create("CRANKINGADVANCEBINS", 3108, FieldType.FLOAT);
	public static final Field CRANKINGADVANCE = Field.create("CRANKINGADVANCE", 3124, FieldType.FLOAT);
	...
	public static final Field IACCOASTINGBINS = Field.create("IACCOASTINGBINS", 3160, FieldType.FLOAT);
	public static final Field IACCOASTING = Field.create("IACCOASTING", 3224, FieldType.FLOAT);
	...
	public static final Field HIGHPRESSUREFUEL_ALIGNMENTFILL = Field.create("HIGHPRESSUREFUEL_ALIGNMENTFILL", 3289, FieldType.INT8);
	...
	public static final Field LOWPRESSUREFUEL_ALIGNMENTFILL = Field.create("LOWPRESSUREFUEL_ALIGNMENTFILL", 3309, FieldType.INT8);
	...
	public static final Field CLTREVLIMITRPMBINS = Field.create("CLTREVLIMITRPMBINS", 3328, FieldType.INT8);
	public static final Field CLTREVLIMITRPM = Field.create("CLTREVLIMITRPM", 3332, FieldType.INT16);
	...
	public static final Field SCRIPTCURVE5BINS = Field.create("SCRIPTCURVE5BINS", 3436, FieldType.FLOAT);
	public static final Field SCRIPTCURVE5 = Field.create("SCRIPTCURVE5", 3468, FieldType.FLOAT);
	public static final Field SCRIPTCURVE6BINS = Field.create("SCRIPTCURVE6BINS", 3500, FieldType.FLOAT);
	public static final Field SCRIPTCURVE6 = Field.create("SCRIPTCURVE6", 3532, FieldType.FLOAT);
	public static final Field SCRIPTTABLENAME1 = Field.create("SCRIPTTABLENAME1", 3564, 16, FieldType.STRING);
	...
	public static final Field ETBBIASBINS = Field.create("ETBBIASBINS", 3888, FieldType.FLOAT);
	public static final Field ETBBIASVALUES = Field.create("ETBBIASVALUES", 3920, FieldType.FLOAT);
	...
	public static final Field UNUSED1059 = Field.create("UNUSED1059", 3961, FieldType.INT8);
	...
	public static final Field UNUSED3988 = Field.create("UNUSED3988", 3988, FieldType.INT8);
	public static final Field IDLETIMINGPIDDEADZONE = Field.create("IDLETIMINGPIDDEADZONE", 3990, FieldType.INT16);
	public static final Field UNUSED3942 = Field.create("UNUSED3942", 3992, FieldType.INT8);
	...
	public static final Field UNUSEDSPIPADDING8 = Field.create("UNUSEDSPIPADDING8", 4010, FieldType.INT8);
	...
	public static final Field UNUSED4028 = Field.create("UNUSED4028", 4028, FieldType.INT);
	...
	public static final Field IACPIDMULTTABLE = Field.create("IACPIDMULTTABLE", 4060, FieldType.INT8);
	public static final Field IACPIDMULTLOADBINS = Field.create("IACPIDMULTLOADBINS", 4124, FieldType.INT8);
	public static final Field IACPIDMULTRPMBINS = Field.create("IACPIDMULTRPMBINS", 4132, FieldType.INT8);
	...
	public static final Field GPPWM1_LOADBINS = Field.create("GPPWM1_LOADBINS", 4152, FieldType.INT8);
	public static final Field GPPWM1_RPMBINS = Field.create("GPPWM1_RPMBINS", 4160, FieldType.INT8);
	public static final Field GPPWM1_TABLE = Field.create("GPPWM1_TABLE", 4168, FieldType.INT8);
	...
	public static final Field GPPWM2_LOADBINS = Field.create("GPPWM2_LOADBINS", 4240, FieldType.INT8);
	public static final Field GPPWM2_RPMBINS = Field.create("GPPWM2_RPMBINS", 4248, FieldType.INT8);
	public static final Field GPPWM2_TABLE = Field.create("GPPWM2_TABLE", 4256, FieldType.INT8);
	...
	public static final Field GPPWM3_LOADBINS = Field.create("GPPWM3_LOADBINS", 4328, FieldType.INT8);
	public static final Field GPPWM3_RPMBINS = Field.create("GPPWM3_RPMBINS", 4336, FieldType.INT8);
	public static final Field GPPWM3_TABLE = Field.create("GPPWM3_TABLE", 4344, FieldType.INT8);
	...
	public static final Field GPPWM4_LOADBINS = Field.create("GPPWM4_LOADBINS", 4416, FieldType.INT8);
	public static final Field GPPWM4_RPMBINS = Field.create("GPPWM4_RPMBINS", 4424, FieldType.INT8);
	public static final Field GPPWM4_TABLE = Field.create("GPPWM4_TABLE", 4432, FieldType.INT8);
	...
	public static final Field KNOCKBASENOISE = Field.create("KNOCKBASENOISE", 4523, FieldType.INT8);
	...
	public static final Field AFTERSTARTENRICH = Field.create("AFTERSTARTENRICH", 6184, FieldType.FLOAT);
	public static final Field AFTERSTARTDECAYTIME = Field.create("AFTERSTARTDECAYTIME", 6216, FieldType.FLOAT);
	public static final Field BOOSTTABLEOPENLOOP = Field.create("BOOSTTABLEOPENLOOP", 6248, FieldType.INT8);
	public static final Field UNUSED6312 = Field.create("UNUSED6312", 6312, FieldType.INT8);
	public static final Field BOOSTRPMBINS = Field.create("BOOSTRPMBINS", 6320, FieldType.INT8);
	public static final Field BOOSTTABLECLOSEDLOOP = Field.create("BOOSTTABLECLOSEDLOOP", 6328, FieldType.INT8);
	public static final Field BOOSTTPSBINS = Field.create("BOOSTTPSBINS", 6392, FieldType.INT8);
	public static final Field PEDALTOTPSTABLE = Field.create("PEDALTOTPSTABLE", 6400, FieldType.INT8);
	public static final Field PEDALTOTPSPEDALBINS = Field.create("PEDALTOTPSPEDALBINS", 6464, FieldType.INT8);
	public static final Field PEDALTOTPSRPMBINS = Field.create("PEDALTOTPSRPMBINS", 6472, FieldType.INT8);
	public static final Field CLTCRANKINGCORRBINS = Field.create("CLTCRANKINGCORRBINS", 6480, FieldType.FLOAT);
	public static final Field CLTCRANKINGCORR = Field.create("CLTCRANKINGCORR", 6512, FieldType.FLOAT);
	public static final Field IDLEADVANCEBINS = Field.create("IDLEADVANCEBINS", 6544, FieldType.FLOAT);
	...
	public static final Field LUASCRIPT = Field.create("LUASCRIPT", 6672, 4000, FieldType.STRING);
	public static final Field CLTFUELCORRBINS = Field.create("CLTFUELCORRBINS", 10672, FieldType.FLOAT);
	public static final Field CLTFUELCORR = Field.create("CLTFUELCORR", 10736, FieldType.FLOAT);
	public static final Field IATFUELCORRBINS = Field.create("IATFUELCORRBINS", 10800, FieldType.FLOAT);
	public static final Field IATFUELCORR = Field.create("IATFUELCORR", 10864, FieldType.FLOAT);
	public static final Field CRANKINGFUELCOEF = Field.create("CRANKINGFUELCOEF", 10928, FieldType.FLOAT);
	public static final Field CRANKINGFUELBINS = Field.create("CRANKINGFUELBINS", 10960, FieldType.FLOAT);
	public static final Field CRANKINGCYCLECOEF = Field.create("CRANKINGCYCLECOEF", 10992, FieldType.FLOAT);
	public static final Field CRANKINGCYCLEBINS = Field.create("CRANKINGCYCLEBINS", 11024, FieldType.FLOAT);
	public static final Field CLTIDLECORRBINS = Field.create("CLTIDLECORRBINS", 11056, FieldType.FLOAT);
	public static final Field CLTIDLECORR = Field.create("CLTIDLECORR", 11120, FieldType.FLOAT);
	public static final Field MAFDECODING = Field.create("MAFDECODING", 11184, FieldType.FLOAT);
	public static final Field MAFDECODINGBINS = Field.create("MAFDECODINGBINS", 12208, FieldType.FLOAT);
	public static final Field IGNITIONIATCORRTABLE = Field.create("IGNITIONIATCORRTABLE", 13232, FieldType.FLOAT);
	public static final Field IGNITIONIATCORRLOADBINS = Field.create("IGNITIONIATCORRLOADBINS", 14256, FieldType.FLOAT);
	public static final Field IGNITIONIATCORRRPMBINS = Field.create("IGNITIONIATCORRRPMBINS", 14320, FieldType.FLOAT);
	public static final Field INJECTIONPHASE = Field.create("INJECTIONPHASE", 14384, FieldType.FLOAT);
	public static final Field INJPHASELOADBINS = Field.create("INJPHASELOADBINS", 15408, FieldType.FLOAT);
	public static final Field INJPHASERPMBINS = Field.create("INJPHASERPMBINS", 15472, FieldType.FLOAT);
	public static final Field TCUSOLENOIDTABLE = Field.create("TCUSOLENOIDTABLE", 15536, FieldType.INT8);
	public static final Field VSSFILTERRECIPROCAL = Field.create("VSSFILTERRECIPROCAL", 15596, FieldType.FLOAT);
	public static final Field MAPESTIMATETABLE = Field.create("MAPESTIMATETABLE", 15600, FieldType.INT16);
	public static final Field MAPESTIMATETPSBINS = Field.create("MAPESTIMATETPSBINS", 16112, FieldType.INT16);
	public static final Field MAPESTIMATERPMBINS = Field.create("MAPESTIMATERPMBINS", 16144, FieldType.INT16);
	public static final Field VVTTABLE1 = Field.create("VVTTABLE1", 16176, FieldType.INT8);
	public static final Field VVTTABLE1LOADBINS = Field.create("VVTTABLE1LOADBINS", 16240, FieldType.FLOAT);
	public static final Field VVTTABLE1RPMBINS = Field.create("VVTTABLE1RPMBINS", 16272, FieldType.FLOAT);
	public static final Field VVTTABLE2 = Field.create("VVTTABLE2", 16304, FieldType.INT8);
	public static final Field VVTTABLE2LOADBINS = Field.create("VVTTABLE2LOADBINS", 16368, FieldType.FLOAT);
	public static final Field VVTTABLE2RPMBINS = Field.create("VVTTABLE2RPMBINS", 16400, FieldType.FLOAT);
	public static final Field UNUSEDLUAWASHERE = Field.create("UNUSEDLUAWASHERE", 16432, FieldType.FLOAT);
	public static final Field IGNITIONTABLE = Field.create("IGNITIONTABLE", 16688, FieldType.FLOAT);
	public static final Field IGNITIONLOADBINS = Field.create("IGNITIONLOADBINS", 17712, FieldType.FLOAT);
	public static final Field IGNITIONRPMBINS = Field.create("IGNITIONRPMBINS", 17776, FieldType.FLOAT);
	public static final Field VETABLE = Field.create("VETABLE", 17840, FieldType.FLOAT);
	public static final Field VELOADBINS = Field.create("VELOADBINS", 18864, FieldType.FLOAT);
	public static final Field VERPMBINS = Field.create("VERPMBINS", 18928, FieldType.FLOAT);
	public static final Field LAMBDATABLE = Field.create("LAMBDATABLE", 18992, FieldType.INT8);
	public static final Field LAMBDALOADBINS = Field.create("LAMBDALOADBINS", 19248, FieldType.FLOAT);
	public static final Field LAMBDARPMBINS = Field.create("LAMBDARPMBINS", 19312, FieldType.FLOAT);
	public static final Field TPSTPSACCELTABLE = Field.create("TPSTPSACCELTABLE", 19376, FieldType.FLOAT);
	public static final Field TPSTPSACCELFROMRPMBINS = Field.create("TPSTPSACCELFROMRPMBINS", 19632, FieldType.FLOAT);
	public static final Field TPSTPSACCELTORPMBINS = Field.create("TPSTPSACCELTORPMBINS", 19664, FieldType.FLOAT);
	public static final Field SCRIPTTABLE1 = Field.create("SCRIPTTABLE1", 19696, FieldType.FLOAT);
	public static final Field SCRIPTTABLE1LOADBINS = Field.create("SCRIPTTABLE1LOADBINS", 19952, FieldType.FLOAT);
	public static final Field SCRIPTTABLE1RPMBINS = Field.create("SCRIPTTABLE1RPMBINS", 19984, FieldType.FLOAT);
	public static final Field SCRIPTTABLE2 = Field.create("SCRIPTTABLE2", 20016, FieldType.INT8);
	public static final Field SCRIPTTABLE2LOADBINS = Field.create("SCRIPTTABLE2LOADBINS", 20080, FieldType.FLOAT);
	public static final Field SCRIPTTABLE2RPMBINS = Field.create("SCRIPTTABLE2RPMBINS", 20112, FieldType.FLOAT);
	public static final Field SCRIPTTABLE3 = Field.create("SCRIPTTABLE3", 20144, FieldType.INT8);
	public static final Field SCRIPTTABLE3LOADBINS = Field.create("SCRIPTTABLE3LOADBINS", 20208, FieldType.FLOAT);
	public static final Field SCRIPTTABLE3RPMBINS = Field.create("SCRIPTTABLE3RPMBINS", 20240, FieldType.FLOAT);
	public static final Field SCRIPTTABLE4 = Field.create("SCRIPTTABLE4", 20272, FieldType.INT8);
	public static final Field SCRIPTTABLE4LOADBINS = Field.create("SCRIPTTABLE4LOADBINS", 20336, FieldType.FLOAT);
	public static final Field SCRIPTTABLE4RPMBINS = Field.create("SCRIPTTABLE4RPMBINS", 20368, FieldType.FLOAT);
