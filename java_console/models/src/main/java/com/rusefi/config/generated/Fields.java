...
// this file was generated automatically by rusEFI tool ConfigDefinition.jar based on gen_config.sh integration/rusefi_config.txt Sun Nov 14 14:25:49 UTC 2021

// by class com.rusefi.output.FileJavaFieldsConsumer
import com.rusefi.config.*;

public class Fields {
	public static final int accelerometerSpiDevice_offset = 2720;
	...
	public static final int acSwitchMode_offset = 4524;
	...
	public static final int afrOverrideMode_offset = 2119;
	public static final int afterCrankingIACtaperDuration_offset = 2044;
	...
	public static final int afterstartCoolantBins_offset = 6128;
	public static final int afterstartDecayTime_offset = 6224;
	public static final int afterstartEnrich_offset = 6192;
	public static final int afterstartHoldTime_offset = 6160;
	...
	public static final int alignmentFill_at_1538_offset = 1538;
	public static final int alignmentFill_at_2235_offset = 2235;
	public static final int alignmentFill_at_2261_offset = 2261;
	public static final int alignmentFill_at_4547_offset = 4547;
	public static final int alignmentFill_at_5134_offset = 5134;
	public static final int alternator_antiwindupFreq_offset = 1772;
	public static final int alternator_derivativeFilterLoss_offset = 1768;
	public static final int alternatorControl_dFactor_offset = 1732;
	public static final int alternatorControl_iFactor_offset = 1728;
	public static final int alternatorControl_maxValue_offset = 1742;
	public static final int alternatorControl_minValue_offset = 1740;
	public static final int alternatorControl_offset = 1724;
	public static final int alternatorControl_offset_offset = 1736;
	public static final int alternatorControl_periodMs_offset = 1738;
	public static final int alternatorControl_pFactor_offset = 1724;
	public static final int alternatorControlPin_offset = 665;
	public static final int alternatorControlPinMode_offset = 666;
	public static final int alternatorOffAboveTps_offset = 2036;
	public static final int alternatorPwmFrequency_offset = 2264;
	...
	public static final int applyNonlinearBelowPulse_offset = 2516;
	...
	public static final int auxAnalogInputs1_offset = 2340;
	public static final int auxAnalogInputs2_offset = 2341;
	public static final int auxAnalogInputs3_offset = 2342;
	public static final int auxAnalogInputs4_offset = 2343;
	public static final int auxAnalogInputs5_offset = 2344;
	public static final int auxAnalogInputs6_offset = 2345;
	public static final int auxAnalogInputs7_offset = 2346;
	public static final int auxAnalogInputs8_offset = 2347;
	public static final int auxFastSensor1_adcChannel_offset = 680;
	public static final int auxPid1_dFactor_offset = 2628;
	public static final int auxPid1_iFactor_offset = 2624;
	public static final int auxPid1_maxValue_offset = 2638;
	public static final int auxPid1_minValue_offset = 2636;
	public static final int auxPid1_offset = 2620;
	public static final int auxPid1_offset_offset = 2632;
	public static final int auxPid1_periodMs_offset = 2634;
	public static final int auxPid1_pFactor_offset = 2620;
	public static final int auxPid2_dFactor_offset = 2648;
	public static final int auxPid2_iFactor_offset = 2644;
	public static final int auxPid2_maxValue_offset = 2658;
	public static final int auxPid2_minValue_offset = 2656;
	public static final int auxPid2_offset = 2640;
	public static final int auxPid2_offset_offset = 2652;
	public static final int auxPid2_periodMs_offset = 2654;
	public static final int auxPid2_pFactor_offset = 2640;
	public static final int auxSerialRxPin_offset = 2050;
	public static final int auxSerialSpeed_offset = 2104;
	public static final int auxSerialTxPin_offset = 2048;
	public static final int auxTempSensor1_adcChannel_offset = 2480;
	public static final int auxTempSensor1_alignmentFill_at_29_offset = 2481;
	public static final int auxTempSensor1_bias_resistor_offset = 2476;
	public static final int auxTempSensor1_config_offset = 2452;
	public static final int auxTempSensor1_offset = 2452;
	public static final int auxTempSensor1_resistance_1_offset = 2464;
	public static final int auxTempSensor1_resistance_2_offset = 2468;
	public static final int auxTempSensor1_resistance_3_offset = 2472;
	public static final int auxTempSensor1_tempC_1_offset = 2452;
	public static final int auxTempSensor1_tempC_2_offset = 2456;
	public static final int auxTempSensor1_tempC_3_offset = 2460;
	public static final int auxTempSensor2_adcChannel_offset = 2512;
	public static final int auxTempSensor2_alignmentFill_at_29_offset = 2513;
	public static final int auxTempSensor2_bias_resistor_offset = 2508;
	public static final int auxTempSensor2_config_offset = 2484;
	public static final int auxTempSensor2_offset = 2484;
	public static final int auxTempSensor2_resistance_1_offset = 2496;
	public static final int auxTempSensor2_resistance_2_offset = 2500;
	public static final int auxTempSensor2_resistance_3_offset = 2504;
	public static final int auxTempSensor2_tempC_1_offset = 2484;
	public static final int auxTempSensor2_tempC_2_offset = 2488;
	public static final int auxTempSensor2_tempC_3_offset = 2492;
	public static final int auxValves1_offset = 1824;
	public static final int auxValves2_offset = 1825;
	public static final int BANKS_COUNT = 2;
	public static final int BARO_CORR_SIZE = 4;
	public static final int baroCorrPressureBins_offset = 1552;
	public static final int baroCorrRpmBins_offset = 1568;
	public static final int baroCorrTable_offset = 1584;
	...
	public static final int binarySerialRxPin_offset = 1823;
	public static final int binarySerialTxPin_offset = 1822;
	...
	public static final int boostCutPressure_offset = 2140;
	...
	public static final int boostRpmBins_offset = 6328;
	public static final int boostTableClosedLoop_offset = 6336;
	public static final int boostTableOpenLoop_offset = 6256;
	public static final int boostTpsBins_offset = 6400;
	...
	public static final int brakePedalPin_offset = 2616;
	public static final int brakePedalPinMode_offset = 2619;
	...
	public static final int can2BaudRate_offset = 2118;
	public static final int can2NbcType_offset = 2128;
	public static final int can2ReadEnabled_offset = 2124;
	public static final int can2RxPin_offset = 2133;
	public static final int can2SleepPeriodMs_offset = 712;
	public static final int can2TxPin_offset = 2132;
	public static final int can2WriteEnabled_offset = 2124;
	...
	public static final int canBaudRate_offset = 2116;
	...
	public static final int canVssNbcType_offset = 4148;
	...
	public static final int cj125CsPinMode_offset = 2233;
	...
	public static final int cj125SpiDevice_offset = 2232;
	public static final int cj125ua_offset = 2617;
	public static final int cj125ur_offset = 2618;
	...
	public static final int cltCrankingCorr_offset = 6520;
	public static final int cltCrankingCorrBins_offset = 6488;
	public static final int cltFuelCorr_offset = 10344;
	public static final int cltFuelCorrBins_offset = 10280;
	public static final int cltIdleCorr_offset = 10728;
	public static final int cltIdleCorrBins_offset = 10664;
	public static final int cltIdleRpm_offset = 1968;
	public static final int cltIdleRpmBins_offset = 1904;
	public static final int cltRevLimitRpm_offset = 3340;
	public static final int cltRevLimitRpmBins_offset = 3336;
	public static final int cltTimingBins_offset = 2360;
	public static final int cltTimingExtra_offset = 2392;
	...
	public static final int coastingFuelCutClt_offset = 3162;
	public static final int coastingFuelCutEnabled_offset = 744;
	public static final int coastingFuelCutMap_offset = 3166;
	public static final int coastingFuelCutRpmHigh_offset = 3156;
	public static final int coastingFuelCutRpmLow_offset = 3158;
	public static final int coastingFuelCutTps_offset = 3160;
	public static final int communicationLedPin_offset = 1820;
	...
	public static final int crankingAdvance_offset = 3132;
	public static final int crankingAdvanceBins_offset = 3116;
	public static final int crankingCycleBins_offset = 10632;
	public static final int crankingCycleCoef_offset = 10600;
	public static final int crankingFuelBins_offset = 10568;
	public static final int crankingFuelCoef_offset = 10536;
	public static final int crankingIACposition_offset = 2236;
	public static final int crankingInjectionMode_offset = 424;
	public static final int crankingTimingAngle_offset = 436;
	public static final int crankingTpsBins_offset = 1680;
	public static final int crankingTpsCoef_offset = 1648;
	...
	public static final int cylinderBankSelect10_offset = 4033;
	public static final int cylinderBankSelect11_offset = 4034;
	public static final int cylinderBankSelect12_offset = 4035;
	public static final int cylinderBankSelect1_offset = 4024;
	public static final int cylinderBankSelect2_offset = 4025;
	public static final int cylinderBankSelect3_offset = 4026;
	public static final int cylinderBankSelect4_offset = 4027;
	public static final int cylinderBankSelect5_offset = 4028;
	public static final int cylinderBankSelect6_offset = 4029;
	public static final int cylinderBankSelect7_offset = 4030;
	public static final int cylinderBankSelect8_offset = 4031;
	public static final int cylinderBankSelect9_offset = 4032;
	...
	public static final int debug_mode_e_DBG_LAUNCH = 38;
	...
	public static final int debugMode_offset = 2100;
	...
	public static final int egoValueShift_offset = 2224;
	...
	public static final int enableVerboseCan2Tx_offset = 2124;
	public static final int enableVerboseCanTx_offset = 744;
	public static final int engine_configuration_s_size = 6008;
	...
	public static final int engineLoadAccelLength_offset = 2064;
	...
	public static final int etb_dFactor_offset = 1752;
	...
	public static final int etb_iFactor_offset = 1748;
	public static final int etb_iTermMax_offset = 3966;
	public static final int etb_iTermMin_offset = 3964;
	public static final int etb_maxValue_offset = 1762;
	public static final int etb_minValue_offset = 1760;
	public static final int etb_offset = 1744;
	public static final int etb_offset_offset = 1756;
	public static final int etb_periodMs_offset = 1758;
	public static final int etb_pFactor_offset = 1744;
	public static final int etb_use_two_wires_offset = 76;
	public static final int etbBiasBins_offset = 3896;
	public static final int etbBiasValues_offset = 3928;
	public static final int etbFreq_offset = 2522;
	public static final int etbFunctions1_offset = 1198;
	public static final int etbFunctions2_offset = 1199;
	public static final int etbIdleThrottleRange_offset = 4020;
	...
	public static final int etbMaximumPosition_offset = 3968;
	...
	public static final int etbWastegatePid_dFactor_offset = 2532;
	public static final int etbWastegatePid_iFactor_offset = 2528;
	public static final int etbWastegatePid_maxValue_offset = 2542;
	public static final int etbWastegatePid_minValue_offset = 2540;
	public static final int etbWastegatePid_offset = 2524;
	public static final int etbWastegatePid_offset_offset = 2536;
	public static final int etbWastegatePid_periodMs_offset = 2538;
	public static final int etbWastegatePid_pFactor_offset = 2524;
	public static final int extraInjectionOffset_offset = 432;
	public static final int failedMapFallback_offset = 541;
	public static final int fan1ExtraIdle_offset = 2260;
	public static final int fan2ExtraIdle_offset = 2338;
	public static final int fan2OffTemperature_offset = 2723;
	public static final int fan2OnTemperature_offset = 2722;
	public static final int fan2Pin_offset = 2721;
	public static final int fan2PinMode_offset = 2427;
	...
	public static final int fixedTiming_offset = 2212;
	public static final int FLASH_DATA_VERSION = 10003;
	public static final int flexSensorPin_offset = 3108;
	...
	public static final int fsioFormulas1_offset = 6680;
	public static final int fsioFormulas2_offset = 6880;
	public static final int fsioFormulas3_offset = 7080;
	public static final int fsioFormulas4_offset = 7280;
	public static final int fsioFormulas5_offset = 7480;
	public static final int fsioFormulas6_offset = 7680;
	...
	public static final int fsioTable1_offset = 19304;
	public static final int fsioTable1LoadBins_offset = 19560;
	public static final int fsioTable1RpmBins_offset = 19592;
	public static final int fsioTable2_offset = 19624;
	public static final int fsioTable2LoadBins_offset = 19688;
	public static final int fsioTable2RpmBins_offset = 19720;
	public static final int fsioTable3_offset = 19752;
	public static final int fsioTable3LoadBins_offset = 19816;
	public static final int fsioTable3RpmBins_offset = 19848;
	public static final int fsioTable4_offset = 19880;
	public static final int fsioTable4LoadBins_offset = 19944;
	public static final int fsioTable4RpmBins_offset = 19976;
	...
	public static final int fuelReferencePressure_offset = 2428;
	public static final int fuelTrim10_offset = 4629;
	public static final int fuelTrim11_offset = 4630;
	public static final int fuelTrim12_offset = 4631;
	public static final int fuelTrim1_offset = 4620;
	public static final int fuelTrim2_offset = 4621;
	public static final int fuelTrim3_offset = 4622;
	public static final int fuelTrim4_offset = 4623;
	public static final int fuelTrim5_offset = 4624;
	public static final int fuelTrim6_offset = 4625;
	public static final int fuelTrim7_offset = 4626;
	public static final int fuelTrim8_offset = 4627;
	public static final int fuelTrim9_offset = 4628;
	...
	public static final int gppwm1_alignmentFill_map_offset = 4159;
	public static final int gppwm1_dutyIfError_offset = 4153;
	public static final int gppwm1_loadAxis_offset = 4158;
	public static final int gppwm1_loadBins_offset = 4160;
	public static final int gppwm1_offBelowDuty_offset = 4157;
	public static final int gppwm1_offset = 4152;
	public static final int gppwm1_onAboveDuty_offset = 4156;
	public static final int gppwm1_pin_offset = 4152;
	public static final int gppwm1_pwmFrequency_offset = 4154;
	public static final int gppwm1_rpmBins_offset = 4168;
	public static final int gppwm1_table_offset = 4176;
	public static final int gppwm2_alignmentFill_map_offset = 4247;
	public static final int gppwm2_dutyIfError_offset = 4241;
	public static final int gppwm2_loadAxis_offset = 4246;
	public static final int gppwm2_loadBins_offset = 4248;
	public static final int gppwm2_offBelowDuty_offset = 4245;
	public static final int gppwm2_offset = 4240;
	public static final int gppwm2_onAboveDuty_offset = 4244;
	public static final int gppwm2_pin_offset = 4240;
	public static final int gppwm2_pwmFrequency_offset = 4242;
	public static final int gppwm2_rpmBins_offset = 4256;
	public static final int gppwm2_table_offset = 4264;
	public static final int gppwm3_alignmentFill_map_offset = 4335;
	public static final int gppwm3_dutyIfError_offset = 4329;
	public static final int gppwm3_loadAxis_offset = 4334;
	public static final int gppwm3_loadBins_offset = 4336;
	public static final int gppwm3_offBelowDuty_offset = 4333;
	public static final int gppwm3_offset = 4328;
	public static final int gppwm3_onAboveDuty_offset = 4332;
	public static final int gppwm3_pin_offset = 4328;
	public static final int gppwm3_pwmFrequency_offset = 4330;
	public static final int gppwm3_rpmBins_offset = 4344;
	public static final int gppwm3_table_offset = 4352;
	public static final int gppwm4_alignmentFill_map_offset = 4423;
	public static final int gppwm4_dutyIfError_offset = 4417;
	public static final int gppwm4_loadAxis_offset = 4422;
	public static final int gppwm4_loadBins_offset = 4424;
	public static final int gppwm4_offBelowDuty_offset = 4421;
	public static final int gppwm4_offset = 4416;
	public static final int gppwm4_onAboveDuty_offset = 4420;
	public static final int gppwm4_pin_offset = 4416;
	public static final int gppwm4_pwmFrequency_offset = 4418;
	public static final int gppwm4_rpmBins_offset = 4432;
	public static final int gppwm4_table_offset = 4440;
	...
	public static final int highPressureFuel_alignmentFill_offset = 3297;
	public static final int highPressureFuel_hwChannel_offset = 3296;
	public static final int highPressureFuel_offset = 3296;
	public static final int highPressureFuel_v1_offset = 3300;
	public static final int highPressureFuel_v2_offset = 3308;
	public static final int highPressureFuel_value1_offset = 3304;
	public static final int highPressureFuel_value2_offset = 3312;
	public static final int hip9011CsPin_offset = 753;
	public static final int hip9011CsPinMode_offset = 703;
	public static final int hip9011Gain_offset = 3960;
	...
	public static final int hpfpActivationAngle_offset = 4710;
	public static final int hpfpCam_offset = 4705;
	public static final int hpfpCamLobes_offset = 4704;
	public static final int hpfpCompensation_offset = 5004;
	public static final int hpfpCompensationLoadBins_offset = 5104;
	public static final int hpfpCompensationRpmBins_offset = 5124;
	public static final int hpfpDeadtimeMS_offset = 4758;
	public static final int hpfpDeadtimeVoltsBins_offset = 4750;
	public static final int hpfpLobeProfileAngle_offset = 4734;
	public static final int hpfpLobeProfileQuantityBins_offset = 4718;
	public static final int hpfpMinAngle_offset = 4707;
	public static final int hpfpPeakPos_offset = 4706;
	public static final int hpfpPidI_offset = 4714;
	public static final int hpfpPidP_offset = 4712;
	public static final int hpfpPumpVolume_offset = 4708;
	public static final int hpfpTarget_offset = 4774;
	public static final int hpfpTargetDecay_offset = 4716;
	public static final int hpfpTargetLoadBins_offset = 4974;
	public static final int hpfpTargetRpmBins_offset = 4994;
	public static final int hpfpValvePin_offset = 2138;
	public static final int hpfpValvePinMode_offset = 2139;
	public static final int HW_MAX_ADC_INDEX = 17;
	public static final int IAC_PID_MULT_SIZE = 8;
	public static final int iacByTpsTaper_offset = 2046;
	public static final int iacCoasting_offset = 3232;
	public static final int iacCoastingBins_offset = 3168;
	public static final int iacPidMultLoadBins_offset = 4132;
	public static final int iacPidMultRpmBins_offset = 4140;
	public static final int iacPidMultTable_offset = 4068;
	...
	public static final int iatFuelCorr_offset = 10472;
	public static final int iatFuelCorrBins_offset = 10408;
	...
	public static final int idleAdvance_offset = 6584;
	public static final int idleAdvanceBins_offset = 6552;
	public static final int idleIncrementalPidCic_offset = 744;
	public static final int idleMode_offset = 1472;
	public static final int idlePidActivationTime_offset = 2596;
	public static final int idlePidDeactivationTpsThreshold_offset = 816;
	public static final int idlePidRpmDeadZone_offset = 1902;
	...
	public static final int idleRpmPid2_dFactor_offset = 4056;
	public static final int idleRpmPid2_iFactor_offset = 4052;
	public static final int idleRpmPid2_maxValue_offset = 4066;
	public static final int idleRpmPid2_minValue_offset = 4064;
	public static final int idleRpmPid2_offset = 4048;
	public static final int idleRpmPid2_offset_offset = 4060;
	public static final int idleRpmPid2_periodMs_offset = 4062;
	public static final int idleRpmPid2_pFactor_offset = 4048;
	public static final int idleRpmPid_dFactor_offset = 1804;
	public static final int idleRpmPid_iFactor_offset = 1800;
	public static final int idlerpmpid_iTermMax_offset = 4014;
	public static final int idlerpmpid_iTermMin_offset = 4010;
	public static final int idleRpmPid_maxValue_offset = 1814;
	public static final int idleRpmPid_minValue_offset = 1812;
	public static final int idleRpmPid_offset = 1796;
	public static final int idleRpmPid_offset_offset = 1808;
	public static final int idleRpmPid_periodMs_offset = 1810;
	public static final int idleRpmPid_pFactor_offset = 1796;
	public static final int idleStepperReactionTime_offset = 1508;
	public static final int idleStepperTotalSteps_offset = 1540;
	public static final int idleTimingPid_dFactor_offset = 3984;
	public static final int idleTimingPid_iFactor_offset = 3980;
	public static final int idleTimingPid_maxValue_offset = 3994;
	public static final int idleTimingPid_minValue_offset = 3992;
	public static final int idleTimingPid_offset = 3976;
	public static final int idleTimingPid_offset_offset = 3988;
	public static final int idleTimingPid_periodMs_offset = 3990;
	public static final int idleTimingPid_pFactor_offset = 3976;
	public static final int idleTimingPidDeadZone_offset = 3998;
	public static final int idleVe_offset = 6648;
	public static final int idleVeBins_offset = 6616;
	...
	public static final int ignitionIatCorrLoadBins_offset = 13864;
	public static final int ignitionIatCorrRpmBins_offset = 13928;
	public static final int ignitionIatCorrTable_offset = 12840;
	public static final int ignitionLoadBins_offset = 17320;
	...
	public static final int ignitionRpmBins_offset = 17384;
	public static final int ignitionTable_offset = 16296;
	public static final int ignOverrideMode_offset = 2136;
	...
	public static final int injectionPhase_offset = 13992;
	...
	public static final int injectorCompensationMode_offset = 2426;
	public static final int injectorCorrectionPolynomial1_offset = 2660;
	public static final int injectorCorrectionPolynomial2_offset = 2664;
	public static final int injectorCorrectionPolynomial3_offset = 2668;
	public static final int injectorCorrectionPolynomial4_offset = 2672;
	public static final int injectorCorrectionPolynomial5_offset = 2676;
	public static final int injectorCorrectionPolynomial6_offset = 2680;
	public static final int injectorCorrectionPolynomial7_offset = 2684;
	public static final int injectorCorrectionPolynomial8_offset = 2688;
	...
	public static final int injectorNonlinearMode_offset = 2518;
	public static final int injectorPressureType_offset = 2137;
	public static final int injPhaseLoadBins_offset = 15016;
	public static final int injPhaseRpmBins_offset = 15080;
	...
	public static final int knockBaseNoise_offset = 4531;
	public static final int knockDetectionWindowEnd_offset = 1504;
	public static final int knockDetectionWindowStart_offset = 1500;
	public static final int knockNoise_offset = 1828;
	public static final int knockNoiseRpmBins_offset = 1860;
	public static final int knockRetardAggression_offset = 612;
	public static final int knockRetardMaximum_offset = 614;
	public static final int knockRetardReapplyRate_offset = 613;
	public static final int knockSamplingDuration_offset = 2520;
	public static final int lambdaLoadBins_offset = 18856;
	public static final int lambdaRpmBins_offset = 18920;
	public static final int lambdaTable_offset = 18600;
	...
	public static final int LIS302DLCsPin_offset = 2051;
	public static final int LIS302DLCsPinMode_offset = 2425;
	...
	public static final int lowPressureFuel_alignmentFill_offset = 3317;
	public static final int lowPressureFuel_hwChannel_offset = 3316;
	public static final int lowPressureFuel_offset = 3316;
	public static final int lowPressureFuel_v1_offset = 3320;
	public static final int lowPressureFuel_v2_offset = 3328;
	public static final int lowPressureFuel_value1_offset = 3324;
	public static final int lowPressureFuel_value2_offset = 3332;
	...
	public static final int luaScript_offset = 7880;
	...
	public static final int mafDecoding_offset = 10792;
	public static final int mafDecodingBins_offset = 11816;
	...
	public static final int mainUnusedEnd_offset = 5136;
	...
	public static final int mapAccelTaperBins_offset = 2144;
	public static final int mapAccelTaperMult_offset = 2176;
	public static final int mapAveragingSchedulingAtIndex_offset = 1548;
	public static final int mapErrorDetectionTooHigh_offset = 1788;
	public static final int mapErrorDetectionTooLow_offset = 1784;
	public static final int mapEstimateRpmBins_offset = 15752;
	public static final int mapEstimateTable_offset = 15208;
	public static final int mapEstimateTpsBins_offset = 15720;
	public static final int mapHighValueVoltage_offset = 2220;
	public static final int mapLowValueVoltage_offset = 2216;
	...
	public static final int maxAcClt_offset = 1719;
	public static final int maxAcRpm_offset = 1716;
	public static final int maxAcTps_offset = 1718;
	public static final int maxIdleVss_offset = 445;
	public static final int mc33816_cs_offset = 3115;
	public static final int mc33816_driven_offset = 2615;
	public static final int mc33816_flag0_offset = 1782;
	public static final int mc33816_rstb_offset = 2614;
	public static final int mc33816spiDevice_offset = 4009;
	public static final int mc33972_cs_offset = 678;
	public static final int mc33972_csPinMode_offset = 679;
	public static final int mc33972spiDevice_offset = 4016;
	public static final int mc33_hvolt_offset = 760;
	public static final int mc33_i_boost_offset = 4504;
	public static final int mc33_i_hold_offset = 4508;
	public static final int mc33_i_peak_offset = 4506;
	public static final int mc33_t_bypass_offset = 4516;
	public static final int mc33_t_hold_off_offset = 4518;
	public static final int mc33_t_hold_tot_offset = 4520;
	public static final int mc33_t_max_boost_offset = 4510;
	public static final int mc33_t_peak_off_offset = 4512;
	public static final int mc33_t_peak_tot_offset = 4514;
	...
	public static final int multisparkDwell_offset = 1794;
	...
	public static final int multisparkSparkDuration_offset = 1792;
	public static final int NARROW_BAND_WIDE_BAND_CONVERSION_SIZE = 8;
	public static final int narrowToWideOxygen_offset = 2304;
	public static final int narrowToWideOxygenBins_offset = 2272;
	public static final int noAccelAfterHardLimitPeriodSecs_offset = 1544;
	public static final int o2heaterPin_offset = 742;
	public static final int o2heaterPinModeTodO_offset = 743;
	public static final int oilPressure_alignmentFill_offset = 2701;
	public static final int oilPressure_hwChannel_offset = 2700;
	public static final int oilPressure_offset = 2700;
	public static final int oilPressure_v1_offset = 2704;
	public static final int oilPressure_v2_offset = 2712;
	public static final int oilPressure_value1_offset = 2708;
	public static final int oilPressure_value2_offset = 2716;
	...
	public static final int pedalToTpsPedalBins_offset = 6472;
	public static final int pedalToTpsRpmBins_offset = 6480;
	public static final int pedalToTpsTable_offset = 6408;
	public static final int persistent_config_s_size = 20008;
	...
	public static final int pidExtraForLowRpm_offset = 3164;
	...
	public static final int postCrankingDurationSec_offset = 2448;
	public static final int postCrankingFactor_offset = 2444;
	...
	public static final int runningLedPin_offset = 1821;
	...
	public static final int scriptCurve1_offset = 2788;
	public static final int scriptCurve1Bins_offset = 2724;
	public static final int scriptCurve2_offset = 2916;
	public static final int scriptCurve2Bins_offset = 2852;
	public static final int scriptCurve3_offset = 3012;
	public static final int scriptCurve3Bins_offset = 2980;
	public static final int scriptCurve4_offset = 3076;
	public static final int scriptCurve4Bins_offset = 3044;
	public static final int scriptCurve5_offset = 3476;
	public static final int scriptCurve5Bins_offset = 3444;
	public static final int scriptCurve6_offset = 3540;
	public static final int scriptCurve6Bins_offset = 3508;
	public static final int scriptCurveName1_offset = 3348;
	public static final int scriptCurveName2_offset = 3364;
	public static final int scriptCurveName3_offset = 3380;
	public static final int scriptCurveName4_offset = 3396;
	public static final int scriptCurveName5_offset = 3412;
	public static final int scriptCurveName6_offset = 3428;
	...
	public static final int scriptTableName1_offset = 3572;
	public static final int scriptTableName2_offset = 3588;
	public static final int scriptTableName3_offset = 3604;
	public static final int scriptTableName4_offset = 3620;
	public static final int sdCardCsPin_offset = 707;
	public static final int sdCardCsPinMode_offset = 2234;
	public static final int sdCardPeriodMs_offset = 804;
	public static final int sdCardSpiDevice_offset = 2600;
	...
	public static final int servoOutputPins1_offset = 3148;
	public static final int servoOutputPins2_offset = 3149;
	public static final int servoOutputPins3_offset = 3150;
	public static final int servoOutputPins4_offset = 3151;
	public static final int servoOutputPins5_offset = 3152;
	public static final int servoOutputPins6_offset = 3153;
	public static final int servoOutputPins7_offset = 3154;
	public static final int servoOutputPins8_offset = 3155;
	public static final int showHumanReadableWarning_offset = 976;
	public static final int showSdCardWarning_offset = 76;
	public static final int silentTriggerError_offset = 1464;
	public static final int slowAdcAlpha_offset = 2096;
	...
	public static final int spi1MisoMode_offset = 2606;
	public static final int spi1misoPin_offset = 929;
	public static final int spi1MosiMode_offset = 2605;
	public static final int spi1mosiPin_offset = 928;
	public static final int spi1SckMode_offset = 2604;
	public static final int spi1sckPin_offset = 930;
	public static final int spi2MisoMode_offset = 2609;
	public static final int spi2misoPin_offset = 932;
	public static final int spi2MosiMode_offset = 2608;
	public static final int spi2mosiPin_offset = 931;
	public static final int spi2SckMode_offset = 2607;
	public static final int spi2sckPin_offset = 933;
	public static final int spi3MisoMode_offset = 2612;
	public static final int spi3misoPin_offset = 935;
	public static final int spi3MosiMode_offset = 2611;
	public static final int spi3mosiPin_offset = 934;
	public static final int spi3SckMode_offset = 2610;
	...
	public static final int starterControlPin_offset = 1780;
	public static final int starterControlPinMode_offset = 2134;
	public static final int starterRelayDisablePin_offset = 808;
	public static final int starterRelayDisablePinMode_offset = 809;
	public static final int startOfCrankingPrimingPulse_offset = 2040;
	public static final int startStopButtonMode_offset = 1781;
	public static final int startStopButtonPin_offset = 811;
	public static final int startUpFuelPumpDuration_offset = 1900;
	...
	public static final int stepperDcInvertedPins_offset = 2124;
	...
	public static final int stepperDirectionPinMode_offset = 3110;
	public static final int stepperEnablePin_offset = 3112;
	public static final int stepperEnablePinMode_offset = 2613;
	public static final int stepperForceParkingEveryRestart_offset = 744;
	public static final int stepperMaxDutyCycle_offset = 2546;
	public static final int stepperMinDutyCycle_offset = 2545;
	public static final int stepperNumMicroSteps_offset = 2544;
	...
	public static final int stoichRatioPrimary_offset = 4013;
	public static final int stoichRatioSecondary_offset = 4017;
	public static final int tachOutputPin_offset = 704;
	public static final int tachOutputPinMode_offset = 705;
	public static final int tachPulseDuractionMs_offset = 1712;
	public static final int tachPulseDurationAsDutyCycle_offset = 1464;
	public static final int tachPulsePerRev_offset = 1783;
	public static final int targetVBatt_offset = 2032;
	public static final int tChargeAirCoefMax_offset = 3876;
	public static final int tChargeAirCoefMin_offset = 3872;
	public static final int tChargeAirDecrLimit_offset = 3888;
	public static final int tChargeAirFlowMax_offset = 3880;
	public static final int tChargeAirIncrLimit_offset = 3884;
	public static final int tChargeMaxRpmMaxTps_offset = 2252;
	public static final int tChargeMaxRpmMinTps_offset = 2248;
	public static final int tChargeMinRpmMaxTps_offset = 2244;
	public static final int tChargeMinRpmMinTps_offset = 2240;
	...
	public static final int tChargeMode_offset = 3892;
	...
	public static final int tcu_solenoid_mode1_offset = 4525;
	public static final int tcu_solenoid_mode2_offset = 4526;
	public static final int tcu_solenoid_mode3_offset = 4527;
	public static final int tcu_solenoid_mode4_offset = 4528;
	public static final int tcu_solenoid_mode5_offset = 4529;
	public static final int tcu_solenoid_mode6_offset = 4530;
	public static final int tcuDownshiftButtonPin_offset = 1827;
	public static final int tcuDownshiftButtonPinMode_offset = 4523;
	public static final int tcuEnabled_offset = 976;
	public static final int tcuSolenoidTable_offset = 15144;
	public static final int tcuUpshiftButtonPin_offset = 1826;
	public static final int tcuUpshiftButtonPinMode_offset = 4522;
	public static final int test557pin_offset = 3109;
	...
	public static final int throttlePedalSecondaryUpVoltage_offset = 2108;
	public static final int throttlePedalSecondaryWOTVoltage_offset = 2112;
	public static final int throttlePedalUpPin_offset = 583;
	public static final int throttlePedalUpPinMode_offset = 710;
	public static final int throttlePedalUpVoltage_offset = 1892;
	public static final int throttlePedalWOTVoltage_offset = 1896;
	public static final int timing_mode_e_TM_DYNAMIC = 0;
	public static final int timing_mode_e_TM_FIXED = 1;
	public static final int timing_offset_cylinder10_offset = 2584;
	public static final int timing_offset_cylinder11_offset = 2588;
	public static final int timing_offset_cylinder12_offset = 2592;
	public static final int timing_offset_cylinder1_offset = 2548;
	public static final int timing_offset_cylinder2_offset = 2552;
	public static final int timing_offset_cylinder3_offset = 2556;
	public static final int timing_offset_cylinder4_offset = 2560;
	public static final int timing_offset_cylinder5_offset = 2564;
	public static final int timing_offset_cylinder6_offset = 2568;
	public static final int timing_offset_cylinder7_offset = 2572;
	public static final int timing_offset_cylinder8_offset = 2576;
	public static final int timing_offset_cylinder9_offset = 2580;
	public static final int timingAdditive_offset = 10080;
	public static final int timingMode_offset = 448;
	public static final int timingMultiplier_offset = 9880;
	public static final int tle6240_cs_offset = 581;
	public static final int tle6240_csPinMode_offset = 582;
	public static final int tle6240spiDevice_offset = 4012;
	public static final int tle8888_cs_offset = 3113;
	public static final int tle8888_csPinMode_offset = 3114;
	...
	public static final int tle8888mode_offset = 2424;
	public static final int tle8888spiDevice_offset = 4008;
	...
	public static final int TOTAL_CONFIG_SIZE = 20008;
	...
	public static final int tps2Max_offset = 1778;
	public static final int tps2Min_offset = 1776;
	...
	public static final int tpsAccelEnrichmentThreshold_offset = 2056;
	public static final int tpsAccelFractionDivisor_offset = 4004;
	public static final int tpsAccelFractionPeriod_offset = 4002;
	public static final int tpsAccelLength_offset = 2052;
	public static final int tpsDecelEnleanmentMultiplier_offset = 2092;
	public static final int tpsDecelEnleanmentThreshold_offset = 2088;
	...
	public static final int tpsTpsAccelFromRpmBins_offset = 19240;
	public static final int tpsTpsAccelTable_offset = 18984;
	public static final int tpsTpsAccelToRpmBins_offset = 19272;
	public static final int trailingCoilPins10_offset = 2357;
	public static final int trailingCoilPins11_offset = 2358;
	public static final int trailingCoilPins12_offset = 2359;
	public static final int trailingCoilPins1_offset = 2348;
	public static final int trailingCoilPins2_offset = 2349;
	public static final int trailingCoilPins3_offset = 2350;
	public static final int trailingCoilPins4_offset = 2351;
	public static final int trailingCoilPins5_offset = 2352;
	public static final int trailingCoilPins6_offset = 2353;
	public static final int trailingCoilPins7_offset = 2354;
	public static final int trailingCoilPins8_offset = 2355;
	public static final int trailingCoilPins9_offset = 2356;
	...
	public static final int triggerCompCenterVolt_offset = 4044;
	public static final int triggerCompHystMax_offset = 4046;
	public static final int triggerCompHystMin_offset = 4045;
	public static final int triggerCompSensorSatRpm_offset = 4047;
	public static final int triggerErrorPin_offset = 828;
	public static final int triggerErrorPinMode_offset = 829;
	public static final int triggerGapOverrideFrom10_offset = 4584;
	public static final int triggerGapOverrideFrom11_offset = 4588;
	public static final int triggerGapOverrideFrom12_offset = 4592;
	public static final int triggerGapOverrideFrom13_offset = 4596;
	public static final int triggerGapOverrideFrom14_offset = 4600;
	public static final int triggerGapOverrideFrom15_offset = 4604;
	public static final int triggerGapOverrideFrom16_offset = 4608;
	public static final int triggerGapOverrideFrom17_offset = 4612;
	public static final int triggerGapOverrideFrom18_offset = 4616;
	public static final int triggerGapOverrideFrom1_offset = 4548;
	public static final int triggerGapOverrideFrom2_offset = 4552;
	public static final int triggerGapOverrideFrom3_offset = 4556;
	public static final int triggerGapOverrideFrom4_offset = 4560;
	public static final int triggerGapOverrideFrom5_offset = 4564;
	public static final int triggerGapOverrideFrom6_offset = 4568;
	public static final int triggerGapOverrideFrom7_offset = 4572;
	public static final int triggerGapOverrideFrom8_offset = 4576;
	public static final int triggerGapOverrideFrom9_offset = 4580;
	public static final int triggerGapOverrideTo10_offset = 4668;
	public static final int triggerGapOverrideTo11_offset = 4672;
	public static final int triggerGapOverrideTo12_offset = 4676;
	public static final int triggerGapOverrideTo13_offset = 4680;
	public static final int triggerGapOverrideTo14_offset = 4684;
	public static final int triggerGapOverrideTo15_offset = 4688;
	public static final int triggerGapOverrideTo16_offset = 4692;
	public static final int triggerGapOverrideTo17_offset = 4696;
	public static final int triggerGapOverrideTo18_offset = 4700;
	public static final int triggerGapOverrideTo1_offset = 4632;
	public static final int triggerGapOverrideTo2_offset = 4636;
	public static final int triggerGapOverrideTo3_offset = 4640;
	public static final int triggerGapOverrideTo4_offset = 4644;
	public static final int triggerGapOverrideTo5_offset = 4648;
	public static final int triggerGapOverrideTo6_offset = 4652;
	public static final int triggerGapOverrideTo7_offset = 4656;
	public static final int triggerGapOverrideTo8_offset = 4660;
	public static final int triggerGapOverrideTo9_offset = 4664;
	public static final int triggerInputDebugPins1_offset = 1764;
	public static final int triggerInputDebugPins2_offset = 1765;
	public static final int triggerInputDebugPins3_offset = 1766;
	...
	public static final String TS_SIGNATURE = "rusEFI 2021.11.14.all.2234532646";
	public static final char TS_SINGLE_WRITE_COMMAND = 'W';
	public static final char TS_TEST_COMMAND = 't';
	public static final int tunerStudioSerialSpeed_offset = 728;
	public static final int turboSpeedSensorInputPin_offset = 1767;
	...
	public static final int uartConsoleSerialSpeed_offset = 2084;
	public static final int unused1059_offset = 3969;
	public static final int unused1127_offset = 2124;
	public static final int unused1128_offset = 2124;
	public static final int unused1129_offset = 2124;
	public static final int unused1130_offset = 2124;
	public static final int unused11_offset = 764;
	public static final int unused1366_offset = 2692;
	...
	public static final int unused2260_offset = 2268;
	public static final int unused2432_offset = 2440;
	public static final int unused244_2_offset = 2432;
	public static final int unused244_3_offset = 2436;
	public static final int unused2508_offset = 2519;
	public static final int unused2536_offset = 2547;
	public static final int unused3103_offset = 3111;
	public static final int unused3328_offset = 3636;
	public static final int unused3942_offset = 4000;
	public static final int unused3988_offset = 3996;
	public static final int unused4028_offset = 4036;
	public static final int unused552_offset = 552;
	public static final int unused615_offset = 615;
	public static final int unused616_offset = 616;
	public static final int unused6312_offset = 6320;
	...
	public static final int unusedAnotherOneOfThose_offset = 2208;
	...
	public static final int unusedBit_510_10_offset = 2124;
	public static final int unusedBit_510_11_offset = 2124;
	public static final int unusedBit_510_12_offset = 2124;
	public static final int unusedBit_510_13_offset = 2124;
	public static final int unusedBit_510_14_offset = 2124;
	public static final int unusedBit_510_15_offset = 2124;
	public static final int unusedBit_510_16_offset = 2124;
	public static final int unusedBit_510_17_offset = 2124;
	public static final int unusedBit_510_18_offset = 2124;
	public static final int unusedBit_510_19_offset = 2124;
	public static final int unusedBit_510_20_offset = 2124;
	public static final int unusedBit_510_21_offset = 2124;
	public static final int unusedBit_510_22_offset = 2124;
	public static final int unusedBit_510_23_offset = 2124;
	public static final int unusedBit_510_24_offset = 2124;
	public static final int unusedBit_510_25_offset = 2124;
	public static final int unusedBit_510_26_offset = 2124;
	public static final int unusedBit_510_27_offset = 2124;
	public static final int unusedBit_510_28_offset = 2124;
	public static final int unusedBit_510_29_offset = 2124;
	public static final int unusedBit_510_30_offset = 2124;
	public static final int unusedBit_510_31_offset = 2124;
	public static final int unusedBit_510_8_offset = 2124;
	public static final int unusedBit_510_9_offset = 2124;
	...
	public static final int unusedDigital_offset = 952;
	public static final int unusedEL1_offset = 2068;
	public static final int unusedEL2_offset = 2072;
	public static final int unusedEL3_offset = 2076;
	public static final int unusedEL4_offset = 2080;
	public static final int unusedExHpfp_offset = 724;
	public static final int unusedFiller_4703_offset = 4711;
	public static final int unusedFsioInputs_offset = 1522;
	public static final int unusedLuaWasHere_offset = 16040;
	public static final int unusedOldBiquad_offset = 2339;
	...
	public static final int unusedSpiPadding4_offset = 2601;
	public static final int unusedSpiPadding8_offset = 4018;
	public static final int unusedVvtOffsetWasHere_offset = 2060;
	...
	public static final int veLoadBins_offset = 18472;
	public static final int veOverrideMode_offset = 2117;
	public static final int verboseCan2BaseAddress_offset = 2120;
	...
	public static final int veRpmBins_offset = 18536;
	public static final int veTable_offset = 17448;
	...
	public static final int vssFilterReciprocal_offset = 15204;
	...
	public static final int vvtMode1_offset = 2336;
	public static final int vvtMode2_offset = 2337;
	public static final int vvtModePadding_offset = 2338;
	...
	public static final int vvtOutputFrequency1_offset = 2256;
	public static final int vvtOutputFrequency2_offset = 2258;
	public static final int vvtPins1_offset = 2228;
	public static final int vvtPins2_offset = 2229;
	public static final int vvtPins3_offset = 2230;
	public static final int vvtPins4_offset = 2231;
	public static final int vvtTable1_offset = 15784;
	public static final int vvtTable1LoadBins_offset = 15848;
	public static final int vvtTable1RpmBins_offset = 15880;
	public static final int vvtTable2_offset = 15912;
	public static final int vvtTable2LoadBins_offset = 15976;
	public static final int vvtTable2RpmBins_offset = 16008;
	public static final int warning_message_offset = 6008;
	public static final int warningLedPin_offset = 2049;
	...
	public static final int wastegatePositionSensor_offset = 2135;
	public static final int wboHeaterPin_offset = 673;
	public static final int wwaeBeta_offset = 1816;
	public static final int wwaeTau_offset = 1720;
	...
	public static final Field INJECTOR_BATTLAGCORRBINS = Field.create("INJECTOR_BATTLAGCORRBINS", 12, FieldType.FLOAT);
	public static final Field INJECTOR_BATTLAGCORR = Field.create("INJECTOR_BATTLAGCORR", 44, FieldType.FLOAT);
	...
	public static final Field CRANKING_ALIGNMENTFILL_AT_6 = Field.create("CRANKING_ALIGNMENTFILL_AT_6", 94, FieldType.INT8);
	...
	public static final Field MAP_SAMPLINGANGLEBINS = Field.create("MAP_SAMPLINGANGLEBINS", 108, FieldType.FLOAT);
	public static final Field MAP_SAMPLINGANGLE = Field.create("MAP_SAMPLINGANGLE", 140, FieldType.FLOAT);
	public static final Field MAP_SAMPLINGWINDOWBINS = Field.create("MAP_SAMPLINGWINDOWBINS", 172, FieldType.FLOAT);
	public static final Field MAP_SAMPLINGWINDOW = Field.create("MAP_SAMPLINGWINDOW", 204, FieldType.FLOAT);
	...
	public static final Field CLT_ALIGNMENTFILL_AT_29 = Field.create("CLT_ALIGNMENTFILL_AT_29", 281, FieldType.INT8);
	...
	public static final Field IAT_ALIGNMENTFILL_AT_29 = Field.create("IAT_ALIGNMENTFILL_AT_29", 313, FieldType.INT8);
	...
	public static final Field SPARKDWELLRPMBINS = Field.create("SPARKDWELLRPMBINS", 332, FieldType.FLOAT);
	public static final Field SPARKDWELLVALUES = Field.create("SPARKDWELLVALUES", 364, FieldType.FLOAT);
	...
	public static final Field CAMINPUTSPADDING = Field.create("CAMINPUTSPADDING", 560, FieldType.INT8);
	public static final Field AFR_HWCHANNEL = Field.create("AFR_HWCHANNEL", 560, FieldType.INT8, adc_channel_e);
	public static final Field AFR_ALIGNMENTFILL_AFR = Field.create("AFR_ALIGNMENTFILL_AFR", 561, FieldType.INT8);
	...
	public static final Field KNOCKRETARDAGGRESSION = Field.create("KNOCKRETARDAGGRESSION", 612, FieldType.INT8);
	public static final Field KNOCKRETARDREAPPLYRATE = Field.create("KNOCKRETARDREAPPLYRATE", 613, FieldType.INT8);
	public static final Field KNOCKRETARDMAXIMUM = Field.create("KNOCKRETARDMAXIMUM", 614, FieldType.INT8);
	public static final Field UNUSED615 = Field.create("UNUSED615", 615, FieldType.INT8);
	...
	public static final Field FUELLEVELVALUES = Field.create("FUELLEVELVALUES", 684, FieldType.INT8);
	...
	public static final Field DWELLVOLTAGECORRVALUES = Field.create("DWELLVOLTAGECORRVALUES", 786, FieldType.INT8);
	public static final Field UNUSEDOUTPUTWHEREHERE = Field.create("UNUSEDOUTPUTWHEREHERE", 794, FieldType.INT8);
	...
	public static final Field UNUSEDOUTPUTFREQWHEREHERE = Field.create("UNUSEDOUTPUTFREQWHEREHERE", 832, FieldType.INT16);
	...
	public static final Field UNUSEDDIGITAL = Field.create("UNUSEDDIGITAL", 952, FieldType.INT8);
	...
	public static final Field FUELLEVELBINS = Field.create("FUELLEVELBINS", 1204, FieldType.INT16);
	...
	public static final Field VVTOFFSETSPADDING = Field.create("VVTOFFSETSPADDING", 1244, FieldType.FLOAT);
	public static final Field VRTHRESHOLD1_PIN = Field.create("VRTHRESHOLD1_PIN", 1244, FieldType.INT8, brain_pin_e);
	public static final Field VRTHRESHOLD1_PAD = Field.create("VRTHRESHOLD1_PAD", 1245, FieldType.INT8);
	public static final Field VRTHRESHOLD1_RPMBINS = Field.create("VRTHRESHOLD1_RPMBINS", 1248, FieldType.INT8);
	public static final Field VRTHRESHOLD1_VALUES = Field.create("VRTHRESHOLD1_VALUES", 1254, FieldType.INT8);
	public static final Field VRTHRESHOLD2_PIN = Field.create("VRTHRESHOLD2_PIN", 1260, FieldType.INT8, brain_pin_e);
	public static final Field VRTHRESHOLD2_PAD = Field.create("VRTHRESHOLD2_PAD", 1261, FieldType.INT8);
	public static final Field VRTHRESHOLD2_RPMBINS = Field.create("VRTHRESHOLD2_RPMBINS", 1264, FieldType.INT8);
	public static final Field VRTHRESHOLD2_VALUES = Field.create("VRTHRESHOLD2_VALUES", 1270, FieldType.INT8);
	...
	public static final Field UNUSEDATOLDBOARDCONFIGURATIONEND = Field.create("UNUSEDATOLDBOARDCONFIGURATIONEND", 1340, FieldType.INT);
	...
	public static final Field CAMINPUTSDEBUGPADDING = Field.create("CAMINPUTSDEBUGPADDING", 1496, FieldType.INT8);
	...
	public static final Field UNUSEDFSIOINPUTS = Field.create("UNUSEDFSIOINPUTS", 1522, FieldType.INT8);
	public static final Field ALIGNMENTFILL_AT_1538 = Field.create("ALIGNMENTFILL_AT_1538", 1538, FieldType.INT8);
	public static final Field IDLESTEPPERTOTALSTEPS = Field.create("IDLESTEPPERTOTALSTEPS", 1540, FieldType.INT);
	public static final Field NOACCELAFTERHARDLIMITPERIODSECS = Field.create("NOACCELAFTERHARDLIMITPERIODSECS", 1544, FieldType.FLOAT);
	public static final Field MAPAVERAGINGSCHEDULINGATINDEX = Field.create("MAPAVERAGINGSCHEDULINGATINDEX", 1548, FieldType.INT);
	public static final Field BAROCORRPRESSUREBINS = Field.create("BAROCORRPRESSUREBINS", 1552, FieldType.FLOAT);
	public static final Field BAROCORRRPMBINS = Field.create("BAROCORRRPMBINS", 1568, FieldType.FLOAT);
	public static final Field BAROCORRTABLE = Field.create("BAROCORRTABLE", 1584, FieldType.FLOAT);
	public static final Field CRANKINGTPSCOEF = Field.create("CRANKINGTPSCOEF", 1648, FieldType.FLOAT);
	public static final Field CRANKINGTPSBINS = Field.create("CRANKINGTPSBINS", 1680, FieldType.FLOAT);
	public static final Field TACHPULSEDURACTIONMS = Field.create("TACHPULSEDURACTIONMS", 1712, FieldType.FLOAT);
	public static final Field MAXACRPM = Field.create("MAXACRPM", 1716, FieldType.INT16);
	public static final Field MAXACTPS = Field.create("MAXACTPS", 1718, FieldType.INT8);
	public static final Field MAXACCLT = Field.create("MAXACCLT", 1719, FieldType.INT8);
	public static final Field WWAETAU = Field.create("WWAETAU", 1720, FieldType.FLOAT);
	public static final Field ALTERNATORCONTROL_PFACTOR = Field.create("ALTERNATORCONTROL_PFACTOR", 1724, FieldType.FLOAT);
	public static final Field ALTERNATORCONTROL_IFACTOR = Field.create("ALTERNATORCONTROL_IFACTOR", 1728, FieldType.FLOAT);
	public static final Field ALTERNATORCONTROL_DFACTOR = Field.create("ALTERNATORCONTROL_DFACTOR", 1732, FieldType.FLOAT);
	public static final Field ALTERNATORCONTROL_OFFSET = Field.create("ALTERNATORCONTROL_OFFSET", 1736, FieldType.INT16);
	public static final Field ALTERNATORCONTROL_PERIODMS = Field.create("ALTERNATORCONTROL_PERIODMS", 1738, FieldType.INT16);
	public static final Field ALTERNATORCONTROL_MINVALUE = Field.create("ALTERNATORCONTROL_MINVALUE", 1740, FieldType.INT16);
	public static final Field ALTERNATORCONTROL_MAXVALUE = Field.create("ALTERNATORCONTROL_MAXVALUE", 1742, FieldType.INT16);
	public static final Field ETB_PFACTOR = Field.create("ETB_PFACTOR", 1744, FieldType.FLOAT);
	public static final Field ETB_IFACTOR = Field.create("ETB_IFACTOR", 1748, FieldType.FLOAT);
	public static final Field ETB_DFACTOR = Field.create("ETB_DFACTOR", 1752, FieldType.FLOAT);
	public static final Field ETB_OFFSET = Field.create("ETB_OFFSET", 1756, FieldType.INT16);
	public static final Field ETB_PERIODMS = Field.create("ETB_PERIODMS", 1758, FieldType.INT16);
	public static final Field ETB_MINVALUE = Field.create("ETB_MINVALUE", 1760, FieldType.INT16);
	public static final Field ETB_MAXVALUE = Field.create("ETB_MAXVALUE", 1762, FieldType.INT16);
	public static final Field TRIGGERINPUTDEBUGPINS1 = Field.create("TRIGGERINPUTDEBUGPINS1", 1764, FieldType.INT8, brain_pin_e);
	public static final Field TRIGGERINPUTDEBUGPINS2 = Field.create("TRIGGERINPUTDEBUGPINS2", 1765, FieldType.INT8, brain_pin_e);
	public static final Field TRIGGERINPUTDEBUGPINS3 = Field.create("TRIGGERINPUTDEBUGPINS3", 1766, FieldType.INT8, brain_pin_e);
	public static final Field TURBOSPEEDSENSORINPUTPIN = Field.create("TURBOSPEEDSENSORINPUTPIN", 1767, FieldType.INT8, brain_input_pin_e);
	public static final Field ALTERNATOR_DERIVATIVEFILTERLOSS = Field.create("ALTERNATOR_DERIVATIVEFILTERLOSS", 1768, FieldType.FLOAT);
	public static final Field ALTERNATOR_ANTIWINDUPFREQ = Field.create("ALTERNATOR_ANTIWINDUPFREQ", 1772, FieldType.FLOAT);
	public static final Field TPS2MIN = Field.create("TPS2MIN", 1776, FieldType.INT16);
	public static final Field TPS2MAX = Field.create("TPS2MAX", 1778, FieldType.INT16);
	public static final Field STARTERCONTROLPIN = Field.create("STARTERCONTROLPIN", 1780, FieldType.INT8, output_pin_e);
	public static final Field STARTSTOPBUTTONMODE = Field.create("STARTSTOPBUTTONMODE", 1781, FieldType.INT8, pin_input_mode_e);
	public static final Field MC33816_FLAG0 = Field.create("MC33816_FLAG0", 1782, FieldType.INT8, brain_pin_e);
	public static final Field TACHPULSEPERREV = Field.create("TACHPULSEPERREV", 1783, FieldType.INT8);
	public static final Field MAPERRORDETECTIONTOOLOW = Field.create("MAPERRORDETECTIONTOOLOW", 1784, FieldType.FLOAT);
	public static final Field MAPERRORDETECTIONTOOHIGH = Field.create("MAPERRORDETECTIONTOOHIGH", 1788, FieldType.FLOAT);
	public static final Field MULTISPARKSPARKDURATION = Field.create("MULTISPARKSPARKDURATION", 1792, FieldType.INT16);
	public static final Field MULTISPARKDWELL = Field.create("MULTISPARKDWELL", 1794, FieldType.INT16);
	public static final Field IDLERPMPID_PFACTOR = Field.create("IDLERPMPID_PFACTOR", 1796, FieldType.FLOAT);
	public static final Field IDLERPMPID_IFACTOR = Field.create("IDLERPMPID_IFACTOR", 1800, FieldType.FLOAT);
	public static final Field IDLERPMPID_DFACTOR = Field.create("IDLERPMPID_DFACTOR", 1804, FieldType.FLOAT);
	public static final Field IDLERPMPID_OFFSET = Field.create("IDLERPMPID_OFFSET", 1808, FieldType.INT16);
	public static final Field IDLERPMPID_PERIODMS = Field.create("IDLERPMPID_PERIODMS", 1810, FieldType.INT16);
	public static final Field IDLERPMPID_MINVALUE = Field.create("IDLERPMPID_MINVALUE", 1812, FieldType.INT16);
	public static final Field IDLERPMPID_MAXVALUE = Field.create("IDLERPMPID_MAXVALUE", 1814, FieldType.INT16);
	public static final Field WWAEBETA = Field.create("WWAEBETA", 1816, FieldType.FLOAT);
	public static final Field COMMUNICATIONLEDPIN = Field.create("COMMUNICATIONLEDPIN", 1820, FieldType.INT8, brain_pin_e);
	public static final Field RUNNINGLEDPIN = Field.create("RUNNINGLEDPIN", 1821, FieldType.INT8, brain_pin_e);
	public static final Field BINARYSERIALTXPIN = Field.create("BINARYSERIALTXPIN", 1822, FieldType.INT8, brain_pin_e);
	public static final Field BINARYSERIALRXPIN = Field.create("BINARYSERIALRXPIN", 1823, FieldType.INT8, brain_pin_e);
	public static final Field AUXVALVES1 = Field.create("AUXVALVES1", 1824, FieldType.INT8, brain_pin_e);
	public static final Field AUXVALVES2 = Field.create("AUXVALVES2", 1825, FieldType.INT8, brain_pin_e);
	public static final Field TCUUPSHIFTBUTTONPIN = Field.create("TCUUPSHIFTBUTTONPIN", 1826, FieldType.INT8, switch_input_pin_e);
	public static final Field TCUDOWNSHIFTBUTTONPIN = Field.create("TCUDOWNSHIFTBUTTONPIN", 1827, FieldType.INT8, switch_input_pin_e);
	public static final Field KNOCKNOISE = Field.create("KNOCKNOISE", 1828, FieldType.FLOAT);
	public static final Field KNOCKNOISERPMBINS = Field.create("KNOCKNOISERPMBINS", 1860, FieldType.FLOAT);
	public static final Field THROTTLEPEDALUPVOLTAGE = Field.create("THROTTLEPEDALUPVOLTAGE", 1892, FieldType.FLOAT);
	public static final Field THROTTLEPEDALWOTVOLTAGE = Field.create("THROTTLEPEDALWOTVOLTAGE", 1896, FieldType.FLOAT);
	public static final Field STARTUPFUELPUMPDURATION = Field.create("STARTUPFUELPUMPDURATION", 1900, FieldType.INT16);
	public static final Field IDLEPIDRPMDEADZONE = Field.create("IDLEPIDRPMDEADZONE", 1902, FieldType.INT16);
	public static final Field CLTIDLERPMBINS = Field.create("CLTIDLERPMBINS", 1904, FieldType.FLOAT);
	public static final Field CLTIDLERPM = Field.create("CLTIDLERPM", 1968, FieldType.FLOAT);
	public static final Field TARGETVBATT = Field.create("TARGETVBATT", 2032, FieldType.FLOAT);
	public static final Field ALTERNATOROFFABOVETPS = Field.create("ALTERNATOROFFABOVETPS", 2036, FieldType.FLOAT);
	public static final Field STARTOFCRANKINGPRIMINGPULSE = Field.create("STARTOFCRANKINGPRIMINGPULSE", 2040, FieldType.FLOAT);
	public static final Field AFTERCRANKINGIACTAPERDURATION = Field.create("AFTERCRANKINGIACTAPERDURATION", 2044, FieldType.INT16);
	public static final Field IACBYTPSTAPER = Field.create("IACBYTPSTAPER", 2046, FieldType.INT16);
	public static final Field AUXSERIALTXPIN = Field.create("AUXSERIALTXPIN", 2048, FieldType.INT8, brain_pin_e);
	public static final Field WARNINGLEDPIN = Field.create("WARNINGLEDPIN", 2049, FieldType.INT8, brain_pin_e);
	public static final Field AUXSERIALRXPIN = Field.create("AUXSERIALRXPIN", 2050, FieldType.INT8, brain_pin_e);
	public static final Field LIS302DLCSPIN = Field.create("LIS302DLCSPIN", 2051, FieldType.INT8, brain_pin_e);
	public static final Field TPSACCELLENGTH = Field.create("TPSACCELLENGTH", 2052, FieldType.INT);
	public static final Field TPSACCELENRICHMENTTHRESHOLD = Field.create("TPSACCELENRICHMENTTHRESHOLD", 2056, FieldType.FLOAT);
	public static final Field UNUSEDVVTOFFSETWASHERE = Field.create("UNUSEDVVTOFFSETWASHERE", 2060, FieldType.FLOAT);
	public static final Field ENGINELOADACCELLENGTH = Field.create("ENGINELOADACCELLENGTH", 2064, FieldType.INT);
	public static final Field UNUSEDEL1 = Field.create("UNUSEDEL1", 2068, FieldType.FLOAT);
	public static final Field UNUSEDEL2 = Field.create("UNUSEDEL2", 2072, FieldType.FLOAT);
	public static final Field UNUSEDEL3 = Field.create("UNUSEDEL3", 2076, FieldType.FLOAT);
	public static final Field UNUSEDEL4 = Field.create("UNUSEDEL4", 2080, FieldType.FLOAT);
	public static final Field UARTCONSOLESERIALSPEED = Field.create("UARTCONSOLESERIALSPEED", 2084, FieldType.INT);
	public static final Field TPSDECELENLEANMENTTHRESHOLD = Field.create("TPSDECELENLEANMENTTHRESHOLD", 2088, FieldType.FLOAT);
	public static final Field TPSDECELENLEANMENTMULTIPLIER = Field.create("TPSDECELENLEANMENTMULTIPLIER", 2092, FieldType.FLOAT);
	public static final Field SLOWADCALPHA = Field.create("SLOWADCALPHA", 2096, FieldType.FLOAT);
	...
	public static final Field DEBUGMODE = Field.create("DEBUGMODE", 2100, FieldType.INT, debug_mode_e);
	public static final Field AUXSERIALSPEED = Field.create("AUXSERIALSPEED", 2104, FieldType.INT);
	public static final Field THROTTLEPEDALSECONDARYUPVOLTAGE = Field.create("THROTTLEPEDALSECONDARYUPVOLTAGE", 2108, FieldType.FLOAT);
	public static final Field THROTTLEPEDALSECONDARYWOTVOLTAGE = Field.create("THROTTLEPEDALSECONDARYWOTVOLTAGE", 2112, FieldType.FLOAT);
	public static final String[] can_baudrate_e = {"100kbps", "250kbps", "500kbps", "1Mbps"};
	public static final Field CANBAUDRATE = Field.create("CANBAUDRATE", 2116, FieldType.INT8, can_baudrate_e);
	public static final String[] ve_override_e = {"None", "MAP", "TPS"};
	public static final Field VEOVERRIDEMODE = Field.create("VEOVERRIDEMODE", 2117, FieldType.INT8, ve_override_e);
	public static final Field CAN2BAUDRATE = Field.create("CAN2BAUDRATE", 2118, FieldType.INT8, can_baudrate_e);
	public static final String[] afr_override_e = {"None", "MAP", "TPS", "Acc Pedal", "Cyl Filling %"};
	public static final Field AFROVERRIDEMODE = Field.create("AFROVERRIDEMODE", 2119, FieldType.INT8, afr_override_e);
	public static final Field VERBOSECAN2BASEADDRESS = Field.create("VERBOSECAN2BASEADDRESS", 2120, FieldType.INT);
	public static final Field ENABLEVERBOSECAN2TX = Field.create("ENABLEVERBOSECAN2TX", 2124, FieldType.BIT, 0);
	public static final Field CAN2READENABLED = Field.create("CAN2READENABLED", 2124, FieldType.BIT, 1);
	public static final Field CAN2WRITEENABLED = Field.create("CAN2WRITEENABLED", 2124, FieldType.BIT, 2);
	public static final Field STEPPERDCINVERTEDPINS = Field.create("STEPPERDCINVERTEDPINS", 2124, FieldType.BIT, 3);
	public static final Field UNUSED1127 = Field.create("UNUSED1127", 2124, FieldType.BIT, 4);
	public static final Field UNUSED1128 = Field.create("UNUSED1128", 2124, FieldType.BIT, 5);
	public static final Field UNUSED1129 = Field.create("UNUSED1129", 2124, FieldType.BIT, 6);
	public static final Field UNUSED1130 = Field.create("UNUSED1130", 2124, FieldType.BIT, 7);
	public static final Field UNUSEDBIT_510_8 = Field.create("UNUSEDBIT_510_8", 2124, FieldType.BIT, 8);
	public static final Field UNUSEDBIT_510_9 = Field.create("UNUSEDBIT_510_9", 2124, FieldType.BIT, 9);
	public static final Field UNUSEDBIT_510_10 = Field.create("UNUSEDBIT_510_10", 2124, FieldType.BIT, 10);
	public static final Field UNUSEDBIT_510_11 = Field.create("UNUSEDBIT_510_11", 2124, FieldType.BIT, 11);
	public static final Field UNUSEDBIT_510_12 = Field.create("UNUSEDBIT_510_12", 2124, FieldType.BIT, 12);
	public static final Field UNUSEDBIT_510_13 = Field.create("UNUSEDBIT_510_13", 2124, FieldType.BIT, 13);
	public static final Field UNUSEDBIT_510_14 = Field.create("UNUSEDBIT_510_14", 2124, FieldType.BIT, 14);
	public static final Field UNUSEDBIT_510_15 = Field.create("UNUSEDBIT_510_15", 2124, FieldType.BIT, 15);
	public static final Field UNUSEDBIT_510_16 = Field.create("UNUSEDBIT_510_16", 2124, FieldType.BIT, 16);
	public static final Field UNUSEDBIT_510_17 = Field.create("UNUSEDBIT_510_17", 2124, FieldType.BIT, 17);
	public static final Field UNUSEDBIT_510_18 = Field.create("UNUSEDBIT_510_18", 2124, FieldType.BIT, 18);
	public static final Field UNUSEDBIT_510_19 = Field.create("UNUSEDBIT_510_19", 2124, FieldType.BIT, 19);
	public static final Field UNUSEDBIT_510_20 = Field.create("UNUSEDBIT_510_20", 2124, FieldType.BIT, 20);
	public static final Field UNUSEDBIT_510_21 = Field.create("UNUSEDBIT_510_21", 2124, FieldType.BIT, 21);
	public static final Field UNUSEDBIT_510_22 = Field.create("UNUSEDBIT_510_22", 2124, FieldType.BIT, 22);
	public static final Field UNUSEDBIT_510_23 = Field.create("UNUSEDBIT_510_23", 2124, FieldType.BIT, 23);
	public static final Field UNUSEDBIT_510_24 = Field.create("UNUSEDBIT_510_24", 2124, FieldType.BIT, 24);
	public static final Field UNUSEDBIT_510_25 = Field.create("UNUSEDBIT_510_25", 2124, FieldType.BIT, 25);
	public static final Field UNUSEDBIT_510_26 = Field.create("UNUSEDBIT_510_26", 2124, FieldType.BIT, 26);
	public static final Field UNUSEDBIT_510_27 = Field.create("UNUSEDBIT_510_27", 2124, FieldType.BIT, 27);
	public static final Field UNUSEDBIT_510_28 = Field.create("UNUSEDBIT_510_28", 2124, FieldType.BIT, 28);
	public static final Field UNUSEDBIT_510_29 = Field.create("UNUSEDBIT_510_29", 2124, FieldType.BIT, 29);
	public static final Field UNUSEDBIT_510_30 = Field.create("UNUSEDBIT_510_30", 2124, FieldType.BIT, 30);
	public static final Field UNUSEDBIT_510_31 = Field.create("UNUSEDBIT_510_31", 2124, FieldType.BIT, 31);
	public static final Field CAN2NBCTYPE = Field.create("CAN2NBCTYPE", 2128, FieldType.INT);
	public static final Field CAN2TXPIN = Field.create("CAN2TXPIN", 2132, FieldType.INT8, brain_pin_e);
	public static final Field CAN2RXPIN = Field.create("CAN2RXPIN", 2133, FieldType.INT8, brain_pin_e);
	public static final Field STARTERCONTROLPINMODE = Field.create("STARTERCONTROLPINMODE", 2134, FieldType.INT8, pin_output_mode_e);
	public static final Field WASTEGATEPOSITIONSENSOR = Field.create("WASTEGATEPOSITIONSENSOR", 2135, FieldType.INT8, adc_channel_e);
	public static final Field IGNOVERRIDEMODE = Field.create("IGNOVERRIDEMODE", 2136, FieldType.INT8, afr_override_e);
	public static final Field INJECTORPRESSURETYPE = Field.create("INJECTORPRESSURETYPE", 2137, FieldType.INT8);
	public static final Field HPFPVALVEPIN = Field.create("HPFPVALVEPIN", 2138, FieldType.INT8, output_pin_e);
	public static final Field HPFPVALVEPINMODE = Field.create("HPFPVALVEPINMODE", 2139, FieldType.INT8, pin_output_mode_e);
	public static final Field BOOSTCUTPRESSURE = Field.create("BOOSTCUTPRESSURE", 2140, FieldType.FLOAT);
	public static final Field MAPACCELTAPERBINS = Field.create("MAPACCELTAPERBINS", 2144, FieldType.FLOAT);
	public static final Field MAPACCELTAPERMULT = Field.create("MAPACCELTAPERMULT", 2176, FieldType.FLOAT);
	public static final Field UNUSEDANOTHERONEOFTHOSE = Field.create("UNUSEDANOTHERONEOFTHOSE", 2208, FieldType.FLOAT);
	public static final Field FIXEDTIMING = Field.create("FIXEDTIMING", 2212, FieldType.FLOAT);
	public static final Field MAPLOWVALUEVOLTAGE = Field.create("MAPLOWVALUEVOLTAGE", 2216, FieldType.FLOAT);
	public static final Field MAPHIGHVALUEVOLTAGE = Field.create("MAPHIGHVALUEVOLTAGE", 2220, FieldType.FLOAT);
	public static final Field EGOVALUESHIFT = Field.create("EGOVALUESHIFT", 2224, FieldType.FLOAT);
	public static final Field VVTPINS1 = Field.create("VVTPINS1", 2228, FieldType.INT8, output_pin_e);
	public static final Field VVTPINS2 = Field.create("VVTPINS2", 2229, FieldType.INT8, output_pin_e);
	public static final Field VVTPINS3 = Field.create("VVTPINS3", 2230, FieldType.INT8, output_pin_e);
	public static final Field VVTPINS4 = Field.create("VVTPINS4", 2231, FieldType.INT8, output_pin_e);
	public static final Field CJ125SPIDEVICE = Field.create("CJ125SPIDEVICE", 2232, FieldType.INT8);
	public static final Field CJ125CSPINMODE = Field.create("CJ125CSPINMODE", 2233, FieldType.INT8, pin_output_mode_e);
	public static final Field SDCARDCSPINMODE = Field.create("SDCARDCSPINMODE", 2234, FieldType.INT8, pin_output_mode_e);
	public static final Field ALIGNMENTFILL_AT_2235 = Field.create("ALIGNMENTFILL_AT_2235", 2235, FieldType.INT8);
	public static final Field CRANKINGIACPOSITION = Field.create("CRANKINGIACPOSITION", 2236, FieldType.INT);
	public static final Field TCHARGEMINRPMMINTPS = Field.create("TCHARGEMINRPMMINTPS", 2240, FieldType.FLOAT);
	public static final Field TCHARGEMINRPMMAXTPS = Field.create("TCHARGEMINRPMMAXTPS", 2244, FieldType.FLOAT);
	public static final Field TCHARGEMAXRPMMINTPS = Field.create("TCHARGEMAXRPMMINTPS", 2248, FieldType.FLOAT);
	public static final Field TCHARGEMAXRPMMAXTPS = Field.create("TCHARGEMAXRPMMAXTPS", 2252, FieldType.FLOAT);
	public static final Field VVTOUTPUTFREQUENCY1 = Field.create("VVTOUTPUTFREQUENCY1", 2256, FieldType.INT16);
	public static final Field VVTOUTPUTFREQUENCY2 = Field.create("VVTOUTPUTFREQUENCY2", 2258, FieldType.INT16);
	public static final Field FAN1EXTRAIDLE = Field.create("FAN1EXTRAIDLE", 2260, FieldType.INT8);
	public static final Field ALIGNMENTFILL_AT_2261 = Field.create("ALIGNMENTFILL_AT_2261", 2261, FieldType.INT8);
	public static final Field ALTERNATORPWMFREQUENCY = Field.create("ALTERNATORPWMFREQUENCY", 2264, FieldType.INT);
	public static final Field UNUSED2260 = Field.create("UNUSED2260", 2268, FieldType.INT);
	public static final Field NARROWTOWIDEOXYGENBINS = Field.create("NARROWTOWIDEOXYGENBINS", 2272, FieldType.FLOAT);
	public static final Field NARROWTOWIDEOXYGEN = Field.create("NARROWTOWIDEOXYGEN", 2304, FieldType.FLOAT);
	public static final String[] vvt_mode_e = {"Inactive", "Single Tooth Second Half", "2GZ", "Miata NB2", "Single Tooth First Half", "Bosch Quick Start", "4/1", "ST 170", "Ford Barra 3+1", "Nissan VQ", "Honda K 4+1", "Nissan MR18", "vvt12", "vvt13"};
	public static final Field VVTMODE1 = Field.create("VVTMODE1", 2336, FieldType.INT8, vvt_mode_e);
	public static final Field VVTMODE2 = Field.create("VVTMODE2", 2337, FieldType.INT8, vvt_mode_e);
	public static final Field VVTMODEPADDING = Field.create("VVTMODEPADDING", 2338, FieldType.INT8);
	public static final Field FAN2EXTRAIDLE = Field.create("FAN2EXTRAIDLE", 2338, FieldType.INT8);
	public static final Field UNUSEDOLDBIQUAD = Field.create("UNUSEDOLDBIQUAD", 2339, FieldType.INT8);
	public static final Field AUXANALOGINPUTS1 = Field.create("AUXANALOGINPUTS1", 2340, FieldType.INT8, adc_channel_e);
	public static final Field AUXANALOGINPUTS2 = Field.create("AUXANALOGINPUTS2", 2341, FieldType.INT8, adc_channel_e);
	public static final Field AUXANALOGINPUTS3 = Field.create("AUXANALOGINPUTS3", 2342, FieldType.INT8, adc_channel_e);
	public static final Field AUXANALOGINPUTS4 = Field.create("AUXANALOGINPUTS4", 2343, FieldType.INT8, adc_channel_e);
	public static final Field AUXANALOGINPUTS5 = Field.create("AUXANALOGINPUTS5", 2344, FieldType.INT8, adc_channel_e);
	public static final Field AUXANALOGINPUTS6 = Field.create("AUXANALOGINPUTS6", 2345, FieldType.INT8, adc_channel_e);
	public static final Field AUXANALOGINPUTS7 = Field.create("AUXANALOGINPUTS7", 2346, FieldType.INT8, adc_channel_e);
	public static final Field AUXANALOGINPUTS8 = Field.create("AUXANALOGINPUTS8", 2347, FieldType.INT8, adc_channel_e);
	public static final Field TRAILINGCOILPINS1 = Field.create("TRAILINGCOILPINS1", 2348, FieldType.INT8, output_pin_e);
	public static final Field TRAILINGCOILPINS2 = Field.create("TRAILINGCOILPINS2", 2349, FieldType.INT8, output_pin_e);
	public static final Field TRAILINGCOILPINS3 = Field.create("TRAILINGCOILPINS3", 2350, FieldType.INT8, output_pin_e);
	public static final Field TRAILINGCOILPINS4 = Field.create("TRAILINGCOILPINS4", 2351, FieldType.INT8, output_pin_e);
	public static final Field TRAILINGCOILPINS5 = Field.create("TRAILINGCOILPINS5", 2352, FieldType.INT8, output_pin_e);
	public static final Field TRAILINGCOILPINS6 = Field.create("TRAILINGCOILPINS6", 2353, FieldType.INT8, output_pin_e);
	public static final Field TRAILINGCOILPINS7 = Field.create("TRAILINGCOILPINS7", 2354, FieldType.INT8, output_pin_e);
	public static final Field TRAILINGCOILPINS8 = Field.create("TRAILINGCOILPINS8", 2355, FieldType.INT8, output_pin_e);
	public static final Field TRAILINGCOILPINS9 = Field.create("TRAILINGCOILPINS9", 2356, FieldType.INT8, output_pin_e);
	public static final Field TRAILINGCOILPINS10 = Field.create("TRAILINGCOILPINS10", 2357, FieldType.INT8, output_pin_e);
	public static final Field TRAILINGCOILPINS11 = Field.create("TRAILINGCOILPINS11", 2358, FieldType.INT8, output_pin_e);
	public static final Field TRAILINGCOILPINS12 = Field.create("TRAILINGCOILPINS12", 2359, FieldType.INT8, output_pin_e);
	public static final Field CLTTIMINGBINS = Field.create("CLTTIMINGBINS", 2360, FieldType.FLOAT);
	public static final Field CLTTIMINGEXTRA = Field.create("CLTTIMINGEXTRA", 2392, FieldType.FLOAT);
	public static final Field TLE8888MODE = Field.create("TLE8888MODE", 2424, FieldType.INT8);
	public static final Field LIS302DLCSPINMODE = Field.create("LIS302DLCSPINMODE", 2425, FieldType.INT8, pin_output_mode_e);
	public static final Field INJECTORCOMPENSATIONMODE = Field.create("INJECTORCOMPENSATIONMODE", 2426, FieldType.INT8);
	public static final Field FAN2PINMODE = Field.create("FAN2PINMODE", 2427, FieldType.INT8, pin_output_mode_e);
	public static final Field FUELREFERENCEPRESSURE = Field.create("FUELREFERENCEPRESSURE", 2428, FieldType.FLOAT);
	public static final Field UNUSED244_2 = Field.create("UNUSED244_2", 2432, FieldType.FLOAT);
	public static final Field UNUSED244_3 = Field.create("UNUSED244_3", 2436, FieldType.FLOAT);
	public static final Field UNUSED2432 = Field.create("UNUSED2432", 2440, FieldType.FLOAT);
	public static final Field POSTCRANKINGFACTOR = Field.create("POSTCRANKINGFACTOR", 2444, FieldType.FLOAT);
	public static final Field POSTCRANKINGDURATIONSEC = Field.create("POSTCRANKINGDURATIONSEC", 2448, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR1_TEMPC_1 = Field.create("AUXTEMPSENSOR1_TEMPC_1", 2452, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR1_TEMPC_2 = Field.create("AUXTEMPSENSOR1_TEMPC_2", 2456, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR1_TEMPC_3 = Field.create("AUXTEMPSENSOR1_TEMPC_3", 2460, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR1_RESISTANCE_1 = Field.create("AUXTEMPSENSOR1_RESISTANCE_1", 2464, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR1_RESISTANCE_2 = Field.create("AUXTEMPSENSOR1_RESISTANCE_2", 2468, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR1_RESISTANCE_3 = Field.create("AUXTEMPSENSOR1_RESISTANCE_3", 2472, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR1_BIAS_RESISTOR = Field.create("AUXTEMPSENSOR1_BIAS_RESISTOR", 2476, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR1_ADCCHANNEL = Field.create("AUXTEMPSENSOR1_ADCCHANNEL", 2480, FieldType.INT8, adc_channel_e);
	public static final Field AUXTEMPSENSOR1_ALIGNMENTFILL_AT_29 = Field.create("AUXTEMPSENSOR1_ALIGNMENTFILL_AT_29", 2481, FieldType.INT8);
	public static final Field AUXTEMPSENSOR2_TEMPC_1 = Field.create("AUXTEMPSENSOR2_TEMPC_1", 2484, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR2_TEMPC_2 = Field.create("AUXTEMPSENSOR2_TEMPC_2", 2488, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR2_TEMPC_3 = Field.create("AUXTEMPSENSOR2_TEMPC_3", 2492, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR2_RESISTANCE_1 = Field.create("AUXTEMPSENSOR2_RESISTANCE_1", 2496, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR2_RESISTANCE_2 = Field.create("AUXTEMPSENSOR2_RESISTANCE_2", 2500, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR2_RESISTANCE_3 = Field.create("AUXTEMPSENSOR2_RESISTANCE_3", 2504, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR2_BIAS_RESISTOR = Field.create("AUXTEMPSENSOR2_BIAS_RESISTOR", 2508, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR2_ADCCHANNEL = Field.create("AUXTEMPSENSOR2_ADCCHANNEL", 2512, FieldType.INT8, adc_channel_e);
	public static final Field AUXTEMPSENSOR2_ALIGNMENTFILL_AT_29 = Field.create("AUXTEMPSENSOR2_ALIGNMENTFILL_AT_29", 2513, FieldType.INT8);
	public static final Field APPLYNONLINEARBELOWPULSE = Field.create("APPLYNONLINEARBELOWPULSE", 2516, FieldType.INT16);
	public static final Field INJECTORNONLINEARMODE = Field.create("INJECTORNONLINEARMODE", 2518, FieldType.INT8);
	public static final Field UNUSED2508 = Field.create("UNUSED2508", 2519, FieldType.INT8);
	public static final Field KNOCKSAMPLINGDURATION = Field.create("KNOCKSAMPLINGDURATION", 2520, FieldType.INT16);
	public static final Field ETBFREQ = Field.create("ETBFREQ", 2522, FieldType.INT16);
	public static final Field ETBWASTEGATEPID_PFACTOR = Field.create("ETBWASTEGATEPID_PFACTOR", 2524, FieldType.FLOAT);
	public static final Field ETBWASTEGATEPID_IFACTOR = Field.create("ETBWASTEGATEPID_IFACTOR", 2528, FieldType.FLOAT);
	public static final Field ETBWASTEGATEPID_DFACTOR = Field.create("ETBWASTEGATEPID_DFACTOR", 2532, FieldType.FLOAT);
	public static final Field ETBWASTEGATEPID_OFFSET = Field.create("ETBWASTEGATEPID_OFFSET", 2536, FieldType.INT16);
	public static final Field ETBWASTEGATEPID_PERIODMS = Field.create("ETBWASTEGATEPID_PERIODMS", 2538, FieldType.INT16);
	public static final Field ETBWASTEGATEPID_MINVALUE = Field.create("ETBWASTEGATEPID_MINVALUE", 2540, FieldType.INT16);
	public static final Field ETBWASTEGATEPID_MAXVALUE = Field.create("ETBWASTEGATEPID_MAXVALUE", 2542, FieldType.INT16);
	...
	public static final Field STEPPERNUMMICROSTEPS = Field.create("STEPPERNUMMICROSTEPS", 2544, FieldType.INT8, stepper_num_micro_steps_e);
	public static final Field STEPPERMINDUTYCYCLE = Field.create("STEPPERMINDUTYCYCLE", 2545, FieldType.INT8);
	public static final Field STEPPERMAXDUTYCYCLE = Field.create("STEPPERMAXDUTYCYCLE", 2546, FieldType.INT8);
	public static final Field UNUSED2536 = Field.create("UNUSED2536", 2547, FieldType.INT8);
	public static final Field TIMING_OFFSET_CYLINDER1 = Field.create("TIMING_OFFSET_CYLINDER1", 2548, FieldType.FLOAT);
	public static final Field TIMING_OFFSET_CYLINDER2 = Field.create("TIMING_OFFSET_CYLINDER2", 2552, FieldType.FLOAT);
	public static final Field TIMING_OFFSET_CYLINDER3 = Field.create("TIMING_OFFSET_CYLINDER3", 2556, FieldType.FLOAT);
	public static final Field TIMING_OFFSET_CYLINDER4 = Field.create("TIMING_OFFSET_CYLINDER4", 2560, FieldType.FLOAT);
	public static final Field TIMING_OFFSET_CYLINDER5 = Field.create("TIMING_OFFSET_CYLINDER5", 2564, FieldType.FLOAT);
	public static final Field TIMING_OFFSET_CYLINDER6 = Field.create("TIMING_OFFSET_CYLINDER6", 2568, FieldType.FLOAT);
	public static final Field TIMING_OFFSET_CYLINDER7 = Field.create("TIMING_OFFSET_CYLINDER7", 2572, FieldType.FLOAT);
	public static final Field TIMING_OFFSET_CYLINDER8 = Field.create("TIMING_OFFSET_CYLINDER8", 2576, FieldType.FLOAT);
	public static final Field TIMING_OFFSET_CYLINDER9 = Field.create("TIMING_OFFSET_CYLINDER9", 2580, FieldType.FLOAT);
	public static final Field TIMING_OFFSET_CYLINDER10 = Field.create("TIMING_OFFSET_CYLINDER10", 2584, FieldType.FLOAT);
	public static final Field TIMING_OFFSET_CYLINDER11 = Field.create("TIMING_OFFSET_CYLINDER11", 2588, FieldType.FLOAT);
	public static final Field TIMING_OFFSET_CYLINDER12 = Field.create("TIMING_OFFSET_CYLINDER12", 2592, FieldType.FLOAT);
	public static final Field IDLEPIDACTIVATIONTIME = Field.create("IDLEPIDACTIVATIONTIME", 2596, FieldType.FLOAT);
	public static final Field SDCARDSPIDEVICE = Field.create("SDCARDSPIDEVICE", 2600, FieldType.INT8);
	public static final Field UNUSEDSPIPADDING4 = Field.create("UNUSEDSPIPADDING4", 2601, FieldType.INT8);
	...
	public static final Field SPI1SCKMODE = Field.create("SPI1SCKMODE", 2604, FieldType.INT8, pin_mode_e);
	public static final Field SPI1MOSIMODE = Field.create("SPI1MOSIMODE", 2605, FieldType.INT8, pin_mode_e);
	public static final Field SPI1MISOMODE = Field.create("SPI1MISOMODE", 2606, FieldType.INT8, pin_mode_e);
	public static final Field SPI2SCKMODE = Field.create("SPI2SCKMODE", 2607, FieldType.INT8, pin_mode_e);
	public static final Field SPI2MOSIMODE = Field.create("SPI2MOSIMODE", 2608, FieldType.INT8, pin_mode_e);
	public static final Field SPI2MISOMODE = Field.create("SPI2MISOMODE", 2609, FieldType.INT8, pin_mode_e);
	public static final Field SPI3SCKMODE = Field.create("SPI3SCKMODE", 2610, FieldType.INT8, pin_mode_e);
	public static final Field SPI3MOSIMODE = Field.create("SPI3MOSIMODE", 2611, FieldType.INT8, pin_mode_e);
	public static final Field SPI3MISOMODE = Field.create("SPI3MISOMODE", 2612, FieldType.INT8, pin_mode_e);
	public static final Field STEPPERENABLEPINMODE = Field.create("STEPPERENABLEPINMODE", 2613, FieldType.INT8, pin_output_mode_e);
	public static final Field MC33816_RSTB = Field.create("MC33816_RSTB", 2614, FieldType.INT8, brain_pin_e);
	public static final Field MC33816_DRIVEN = Field.create("MC33816_DRIVEN", 2615, FieldType.INT8, brain_pin_e);
	public static final Field BRAKEPEDALPIN = Field.create("BRAKEPEDALPIN", 2616, FieldType.INT8, switch_input_pin_e);
	public static final Field CJ125UA = Field.create("CJ125UA", 2617, FieldType.INT8, adc_channel_e);
	public static final Field CJ125UR = Field.create("CJ125UR", 2618, FieldType.INT8, adc_channel_e);
	public static final Field BRAKEPEDALPINMODE = Field.create("BRAKEPEDALPINMODE", 2619, FieldType.INT8, pin_input_mode_e);
	public static final Field AUXPID1_PFACTOR = Field.create("AUXPID1_PFACTOR", 2620, FieldType.FLOAT);
	public static final Field AUXPID1_IFACTOR = Field.create("AUXPID1_IFACTOR", 2624, FieldType.FLOAT);
	public static final Field AUXPID1_DFACTOR = Field.create("AUXPID1_DFACTOR", 2628, FieldType.FLOAT);
	public static final Field AUXPID1_OFFSET = Field.create("AUXPID1_OFFSET", 2632, FieldType.INT16);
	public static final Field AUXPID1_PERIODMS = Field.create("AUXPID1_PERIODMS", 2634, FieldType.INT16);
	public static final Field AUXPID1_MINVALUE = Field.create("AUXPID1_MINVALUE", 2636, FieldType.INT16);
	public static final Field AUXPID1_MAXVALUE = Field.create("AUXPID1_MAXVALUE", 2638, FieldType.INT16);
	public static final Field AUXPID2_PFACTOR = Field.create("AUXPID2_PFACTOR", 2640, FieldType.FLOAT);
	public static final Field AUXPID2_IFACTOR = Field.create("AUXPID2_IFACTOR", 2644, FieldType.FLOAT);
	public static final Field AUXPID2_DFACTOR = Field.create("AUXPID2_DFACTOR", 2648, FieldType.FLOAT);
	public static final Field AUXPID2_OFFSET = Field.create("AUXPID2_OFFSET", 2652, FieldType.INT16);
	public static final Field AUXPID2_PERIODMS = Field.create("AUXPID2_PERIODMS", 2654, FieldType.INT16);
	public static final Field AUXPID2_MINVALUE = Field.create("AUXPID2_MINVALUE", 2656, FieldType.INT16);
	public static final Field AUXPID2_MAXVALUE = Field.create("AUXPID2_MAXVALUE", 2658, FieldType.INT16);
	public static final Field INJECTORCORRECTIONPOLYNOMIAL1 = Field.create("INJECTORCORRECTIONPOLYNOMIAL1", 2660, FieldType.FLOAT);
	public static final Field INJECTORCORRECTIONPOLYNOMIAL2 = Field.create("INJECTORCORRECTIONPOLYNOMIAL2", 2664, FieldType.FLOAT);
	public static final Field INJECTORCORRECTIONPOLYNOMIAL3 = Field.create("INJECTORCORRECTIONPOLYNOMIAL3", 2668, FieldType.FLOAT);
	public static final Field INJECTORCORRECTIONPOLYNOMIAL4 = Field.create("INJECTORCORRECTIONPOLYNOMIAL4", 2672, FieldType.FLOAT);
	public static final Field INJECTORCORRECTIONPOLYNOMIAL5 = Field.create("INJECTORCORRECTIONPOLYNOMIAL5", 2676, FieldType.FLOAT);
	public static final Field INJECTORCORRECTIONPOLYNOMIAL6 = Field.create("INJECTORCORRECTIONPOLYNOMIAL6", 2680, FieldType.FLOAT);
	public static final Field INJECTORCORRECTIONPOLYNOMIAL7 = Field.create("INJECTORCORRECTIONPOLYNOMIAL7", 2684, FieldType.FLOAT);
	public static final Field INJECTORCORRECTIONPOLYNOMIAL8 = Field.create("INJECTORCORRECTIONPOLYNOMIAL8", 2688, FieldType.FLOAT);
	public static final Field UNUSED1366 = Field.create("UNUSED1366", 2692, FieldType.INT8);
	public static final Field OILPRESSURE_HWCHANNEL = Field.create("OILPRESSURE_HWCHANNEL", 2700, FieldType.INT8, adc_channel_e);
	public static final Field OILPRESSURE_ALIGNMENTFILL = Field.create("OILPRESSURE_ALIGNMENTFILL", 2701, FieldType.INT8);
	public static final Field OILPRESSURE_V1 = Field.create("OILPRESSURE_V1", 2704, FieldType.FLOAT);
	public static final Field OILPRESSURE_VALUE1 = Field.create("OILPRESSURE_VALUE1", 2708, FieldType.FLOAT);
	public static final Field OILPRESSURE_V2 = Field.create("OILPRESSURE_V2", 2712, FieldType.FLOAT);
	public static final Field OILPRESSURE_VALUE2 = Field.create("OILPRESSURE_VALUE2", 2716, FieldType.FLOAT);
	public static final Field ACCELEROMETERSPIDEVICE = Field.create("ACCELEROMETERSPIDEVICE", 2720, FieldType.INT8);
	public static final Field FAN2PIN = Field.create("FAN2PIN", 2721, FieldType.INT8, output_pin_e);
	public static final Field FAN2ONTEMPERATURE = Field.create("FAN2ONTEMPERATURE", 2722, FieldType.INT8);
	public static final Field FAN2OFFTEMPERATURE = Field.create("FAN2OFFTEMPERATURE", 2723, FieldType.INT8);
	public static final Field SCRIPTCURVE1BINS = Field.create("SCRIPTCURVE1BINS", 2724, FieldType.FLOAT);
	public static final Field SCRIPTCURVE1 = Field.create("SCRIPTCURVE1", 2788, FieldType.FLOAT);
	public static final Field SCRIPTCURVE2BINS = Field.create("SCRIPTCURVE2BINS", 2852, FieldType.FLOAT);
	public static final Field SCRIPTCURVE2 = Field.create("SCRIPTCURVE2", 2916, FieldType.FLOAT);
	public static final Field SCRIPTCURVE3BINS = Field.create("SCRIPTCURVE3BINS", 2980, FieldType.FLOAT);
	public static final Field SCRIPTCURVE3 = Field.create("SCRIPTCURVE3", 3012, FieldType.FLOAT);
	public static final Field SCRIPTCURVE4BINS = Field.create("SCRIPTCURVE4BINS", 3044, FieldType.FLOAT);
	public static final Field SCRIPTCURVE4 = Field.create("SCRIPTCURVE4", 3076, FieldType.FLOAT);
	public static final Field FLEXSENSORPIN = Field.create("FLEXSENSORPIN", 3108, FieldType.INT8, brain_input_pin_e);
	public static final Field TEST557PIN = Field.create("TEST557PIN", 3109, FieldType.INT8, brain_pin_e);
	public static final Field STEPPERDIRECTIONPINMODE = Field.create("STEPPERDIRECTIONPINMODE", 3110, FieldType.INT8, pin_output_mode_e);
	public static final Field UNUSED3103 = Field.create("UNUSED3103", 3111, FieldType.INT8);
	public static final Field STEPPERENABLEPIN = Field.create("STEPPERENABLEPIN", 3112, FieldType.INT8, output_pin_e);
	public static final Field TLE8888_CS = Field.create("TLE8888_CS", 3113, FieldType.INT8, brain_pin_e);
	public static final Field TLE8888_CSPINMODE = Field.create("TLE8888_CSPINMODE", 3114, FieldType.INT8, pin_output_mode_e);
	public static final Field MC33816_CS = Field.create("MC33816_CS", 3115, FieldType.INT8, brain_pin_e);
	public static final Field CRANKINGADVANCEBINS = Field.create("CRANKINGADVANCEBINS", 3116, FieldType.FLOAT);
	public static final Field CRANKINGADVANCE = Field.create("CRANKINGADVANCE", 3132, FieldType.FLOAT);
	public static final Field SERVOOUTPUTPINS1 = Field.create("SERVOOUTPUTPINS1", 3148, FieldType.INT8, brain_pin_e);
	public static final Field SERVOOUTPUTPINS2 = Field.create("SERVOOUTPUTPINS2", 3149, FieldType.INT8, brain_pin_e);
	public static final Field SERVOOUTPUTPINS3 = Field.create("SERVOOUTPUTPINS3", 3150, FieldType.INT8, brain_pin_e);
	public static final Field SERVOOUTPUTPINS4 = Field.create("SERVOOUTPUTPINS4", 3151, FieldType.INT8, brain_pin_e);
	public static final Field SERVOOUTPUTPINS5 = Field.create("SERVOOUTPUTPINS5", 3152, FieldType.INT8, brain_pin_e);
	public static final Field SERVOOUTPUTPINS6 = Field.create("SERVOOUTPUTPINS6", 3153, FieldType.INT8, brain_pin_e);
	public static final Field SERVOOUTPUTPINS7 = Field.create("SERVOOUTPUTPINS7", 3154, FieldType.INT8, brain_pin_e);
	public static final Field SERVOOUTPUTPINS8 = Field.create("SERVOOUTPUTPINS8", 3155, FieldType.INT8, brain_pin_e);
	public static final Field COASTINGFUELCUTRPMHIGH = Field.create("COASTINGFUELCUTRPMHIGH", 3156, FieldType.INT16);
	public static final Field COASTINGFUELCUTRPMLOW = Field.create("COASTINGFUELCUTRPMLOW", 3158, FieldType.INT16);
	public static final Field COASTINGFUELCUTTPS = Field.create("COASTINGFUELCUTTPS", 3160, FieldType.INT16);
	public static final Field COASTINGFUELCUTCLT = Field.create("COASTINGFUELCUTCLT", 3162, FieldType.INT16);
	public static final Field PIDEXTRAFORLOWRPM = Field.create("PIDEXTRAFORLOWRPM", 3164, FieldType.INT16);
	public static final Field COASTINGFUELCUTMAP = Field.create("COASTINGFUELCUTMAP", 3166, FieldType.INT16);
	public static final Field IACCOASTINGBINS = Field.create("IACCOASTINGBINS", 3168, FieldType.FLOAT);
	public static final Field IACCOASTING = Field.create("IACCOASTING", 3232, FieldType.FLOAT);
	public static final Field HIGHPRESSUREFUEL_HWCHANNEL = Field.create("HIGHPRESSUREFUEL_HWCHANNEL", 3296, FieldType.INT8, adc_channel_e);
	public static final Field HIGHPRESSUREFUEL_ALIGNMENTFILL = Field.create("HIGHPRESSUREFUEL_ALIGNMENTFILL", 3297, FieldType.INT8);
	public static final Field HIGHPRESSUREFUEL_V1 = Field.create("HIGHPRESSUREFUEL_V1", 3300, FieldType.FLOAT);
	public static final Field HIGHPRESSUREFUEL_VALUE1 = Field.create("HIGHPRESSUREFUEL_VALUE1", 3304, FieldType.FLOAT);
	public static final Field HIGHPRESSUREFUEL_V2 = Field.create("HIGHPRESSUREFUEL_V2", 3308, FieldType.FLOAT);
	public static final Field HIGHPRESSUREFUEL_VALUE2 = Field.create("HIGHPRESSUREFUEL_VALUE2", 3312, FieldType.FLOAT);
	public static final Field LOWPRESSUREFUEL_HWCHANNEL = Field.create("LOWPRESSUREFUEL_HWCHANNEL", 3316, FieldType.INT8, adc_channel_e);
	public static final Field LOWPRESSUREFUEL_ALIGNMENTFILL = Field.create("LOWPRESSUREFUEL_ALIGNMENTFILL", 3317, FieldType.INT8);
	public static final Field LOWPRESSUREFUEL_V1 = Field.create("LOWPRESSUREFUEL_V1", 3320, FieldType.FLOAT);
	public static final Field LOWPRESSUREFUEL_VALUE1 = Field.create("LOWPRESSUREFUEL_VALUE1", 3324, FieldType.FLOAT);
	public static final Field LOWPRESSUREFUEL_V2 = Field.create("LOWPRESSUREFUEL_V2", 3328, FieldType.FLOAT);
	public static final Field LOWPRESSUREFUEL_VALUE2 = Field.create("LOWPRESSUREFUEL_VALUE2", 3332, FieldType.FLOAT);
	public static final Field CLTREVLIMITRPMBINS = Field.create("CLTREVLIMITRPMBINS", 3336, FieldType.INT8);
	public static final Field CLTREVLIMITRPM = Field.create("CLTREVLIMITRPM", 3340, FieldType.INT16);
	public static final Field SCRIPTCURVENAME1 = Field.create("SCRIPTCURVENAME1", 3348, 16, FieldType.STRING);
	public static final Field SCRIPTCURVENAME2 = Field.create("SCRIPTCURVENAME2", 3364, 16, FieldType.STRING);
	public static final Field SCRIPTCURVENAME3 = Field.create("SCRIPTCURVENAME3", 3380, 16, FieldType.STRING);
	public static final Field SCRIPTCURVENAME4 = Field.create("SCRIPTCURVENAME4", 3396, 16, FieldType.STRING);
	public static final Field SCRIPTCURVENAME5 = Field.create("SCRIPTCURVENAME5", 3412, 16, FieldType.STRING);
	public static final Field SCRIPTCURVENAME6 = Field.create("SCRIPTCURVENAME6", 3428, 16, FieldType.STRING);
	public static final Field SCRIPTCURVE5BINS = Field.create("SCRIPTCURVE5BINS", 3444, FieldType.FLOAT);
	public static final Field SCRIPTCURVE5 = Field.create("SCRIPTCURVE5", 3476, FieldType.FLOAT);
	public static final Field SCRIPTCURVE6BINS = Field.create("SCRIPTCURVE6BINS", 3508, FieldType.FLOAT);
	public static final Field SCRIPTCURVE6 = Field.create("SCRIPTCURVE6", 3540, FieldType.FLOAT);
	public static final Field SCRIPTTABLENAME1 = Field.create("SCRIPTTABLENAME1", 3572, 16, FieldType.STRING);
	public static final Field SCRIPTTABLENAME2 = Field.create("SCRIPTTABLENAME2", 3588, 16, FieldType.STRING);
	public static final Field SCRIPTTABLENAME3 = Field.create("SCRIPTTABLENAME3", 3604, 16, FieldType.STRING);
	public static final Field SCRIPTTABLENAME4 = Field.create("SCRIPTTABLENAME4", 3620, 16, FieldType.STRING);
	public static final Field UNUSED3328 = Field.create("UNUSED3328", 3636, FieldType.INT8);
	public static final Field TCHARGEAIRCOEFMIN = Field.create("TCHARGEAIRCOEFMIN", 3872, FieldType.FLOAT);
	public static final Field TCHARGEAIRCOEFMAX = Field.create("TCHARGEAIRCOEFMAX", 3876, FieldType.FLOAT);
	public static final Field TCHARGEAIRFLOWMAX = Field.create("TCHARGEAIRFLOWMAX", 3880, FieldType.FLOAT);
	public static final Field TCHARGEAIRINCRLIMIT = Field.create("TCHARGEAIRINCRLIMIT", 3884, FieldType.FLOAT);
	public static final Field TCHARGEAIRDECRLIMIT = Field.create("TCHARGEAIRDECRLIMIT", 3888, FieldType.FLOAT);
	public static final String[] tChargeMode_e = {"RPM+TPS (Default)", "Air Mass Interpolation"};
	public static final Field TCHARGEMODE = Field.create("TCHARGEMODE", 3892, FieldType.INT, tChargeMode_e);
	public static final Field ETBBIASBINS = Field.create("ETBBIASBINS", 3896, FieldType.FLOAT);
	public static final Field ETBBIASVALUES = Field.create("ETBBIASVALUES", 3928, FieldType.FLOAT);
	public static final Field HIP9011GAIN = Field.create("HIP9011GAIN", 3960, FieldType.FLOAT);
	public static final Field ETB_ITERMMIN = Field.create("ETB_ITERMMIN", 3964, FieldType.INT16);
	public static final Field ETB_ITERMMAX = Field.create("ETB_ITERMMAX", 3966, FieldType.INT16);
	public static final Field ETBMAXIMUMPOSITION = Field.create("ETBMAXIMUMPOSITION", 3968, FieldType.INT8);
	public static final Field UNUSED1059 = Field.create("UNUSED1059", 3969, FieldType.INT8);
	public static final Field IDLETIMINGPID_PFACTOR = Field.create("IDLETIMINGPID_PFACTOR", 3976, FieldType.FLOAT);
	public static final Field IDLETIMINGPID_IFACTOR = Field.create("IDLETIMINGPID_IFACTOR", 3980, FieldType.FLOAT);
	public static final Field IDLETIMINGPID_DFACTOR = Field.create("IDLETIMINGPID_DFACTOR", 3984, FieldType.FLOAT);
	public static final Field IDLETIMINGPID_OFFSET = Field.create("IDLETIMINGPID_OFFSET", 3988, FieldType.INT16);
	public static final Field IDLETIMINGPID_PERIODMS = Field.create("IDLETIMINGPID_PERIODMS", 3990, FieldType.INT16);
	public static final Field IDLETIMINGPID_MINVALUE = Field.create("IDLETIMINGPID_MINVALUE", 3992, FieldType.INT16);
	public static final Field IDLETIMINGPID_MAXVALUE = Field.create("IDLETIMINGPID_MAXVALUE", 3994, FieldType.INT16);
	public static final Field UNUSED3988 = Field.create("UNUSED3988", 3996, FieldType.INT8);
	public static final Field IDLETIMINGPIDDEADZONE = Field.create("IDLETIMINGPIDDEADZONE", 3998, FieldType.INT16);
	public static final Field UNUSED3942 = Field.create("UNUSED3942", 4000, FieldType.INT8);
	public static final Field TPSACCELFRACTIONPERIOD = Field.create("TPSACCELFRACTIONPERIOD", 4002, FieldType.INT16);
	public static final Field TPSACCELFRACTIONDIVISOR = Field.create("TPSACCELFRACTIONDIVISOR", 4004, FieldType.FLOAT);
	public static final Field TLE8888SPIDEVICE = Field.create("TLE8888SPIDEVICE", 4008, FieldType.INT8);
	public static final Field MC33816SPIDEVICE = Field.create("MC33816SPIDEVICE", 4009, FieldType.INT8);
	public static final Field IDLERPMPID_ITERMMIN = Field.create("IDLERPMPID_ITERMMIN", 4010, FieldType.INT16);
	public static final Field TLE6240SPIDEVICE = Field.create("TLE6240SPIDEVICE", 4012, FieldType.INT8);
	public static final Field STOICHRATIOPRIMARY = Field.create("STOICHRATIOPRIMARY", 4013, FieldType.INT8);
	public static final Field IDLERPMPID_ITERMMAX = Field.create("IDLERPMPID_ITERMMAX", 4014, FieldType.INT16);
	public static final Field MC33972SPIDEVICE = Field.create("MC33972SPIDEVICE", 4016, FieldType.INT8);
	public static final Field STOICHRATIOSECONDARY = Field.create("STOICHRATIOSECONDARY", 4017, FieldType.INT8);
	public static final Field UNUSEDSPIPADDING8 = Field.create("UNUSEDSPIPADDING8", 4018, FieldType.INT8);
	public static final Field ETBIDLETHROTTLERANGE = Field.create("ETBIDLETHROTTLERANGE", 4020, FieldType.FLOAT);
	public static final Field CYLINDERBANKSELECT1 = Field.create("CYLINDERBANKSELECT1", 4024, FieldType.INT8);
	public static final Field CYLINDERBANKSELECT2 = Field.create("CYLINDERBANKSELECT2", 4025, FieldType.INT8);
	public static final Field CYLINDERBANKSELECT3 = Field.create("CYLINDERBANKSELECT3", 4026, FieldType.INT8);
	public static final Field CYLINDERBANKSELECT4 = Field.create("CYLINDERBANKSELECT4", 4027, FieldType.INT8);
	public static final Field CYLINDERBANKSELECT5 = Field.create("CYLINDERBANKSELECT5", 4028, FieldType.INT8);
	public static final Field CYLINDERBANKSELECT6 = Field.create("CYLINDERBANKSELECT6", 4029, FieldType.INT8);
	public static final Field CYLINDERBANKSELECT7 = Field.create("CYLINDERBANKSELECT7", 4030, FieldType.INT8);
	public static final Field CYLINDERBANKSELECT8 = Field.create("CYLINDERBANKSELECT8", 4031, FieldType.INT8);
	public static final Field CYLINDERBANKSELECT9 = Field.create("CYLINDERBANKSELECT9", 4032, FieldType.INT8);
	public static final Field CYLINDERBANKSELECT10 = Field.create("CYLINDERBANKSELECT10", 4033, FieldType.INT8);
	public static final Field CYLINDERBANKSELECT11 = Field.create("CYLINDERBANKSELECT11", 4034, FieldType.INT8);
	public static final Field CYLINDERBANKSELECT12 = Field.create("CYLINDERBANKSELECT12", 4035, FieldType.INT8);
	public static final Field UNUSED4028 = Field.create("UNUSED4028", 4036, FieldType.INT);
	public static final Field TRIGGERCOMPCENTERVOLT = Field.create("TRIGGERCOMPCENTERVOLT", 4044, FieldType.INT8);
	public static final Field TRIGGERCOMPHYSTMIN = Field.create("TRIGGERCOMPHYSTMIN", 4045, FieldType.INT8);
	public static final Field TRIGGERCOMPHYSTMAX = Field.create("TRIGGERCOMPHYSTMAX", 4046, FieldType.INT8);
	public static final Field TRIGGERCOMPSENSORSATRPM = Field.create("TRIGGERCOMPSENSORSATRPM", 4047, FieldType.INT8);
	public static final Field IDLERPMPID2_PFACTOR = Field.create("IDLERPMPID2_PFACTOR", 4048, FieldType.FLOAT);
	public static final Field IDLERPMPID2_IFACTOR = Field.create("IDLERPMPID2_IFACTOR", 4052, FieldType.FLOAT);
	public static final Field IDLERPMPID2_DFACTOR = Field.create("IDLERPMPID2_DFACTOR", 4056, FieldType.FLOAT);
	public static final Field IDLERPMPID2_OFFSET = Field.create("IDLERPMPID2_OFFSET", 4060, FieldType.INT16);
	public static final Field IDLERPMPID2_PERIODMS = Field.create("IDLERPMPID2_PERIODMS", 4062, FieldType.INT16);
	public static final Field IDLERPMPID2_MINVALUE = Field.create("IDLERPMPID2_MINVALUE", 4064, FieldType.INT16);
	public static final Field IDLERPMPID2_MAXVALUE = Field.create("IDLERPMPID2_MAXVALUE", 4066, FieldType.INT16);
	public static final Field IACPIDMULTTABLE = Field.create("IACPIDMULTTABLE", 4068, FieldType.INT8);
	public static final Field IACPIDMULTLOADBINS = Field.create("IACPIDMULTLOADBINS", 4132, FieldType.INT8);
	public static final Field IACPIDMULTRPMBINS = Field.create("IACPIDMULTRPMBINS", 4140, FieldType.INT8);
	public static final Field CANVSSNBCTYPE = Field.create("CANVSSNBCTYPE", 4148, FieldType.INT);
	public static final Field GPPWM1_PIN = Field.create("GPPWM1_PIN", 4152, FieldType.INT8, output_pin_e);
	public static final Field GPPWM1_DUTYIFERROR = Field.create("GPPWM1_DUTYIFERROR", 4153, FieldType.INT8);
	public static final Field GPPWM1_PWMFREQUENCY = Field.create("GPPWM1_PWMFREQUENCY", 4154, FieldType.INT16);
	public static final Field GPPWM1_ONABOVEDUTY = Field.create("GPPWM1_ONABOVEDUTY", 4156, FieldType.INT8);
	public static final Field GPPWM1_OFFBELOWDUTY = Field.create("GPPWM1_OFFBELOWDUTY", 4157, FieldType.INT8);
	...
	public static final Field GPPWM1_LOADAXIS = Field.create("GPPWM1_LOADAXIS", 4158, FieldType.INT8, gppwm_channel_e);
	public static final Field GPPWM1_ALIGNMENTFILL_MAP = Field.create("GPPWM1_ALIGNMENTFILL_MAP", 4159, FieldType.INT8);
	public static final Field GPPWM1_LOADBINS = Field.create("GPPWM1_LOADBINS", 4160, FieldType.INT8);
	public static final Field GPPWM1_RPMBINS = Field.create("GPPWM1_RPMBINS", 4168, FieldType.INT8);
	public static final Field GPPWM1_TABLE = Field.create("GPPWM1_TABLE", 4176, FieldType.INT8);
	public static final Field GPPWM2_PIN = Field.create("GPPWM2_PIN", 4240, FieldType.INT8, output_pin_e);
	public static final Field GPPWM2_DUTYIFERROR = Field.create("GPPWM2_DUTYIFERROR", 4241, FieldType.INT8);
	public static final Field GPPWM2_PWMFREQUENCY = Field.create("GPPWM2_PWMFREQUENCY", 4242, FieldType.INT16);
	public static final Field GPPWM2_ONABOVEDUTY = Field.create("GPPWM2_ONABOVEDUTY", 4244, FieldType.INT8);
	public static final Field GPPWM2_OFFBELOWDUTY = Field.create("GPPWM2_OFFBELOWDUTY", 4245, FieldType.INT8);
	public static final Field GPPWM2_LOADAXIS = Field.create("GPPWM2_LOADAXIS", 4246, FieldType.INT8, gppwm_channel_e);
	public static final Field GPPWM2_ALIGNMENTFILL_MAP = Field.create("GPPWM2_ALIGNMENTFILL_MAP", 4247, FieldType.INT8);
	public static final Field GPPWM2_LOADBINS = Field.create("GPPWM2_LOADBINS", 4248, FieldType.INT8);
	public static final Field GPPWM2_RPMBINS = Field.create("GPPWM2_RPMBINS", 4256, FieldType.INT8);
	public static final Field GPPWM2_TABLE = Field.create("GPPWM2_TABLE", 4264, FieldType.INT8);
	public static final Field GPPWM3_PIN = Field.create("GPPWM3_PIN", 4328, FieldType.INT8, output_pin_e);
	public static final Field GPPWM3_DUTYIFERROR = Field.create("GPPWM3_DUTYIFERROR", 4329, FieldType.INT8);
	public static final Field GPPWM3_PWMFREQUENCY = Field.create("GPPWM3_PWMFREQUENCY", 4330, FieldType.INT16);
	public static final Field GPPWM3_ONABOVEDUTY = Field.create("GPPWM3_ONABOVEDUTY", 4332, FieldType.INT8);
	public static final Field GPPWM3_OFFBELOWDUTY = Field.create("GPPWM3_OFFBELOWDUTY", 4333, FieldType.INT8);
	public static final Field GPPWM3_LOADAXIS = Field.create("GPPWM3_LOADAXIS", 4334, FieldType.INT8, gppwm_channel_e);
	public static final Field GPPWM3_ALIGNMENTFILL_MAP = Field.create("GPPWM3_ALIGNMENTFILL_MAP", 4335, FieldType.INT8);
	public static final Field GPPWM3_LOADBINS = Field.create("GPPWM3_LOADBINS", 4336, FieldType.INT8);
	public static final Field GPPWM3_RPMBINS = Field.create("GPPWM3_RPMBINS", 4344, FieldType.INT8);
	public static final Field GPPWM3_TABLE = Field.create("GPPWM3_TABLE", 4352, FieldType.INT8);
	public static final Field GPPWM4_PIN = Field.create("GPPWM4_PIN", 4416, FieldType.INT8, output_pin_e);
	public static final Field GPPWM4_DUTYIFERROR = Field.create("GPPWM4_DUTYIFERROR", 4417, FieldType.INT8);
	public static final Field GPPWM4_PWMFREQUENCY = Field.create("GPPWM4_PWMFREQUENCY", 4418, FieldType.INT16);
	public static final Field GPPWM4_ONABOVEDUTY = Field.create("GPPWM4_ONABOVEDUTY", 4420, FieldType.INT8);
	public static final Field GPPWM4_OFFBELOWDUTY = Field.create("GPPWM4_OFFBELOWDUTY", 4421, FieldType.INT8);
	public static final Field GPPWM4_LOADAXIS = Field.create("GPPWM4_LOADAXIS", 4422, FieldType.INT8, gppwm_channel_e);
	public static final Field GPPWM4_ALIGNMENTFILL_MAP = Field.create("GPPWM4_ALIGNMENTFILL_MAP", 4423, FieldType.INT8);
	public static final Field GPPWM4_LOADBINS = Field.create("GPPWM4_LOADBINS", 4424, FieldType.INT8);
	public static final Field GPPWM4_RPMBINS = Field.create("GPPWM4_RPMBINS", 4432, FieldType.INT8);
	public static final Field GPPWM4_TABLE = Field.create("GPPWM4_TABLE", 4440, FieldType.INT8);
	public static final Field MC33_I_BOOST = Field.create("MC33_I_BOOST", 4504, FieldType.INT16);
	public static final Field MC33_I_PEAK = Field.create("MC33_I_PEAK", 4506, FieldType.INT16);
	public static final Field MC33_I_HOLD = Field.create("MC33_I_HOLD", 4508, FieldType.INT16);
	public static final Field MC33_T_MAX_BOOST = Field.create("MC33_T_MAX_BOOST", 4510, FieldType.INT16);
	public static final Field MC33_T_PEAK_OFF = Field.create("MC33_T_PEAK_OFF", 4512, FieldType.INT16);
	public static final Field MC33_T_PEAK_TOT = Field.create("MC33_T_PEAK_TOT", 4514, FieldType.INT16);
	public static final Field MC33_T_BYPASS = Field.create("MC33_T_BYPASS", 4516, FieldType.INT16);
	public static final Field MC33_T_HOLD_OFF = Field.create("MC33_T_HOLD_OFF", 4518, FieldType.INT16);
	public static final Field MC33_T_HOLD_TOT = Field.create("MC33_T_HOLD_TOT", 4520, FieldType.INT16);
	public static final Field TCUUPSHIFTBUTTONPINMODE = Field.create("TCUUPSHIFTBUTTONPINMODE", 4522, FieldType.INT8, pin_input_mode_e);
	public static final Field TCUDOWNSHIFTBUTTONPINMODE = Field.create("TCUDOWNSHIFTBUTTONPINMODE", 4523, FieldType.INT8, pin_input_mode_e);
	public static final Field ACSWITCHMODE = Field.create("ACSWITCHMODE", 4524, FieldType.INT8, pin_input_mode_e);
	public static final Field TCU_SOLENOID_MODE1 = Field.create("TCU_SOLENOID_MODE1", 4525, FieldType.INT8, pin_output_mode_e);
	public static final Field TCU_SOLENOID_MODE2 = Field.create("TCU_SOLENOID_MODE2", 4526, FieldType.INT8, pin_output_mode_e);
	public static final Field TCU_SOLENOID_MODE3 = Field.create("TCU_SOLENOID_MODE3", 4527, FieldType.INT8, pin_output_mode_e);
	public static final Field TCU_SOLENOID_MODE4 = Field.create("TCU_SOLENOID_MODE4", 4528, FieldType.INT8, pin_output_mode_e);
	public static final Field TCU_SOLENOID_MODE5 = Field.create("TCU_SOLENOID_MODE5", 4529, FieldType.INT8, pin_output_mode_e);
	public static final Field TCU_SOLENOID_MODE6 = Field.create("TCU_SOLENOID_MODE6", 4530, FieldType.INT8, pin_output_mode_e);
	public static final Field KNOCKBASENOISE = Field.create("KNOCKBASENOISE", 4531, FieldType.INT8);
	public static final Field ALIGNMENTFILL_AT_4547 = Field.create("ALIGNMENTFILL_AT_4547", 4547, FieldType.INT8);
	public static final Field TRIGGERGAPOVERRIDEFROM1 = Field.create("TRIGGERGAPOVERRIDEFROM1", 4548, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDEFROM2 = Field.create("TRIGGERGAPOVERRIDEFROM2", 4552, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDEFROM3 = Field.create("TRIGGERGAPOVERRIDEFROM3", 4556, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDEFROM4 = Field.create("TRIGGERGAPOVERRIDEFROM4", 4560, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDEFROM5 = Field.create("TRIGGERGAPOVERRIDEFROM5", 4564, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDEFROM6 = Field.create("TRIGGERGAPOVERRIDEFROM6", 4568, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDEFROM7 = Field.create("TRIGGERGAPOVERRIDEFROM7", 4572, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDEFROM8 = Field.create("TRIGGERGAPOVERRIDEFROM8", 4576, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDEFROM9 = Field.create("TRIGGERGAPOVERRIDEFROM9", 4580, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDEFROM10 = Field.create("TRIGGERGAPOVERRIDEFROM10", 4584, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDEFROM11 = Field.create("TRIGGERGAPOVERRIDEFROM11", 4588, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDEFROM12 = Field.create("TRIGGERGAPOVERRIDEFROM12", 4592, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDEFROM13 = Field.create("TRIGGERGAPOVERRIDEFROM13", 4596, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDEFROM14 = Field.create("TRIGGERGAPOVERRIDEFROM14", 4600, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDEFROM15 = Field.create("TRIGGERGAPOVERRIDEFROM15", 4604, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDEFROM16 = Field.create("TRIGGERGAPOVERRIDEFROM16", 4608, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDEFROM17 = Field.create("TRIGGERGAPOVERRIDEFROM17", 4612, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDEFROM18 = Field.create("TRIGGERGAPOVERRIDEFROM18", 4616, FieldType.FLOAT);
	public static final Field FUELTRIM1 = Field.create("FUELTRIM1", 4620, FieldType.INT8);
	public static final Field FUELTRIM2 = Field.create("FUELTRIM2", 4621, FieldType.INT8);
	public static final Field FUELTRIM3 = Field.create("FUELTRIM3", 4622, FieldType.INT8);
	public static final Field FUELTRIM4 = Field.create("FUELTRIM4", 4623, FieldType.INT8);
	public static final Field FUELTRIM5 = Field.create("FUELTRIM5", 4624, FieldType.INT8);
	public static final Field FUELTRIM6 = Field.create("FUELTRIM6", 4625, FieldType.INT8);
	public static final Field FUELTRIM7 = Field.create("FUELTRIM7", 4626, FieldType.INT8);
	public static final Field FUELTRIM8 = Field.create("FUELTRIM8", 4627, FieldType.INT8);
	public static final Field FUELTRIM9 = Field.create("FUELTRIM9", 4628, FieldType.INT8);
	public static final Field FUELTRIM10 = Field.create("FUELTRIM10", 4629, FieldType.INT8);
	public static final Field FUELTRIM11 = Field.create("FUELTRIM11", 4630, FieldType.INT8);
	public static final Field FUELTRIM12 = Field.create("FUELTRIM12", 4631, FieldType.INT8);
	public static final Field TRIGGERGAPOVERRIDETO1 = Field.create("TRIGGERGAPOVERRIDETO1", 4632, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDETO2 = Field.create("TRIGGERGAPOVERRIDETO2", 4636, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDETO3 = Field.create("TRIGGERGAPOVERRIDETO3", 4640, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDETO4 = Field.create("TRIGGERGAPOVERRIDETO4", 4644, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDETO5 = Field.create("TRIGGERGAPOVERRIDETO5", 4648, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDETO6 = Field.create("TRIGGERGAPOVERRIDETO6", 4652, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDETO7 = Field.create("TRIGGERGAPOVERRIDETO7", 4656, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDETO8 = Field.create("TRIGGERGAPOVERRIDETO8", 4660, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDETO9 = Field.create("TRIGGERGAPOVERRIDETO9", 4664, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDETO10 = Field.create("TRIGGERGAPOVERRIDETO10", 4668, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDETO11 = Field.create("TRIGGERGAPOVERRIDETO11", 4672, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDETO12 = Field.create("TRIGGERGAPOVERRIDETO12", 4676, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDETO13 = Field.create("TRIGGERGAPOVERRIDETO13", 4680, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDETO14 = Field.create("TRIGGERGAPOVERRIDETO14", 4684, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDETO15 = Field.create("TRIGGERGAPOVERRIDETO15", 4688, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDETO16 = Field.create("TRIGGERGAPOVERRIDETO16", 4692, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDETO17 = Field.create("TRIGGERGAPOVERRIDETO17", 4696, FieldType.FLOAT);
	public static final Field TRIGGERGAPOVERRIDETO18 = Field.create("TRIGGERGAPOVERRIDETO18", 4700, FieldType.FLOAT);
	public static final Field HPFPCAMLOBES = Field.create("HPFPCAMLOBES", 4704, FieldType.INT8);
	public static final String[] hpfp_cam_e = {"NONE", "Intake 1", "Exhaust 1", "Intake 2", "Exhaust 2"};
	public static final Field HPFPCAM = Field.create("HPFPCAM", 4705, FieldType.INT8, hpfp_cam_e);
	public static final Field HPFPPEAKPOS = Field.create("HPFPPEAKPOS", 4706, FieldType.INT8);
	public static final Field HPFPMINANGLE = Field.create("HPFPMINANGLE", 4707, FieldType.INT8);
	public static final Field HPFPPUMPVOLUME = Field.create("HPFPPUMPVOLUME", 4708, FieldType.INT16);
	public static final Field HPFPACTIVATIONANGLE = Field.create("HPFPACTIVATIONANGLE", 4710, FieldType.INT8);
	public static final Field UNUSEDFILLER_4703 = Field.create("UNUSEDFILLER_4703", 4711, FieldType.INT8);
	public static final Field HPFPPIDP = Field.create("HPFPPIDP", 4712, FieldType.INT16);
	public static final Field HPFPPIDI = Field.create("HPFPPIDI", 4714, FieldType.INT16);
	public static final Field HPFPTARGETDECAY = Field.create("HPFPTARGETDECAY", 4716, FieldType.INT16);
	public static final Field HPFPLOBEPROFILEQUANTITYBINS = Field.create("HPFPLOBEPROFILEQUANTITYBINS", 4718, FieldType.INT8);
	public static final Field HPFPLOBEPROFILEANGLE = Field.create("HPFPLOBEPROFILEANGLE", 4734, FieldType.INT8);
	public static final Field HPFPDEADTIMEVOLTSBINS = Field.create("HPFPDEADTIMEVOLTSBINS", 4750, FieldType.INT8);
	public static final Field HPFPDEADTIMEMS = Field.create("HPFPDEADTIMEMS", 4758, FieldType.INT16);
	public static final Field HPFPTARGET = Field.create("HPFPTARGET", 4774, FieldType.INT16);
	public static final Field HPFPTARGETLOADBINS = Field.create("HPFPTARGETLOADBINS", 4974, FieldType.INT16);
	public static final Field HPFPTARGETRPMBINS = Field.create("HPFPTARGETRPMBINS", 4994, FieldType.INT8);
	public static final Field HPFPCOMPENSATION = Field.create("HPFPCOMPENSATION", 5004, FieldType.INT8);
	public static final Field HPFPCOMPENSATIONLOADBINS = Field.create("HPFPCOMPENSATIONLOADBINS", 5104, FieldType.INT16);
	public static final Field HPFPCOMPENSATIONRPMBINS = Field.create("HPFPCOMPENSATIONRPMBINS", 5124, FieldType.INT8);
	public static final Field ALIGNMENTFILL_AT_5134 = Field.create("ALIGNMENTFILL_AT_5134", 5134, FieldType.INT8);
	public static final Field MAINUNUSEDEND = Field.create("MAINUNUSEDEND", 5136, FieldType.INT);
	public static final Field WARNING_MESSAGE = Field.create("WARNING_MESSAGE", 6008, 120, FieldType.STRING);
	public static final Field AFTERSTARTCOOLANTBINS = Field.create("AFTERSTARTCOOLANTBINS", 6128, FieldType.FLOAT);
	public static final Field AFTERSTARTHOLDTIME = Field.create("AFTERSTARTHOLDTIME", 6160, FieldType.FLOAT);
	public static final Field AFTERSTARTENRICH = Field.create("AFTERSTARTENRICH", 6192, FieldType.FLOAT);
	public static final Field AFTERSTARTDECAYTIME = Field.create("AFTERSTARTDECAYTIME", 6224, FieldType.FLOAT);
	public static final Field BOOSTTABLEOPENLOOP = Field.create("BOOSTTABLEOPENLOOP", 6256, FieldType.INT8);
	public static final Field UNUSED6312 = Field.create("UNUSED6312", 6320, FieldType.INT8);
	public static final Field BOOSTRPMBINS = Field.create("BOOSTRPMBINS", 6328, FieldType.INT8);
	public static final Field BOOSTTABLECLOSEDLOOP = Field.create("BOOSTTABLECLOSEDLOOP", 6336, FieldType.INT8);
	public static final Field BOOSTTPSBINS = Field.create("BOOSTTPSBINS", 6400, FieldType.INT8);
	public static final Field PEDALTOTPSTABLE = Field.create("PEDALTOTPSTABLE", 6408, FieldType.INT8);
	public static final Field PEDALTOTPSPEDALBINS = Field.create("PEDALTOTPSPEDALBINS", 6472, FieldType.INT8);
	public static final Field PEDALTOTPSRPMBINS = Field.create("PEDALTOTPSRPMBINS", 6480, FieldType.INT8);
	public static final Field CLTCRANKINGCORRBINS = Field.create("CLTCRANKINGCORRBINS", 6488, FieldType.FLOAT);
	public static final Field CLTCRANKINGCORR = Field.create("CLTCRANKINGCORR", 6520, FieldType.FLOAT);
	public static final Field IDLEADVANCEBINS = Field.create("IDLEADVANCEBINS", 6552, FieldType.FLOAT);
	public static final Field IDLEADVANCE = Field.create("IDLEADVANCE", 6584, FieldType.FLOAT);
	public static final Field IDLEVEBINS = Field.create("IDLEVEBINS", 6616, FieldType.FLOAT);
	public static final Field IDLEVE = Field.create("IDLEVE", 6648, FieldType.FLOAT);
	public static final Field FSIOFORMULAS1 = Field.create("FSIOFORMULAS1", 6680, 200, FieldType.STRING);
	public static final Field FSIOFORMULAS2 = Field.create("FSIOFORMULAS2", 6880, 200, FieldType.STRING);
	public static final Field FSIOFORMULAS3 = Field.create("FSIOFORMULAS3", 7080, 200, FieldType.STRING);
	public static final Field FSIOFORMULAS4 = Field.create("FSIOFORMULAS4", 7280, 200, FieldType.STRING);
	public static final Field FSIOFORMULAS5 = Field.create("FSIOFORMULAS5", 7480, 200, FieldType.STRING);
	public static final Field FSIOFORMULAS6 = Field.create("FSIOFORMULAS6", 7680, 200, FieldType.STRING);
	public static final Field LUASCRIPT = Field.create("LUASCRIPT", 7880, 2000, FieldType.STRING);
	public static final Field TIMINGMULTIPLIER = Field.create("TIMINGMULTIPLIER", 9880, 200, FieldType.STRING);
	public static final Field TIMINGADDITIVE = Field.create("TIMINGADDITIVE", 10080, 200, FieldType.STRING);
	public static final Field CLTFUELCORRBINS = Field.create("CLTFUELCORRBINS", 10280, FieldType.FLOAT);
	public static final Field CLTFUELCORR = Field.create("CLTFUELCORR", 10344, FieldType.FLOAT);
	public static final Field IATFUELCORRBINS = Field.create("IATFUELCORRBINS", 10408, FieldType.FLOAT);
	public static final Field IATFUELCORR = Field.create("IATFUELCORR", 10472, FieldType.FLOAT);
	public static final Field CRANKINGFUELCOEF = Field.create("CRANKINGFUELCOEF", 10536, FieldType.FLOAT);
	public static final Field CRANKINGFUELBINS = Field.create("CRANKINGFUELBINS", 10568, FieldType.FLOAT);
	public static final Field CRANKINGCYCLECOEF = Field.create("CRANKINGCYCLECOEF", 10600, FieldType.FLOAT);
	public static final Field CRANKINGCYCLEBINS = Field.create("CRANKINGCYCLEBINS", 10632, FieldType.FLOAT);
	public static final Field CLTIDLECORRBINS = Field.create("CLTIDLECORRBINS", 10664, FieldType.FLOAT);
	public static final Field CLTIDLECORR = Field.create("CLTIDLECORR", 10728, FieldType.FLOAT);
	public static final Field MAFDECODING = Field.create("MAFDECODING", 10792, FieldType.FLOAT);
	public static final Field MAFDECODINGBINS = Field.create("MAFDECODINGBINS", 11816, FieldType.FLOAT);
	public static final Field IGNITIONIATCORRTABLE = Field.create("IGNITIONIATCORRTABLE", 12840, FieldType.FLOAT);
	public static final Field IGNITIONIATCORRLOADBINS = Field.create("IGNITIONIATCORRLOADBINS", 13864, FieldType.FLOAT);
	public static final Field IGNITIONIATCORRRPMBINS = Field.create("IGNITIONIATCORRRPMBINS", 13928, FieldType.FLOAT);
	public static final Field INJECTIONPHASE = Field.create("INJECTIONPHASE", 13992, FieldType.FLOAT);
	public static final Field INJPHASELOADBINS = Field.create("INJPHASELOADBINS", 15016, FieldType.FLOAT);
	public static final Field INJPHASERPMBINS = Field.create("INJPHASERPMBINS", 15080, FieldType.FLOAT);
	public static final Field TCUSOLENOIDTABLE = Field.create("TCUSOLENOIDTABLE", 15144, FieldType.INT8);
	public static final Field VSSFILTERRECIPROCAL = Field.create("VSSFILTERRECIPROCAL", 15204, FieldType.FLOAT);
	public static final Field MAPESTIMATETABLE = Field.create("MAPESTIMATETABLE", 15208, FieldType.INT16);
	public static final Field MAPESTIMATETPSBINS = Field.create("MAPESTIMATETPSBINS", 15720, FieldType.INT16);
	public static final Field MAPESTIMATERPMBINS = Field.create("MAPESTIMATERPMBINS", 15752, FieldType.INT16);
	public static final Field VVTTABLE1 = Field.create("VVTTABLE1", 15784, FieldType.INT8);
	public static final Field VVTTABLE1LOADBINS = Field.create("VVTTABLE1LOADBINS", 15848, FieldType.FLOAT);
	public static final Field VVTTABLE1RPMBINS = Field.create("VVTTABLE1RPMBINS", 15880, FieldType.FLOAT);
	public static final Field VVTTABLE2 = Field.create("VVTTABLE2", 15912, FieldType.INT8);
	public static final Field VVTTABLE2LOADBINS = Field.create("VVTTABLE2LOADBINS", 15976, FieldType.FLOAT);
	public static final Field VVTTABLE2RPMBINS = Field.create("VVTTABLE2RPMBINS", 16008, FieldType.FLOAT);
	public static final Field UNUSEDLUAWASHERE = Field.create("UNUSEDLUAWASHERE", 16040, FieldType.FLOAT);
	public static final Field IGNITIONTABLE = Field.create("IGNITIONTABLE", 16296, FieldType.FLOAT);
	public static final Field IGNITIONLOADBINS = Field.create("IGNITIONLOADBINS", 17320, FieldType.FLOAT);
	public static final Field IGNITIONRPMBINS = Field.create("IGNITIONRPMBINS", 17384, FieldType.FLOAT);
	public static final Field VETABLE = Field.create("VETABLE", 17448, FieldType.FLOAT);
	public static final Field VELOADBINS = Field.create("VELOADBINS", 18472, FieldType.FLOAT);
	public static final Field VERPMBINS = Field.create("VERPMBINS", 18536, FieldType.FLOAT);
	public static final Field LAMBDATABLE = Field.create("LAMBDATABLE", 18600, FieldType.INT8);
	public static final Field LAMBDALOADBINS = Field.create("LAMBDALOADBINS", 18856, FieldType.FLOAT);
	public static final Field LAMBDARPMBINS = Field.create("LAMBDARPMBINS", 18920, FieldType.FLOAT);
	public static final Field TPSTPSACCELTABLE = Field.create("TPSTPSACCELTABLE", 18984, FieldType.FLOAT);
	public static final Field TPSTPSACCELFROMRPMBINS = Field.create("TPSTPSACCELFROMRPMBINS", 19240, FieldType.FLOAT);
	public static final Field TPSTPSACCELTORPMBINS = Field.create("TPSTPSACCELTORPMBINS", 19272, FieldType.FLOAT);
	public static final Field FSIOTABLE1 = Field.create("FSIOTABLE1", 19304, FieldType.FLOAT);
	public static final Field FSIOTABLE1LOADBINS = Field.create("FSIOTABLE1LOADBINS", 19560, FieldType.FLOAT);
	public static final Field FSIOTABLE1RPMBINS = Field.create("FSIOTABLE1RPMBINS", 19592, FieldType.FLOAT);
	public static final Field FSIOTABLE2 = Field.create("FSIOTABLE2", 19624, FieldType.INT8);
	public static final Field FSIOTABLE2LOADBINS = Field.create("FSIOTABLE2LOADBINS", 19688, FieldType.FLOAT);
	public static final Field FSIOTABLE2RPMBINS = Field.create("FSIOTABLE2RPMBINS", 19720, FieldType.FLOAT);
	public static final Field FSIOTABLE3 = Field.create("FSIOTABLE3", 19752, FieldType.INT8);
	public static final Field FSIOTABLE3LOADBINS = Field.create("FSIOTABLE3LOADBINS", 19816, FieldType.FLOAT);
	public static final Field FSIOTABLE3RPMBINS = Field.create("FSIOTABLE3RPMBINS", 19848, FieldType.FLOAT);
	public static final Field FSIOTABLE4 = Field.create("FSIOTABLE4", 19880, FieldType.INT8);
	public static final Field FSIOTABLE4LOADBINS = Field.create("FSIOTABLE4LOADBINS", 19944, FieldType.FLOAT);
	public static final Field FSIOTABLE4RPMBINS = Field.create("FSIOTABLE4RPMBINS", 19976, FieldType.FLOAT);
	...
	GPPWMNOTE3,
	GPPWMNOTE4,
	UNUSEDATOLDBOARDCONFIGURATIONEND,
	VEHICLEWEIGHT,
	LPS25BAROSENSORSCL,
	LPS25BAROSENSORSDA,
	TPS2SECONDARYMIN,
