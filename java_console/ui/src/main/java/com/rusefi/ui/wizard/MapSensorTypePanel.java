...
public class MapSensorTypePanel implements WizardStep {
    ...
    public MapSensorTypePanel(UIContext uiContext) {
        ...
        JLabel title = new JLabel("MAP Sensor Type");
        scaleComponent(title, 3);
        content.add(title, gbc);

        gbc.gridy++;
        JLabel placeholder = new JLabel("MAP sensor configuration - placeholder for future implementation");
