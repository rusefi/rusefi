...
public class CrankTriggerPanel extends AbstractWizardStep {
    ...
    private static final String DIALOG_KEY = "trigger_primary";
    ...
    public CrankTriggerPanel(UIContext uiContext) {
        ...
        JLabel eyebrow = new JLabel("CRANK TRIGGER SETUP");
        ...
        card.add(new JLabel("Choose the trigger pattern, input pins, and signal edges."), gbc);
