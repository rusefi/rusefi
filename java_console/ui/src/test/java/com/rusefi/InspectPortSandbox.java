...
/**
 * Manual sandbox for testing {@link EcuHardwareProbes#inspect} against real hardware.
 ...
 *
 * All ports are probed in parallel (via {@link EcuHardwareProbes#inspectPorts}) so that
...
public class InspectPortSandbox {
    public static void main(String[] args) throws InterruptedException {
        while (true) {
            ...
            List<PortResult> results = EcuHardwareProbes.inspectPorts(new ArrayList<>(ports));
